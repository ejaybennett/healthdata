(fifthQuint)Transcranial Electrical Stimulation (TCES) / Cerebral Blood Flow (CBF) / Xenon Under Computerized Tomography (Xe/CT).
 ...
 - Exclusion criteria : Participation in two different study trials without direct individual benefit at the same time.

 Contraindications to Computerized Tomography.

 Subjects diagnosed clinically with a Neurological or Psychiatric disorder; Subjects who have been under analgesics or morphine agonists for less than a month; Pregnant or breastfeeding mothers and women without an adequate contraception.

 Drug addicts or persons under tutelage.

 - Study plan: Study group: Xe/CT and transcranial electrostimulation / Control group : Xe/CT - Principal Criterion of Judgement: difference in mean cerebral blood flow between the study group(stimulated) and the control group (not stimulated).
 ...
 - Number of subjects : 40 - Duration of subject participation in study : 2 H 30.

 Transcranial Electrical Stimulation (TCES) / Cerebral Blood Flow (CBF) / Xenon Under Computerized Tomography (Xe/CT)@highlight
