(fifthQuint)Study of 4-Demethylcholesteryloxycarbonylpenclomedine (DM-CHOC-PEN) in Patients With Advanced Cancer.
 ...
 The drug is being administered intravenously once every 21 days as an infusion.

 The starting dose was 39 mg/M2 (based on 1/10 LD10 observed in mice and rats).

 A modified accelerated dosing protocol of Simon, Freidlin, et al is in process to escalate dosage which will reduce the number of patients required and minimize ineffective doses.

 The protocol will result in one patient cohorts at 40% dosage escalations.

 When the 1st instance of a dose limiting toxicity (DLT) [grade - 3 or 4 toxicity] is observed, or the 2nd instance of a 1st course grade 2 toxicity of any type is observed, the cohort for that current dose level will be expanded to 3-6 patients and escalation will proceed at 33% increments.

 During the entirety of the study, intra-patient escalation will be allowed.

 This will occur if the patient experiences are grade 2 toxicity was identified at the existing dose and no DLTs were noted at the higher dose level (if any patients had been escalated to that dose).
...
.
 ...
 Study of 4-Demethylcholesteryloxycarbonylpenclomedine (DM-CHOC-PEN) in Patients With Advanced Cancer@highlight
