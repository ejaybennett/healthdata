(fifthQuint)The Healing Context in CAM: Instrument Development and Initial Validation - Calibration Study.
 ...
 cent Hypothesis 3a: Scores on the HEAL measure will display moderate to large correlations (r's > .

50) with similar self-report measures, supporting convergent validity.

 cent Hypothesis 3b: Scores on the HEAL measure will correlate modestly (r's = .

20-.

35) with self-report measures of general psychosocial functioning, supporting discriminant validity.

 cent Hypothesis 3c: HEAL scores will account for a significant proportion of variance in treatment outcome in both samples.
...
.
 ...
 The Healing Context in CAM: Instrument Development and Initial Validation - Calibration Study@highlight
...
The overall objective of this study is to develop and test an efficient set of self-report instruments to measure Complementary and Alternative Medicine(CAM)-relevant contextual factors important in healing.
 ...
 This current protocol in ClinicalTrials.

gov pertains only to the Calibration Phase of the study.
