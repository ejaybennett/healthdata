(firstQuint)Eeva System Imaging Study.
 ...
 Primary Objectives Include: To collect imaging data on embryos followed to blastocyst stage (Day 5-6) Secondary Objectives Include: To collect enrollment data: demographics, IVF and pregnancy history To collect Day 3, Day 5 and Day 6 embryo morphology data To collect pregnancy test and outcome data To collect pre-implantation genetic screening (PGS) data (if applicable) To collect Frozen Embryo Transfer (FET) data (if applicable).

 Eeva System Imaging Study@highlight
