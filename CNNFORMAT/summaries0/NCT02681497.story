(fifthQuint)Use of Canagliflozin in Conjunction With Insulin in a Real-world Setting.

 This retrospective study will use data from an Electronic Medical Record (EMR)-based database (Web based Diabetes Records (Web DR) researchable database), which has been used to study patient's socioeconomic characteristics, treatment patterns and health outcomes of patients with diabetes.

 The Web DR de-identified researchable database contains integrated demographic, clinical and laboratory test result data of patients who received care from outpatient diabetes clinics in London, Ontario.

 The database includes more than 16,000 patients and their clinic visit information since 2000.

 Adult individuals (age>=18) with type 2 diabetes receiving , registered in Web DR who have been treated with canagliflozin in conjunction with insulin therapy will be selected for this study.
...
.
 ...
 Use of Canagliflozin in Conjunction With Insulin in a Real-world Setting@highlight

This study is a retrospective chart review study aiming to assess the characteristics and health outcomes of patients with type 2 diabetes treated with canagliflozin when used in addition to insulin therapy.

 Furthermore, the project aims to establish an EMR-based cohort of patients with type 2 diabetes mellitus (T2DM) treated with canagliflozin to allow for future longitudinal studies that investigate outcomes over a longer follow-up period, and whether canagliflozin (when used in addition to insulin therapy) has an impact on diabetes-related healthcare costs.
