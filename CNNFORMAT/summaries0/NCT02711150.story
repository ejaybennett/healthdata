(fifthQuint)Effect of EPD on the Lumbar Acoustic Window at Term Pregnancy.
...
.
 ...
 These measurements will be made with the patient in the following positions: cent Sitting position, feet supported with back flexed.

 cent Sitting position, feet supported and arms supported through the application of an epidural positioning device.
 ...
 This estimation was based on data derived from a similar study, which had used a minimum sample size of 16 subjects, with a 1 mm mean change in 'needle target area' dimensions, a 1 mm standard deviation (SD), and an alpha of 0.

05 with a power of 90 % [1, 2].

.

 Effect of EPD on the Lumbar Acoustic Window at Term Pregnancy@highlight
