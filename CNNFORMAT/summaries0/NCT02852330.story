(thirdQuint)Intracochlear Potentials: Volta Study.
 ...
 The use of the SA16 research software in the current clinical investigation is intended to support Cochlear's research into the development of implant telemetry based surgical tools.

 The SA16 research software is designed to perform a series of predefined measurements with minimal intervention both during and immediately following electrode insertion using telemetry from the implant via the Sound Processor to the computer.

 These measurements include real time continuous measurements, intended for use during the electrode insertion portion of the surgical procedure, and baseline measurements following the completion of electrode insertion.
...
2) software will be used to collect voltage tomography measurements post-implantation.

.

 Intracochlear Potentials: Volta Study@highlight
