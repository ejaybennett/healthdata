(thirdQuint)Theophylline Treatment for Pseudohypoparathyroidism.

 Pseudohypoparathyroidism (PHP) is a rare, genetic disorder caused by impaired stimulatory G protein (Gs) signaling through downregulation of the gene, GNAS.
 ...
 Gs signaling is essential for the normal hormonal function of the pituitary, thyroid, gonads, renal proximal tubules and hypothalamus.
 ...
 Therefore, the goal of this proposal is to test the efficacy of upstream therapy aimed at correcting the function of two Gs-dependent receptors responsible for the obesity (melanocortin-4 receptor, MC4R) and short stature (parathyroid hormone, PTH, receptor) phenotype in children with PHP.

 Gs-coupled receptor signaling cascade begins with an increase in cyclic adenosine monophosphate (cAMP) which is rapidly degraded by the enzyme phosphodiesterase (PDE).

 PDE inhibitors act by prolonging cAMP signaling by decreasing the rate of degradation.

 Given that patients with PHP have reduced, but not completely absent, cAMP production, the investigators seek to test the hypothesis that the PDE inhibitor theophylline will reduce BMI, glucose intolerance, and hormone resistance in children and young adults with PHP through improved Gs-coupled receptor signaling.
...
.
 ...
 Theophylline Treatment for Pseudohypoparathyroidism@highlight
