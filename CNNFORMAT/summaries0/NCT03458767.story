(firstQuint)A Cognitive Self-Management Intervention for Persons With Multiple Sclerosis: Adapting Web-based Technology.
 ...
 Outcome variables include: (1) neurocognitive function assessed using the NIH Toolbox(R), a comprehensive set of psychometrically sound neuro-behavioral measures that quickly assesses cognitive functions using an iPad, (2) objective PA and sleep using Actigraph cent accelerometers, (3) self-reported sleep, depression, and fatigue using the Patient-Reported Outcome Measurement Information System (PROMIS), and (4) MS specific self-management using the Multiple Sclerosis Self-Management Scale (MSSM).
...
.
 ...
 A Cognitive Self-Management Intervention for Persons With Multiple Sclerosis: Adapting Web-based Technology@highlight
