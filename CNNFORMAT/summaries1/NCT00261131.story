(secondQuint)Efficacy and Functional Outcomes of Botulinum Toxin A Injections to Hamstrings in Flexed Knee Gait in Cerebral Palsy.
 ...
 It is a multi-center, prospective, randomized, double-blind trial comparing results of injection of BTX- A and placebo saline in controls, into overactive hamstring muscles, using multiple outcomes measures.

 Temporal-spatial gait parameters, instrumented 3DGA kinematics, passive ROM, spasticity measurement with both Ashworth and Tardieu scales, muscle strength/control, Gross Motor Function Measurement (GMFM), Pediatric Outcomes Data Collection Instrument (PODCI), Gillette Functional Assessment Questionnaire (FAQ), 6-Minute Walk Test, and Goal Attainment Scale (GAS), assessing all ICF domains, will be collected at baseline and at 1 month, 3 months, and 6 months post-injection.

 Power analysis demonstrates the need to randomize 250 children (125 with BTX-A, 125 with saline), allowing for attrition.

 Nine participating hospitals will contribute patients.

.

 Efficacy and Functional Outcomes of Botulinum Toxin A Injections to Hamstrings in Flexed Knee Gait in Cerebral Palsy@highlight
