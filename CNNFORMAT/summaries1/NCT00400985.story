(thirdQuint)Sensitivity of the InSync Sentry OptiVol Feature for the Prediction of Heart Failure.
 ...
 The OptiVol feature is based on the measurement of daily intrathoracic impedance values, measurements that can be used to track changes in the subject's thoracic fluid status over time.

 An Alert warns the patient whenever a programmable threshold has been reached.
 ...
 The third phase of the study allows for remote subject therapy management using the OptiVol Patient Alert.

 The patient management strategy is then based on the experience gained in the second study phase Physician actions taken in the occurrence of a Patient Alert will be summarized.

.

 Sensitivity of the InSync Sentry OptiVol Feature for the Prediction of Heart Failure@highlight
