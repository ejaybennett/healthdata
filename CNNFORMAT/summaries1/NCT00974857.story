(secondQuint)Effects Of Volume Control Guided by Body Composition Monitor (BCM) on Blood Pressure and Cardiac Condition in Hemodialysis Patients.

 The proposed prospective, randomized, controlled study intends to document the effect of volume control guided by BCM on blood pressure (determined both manually and 48-h ambulatory), need for anti-hypertensive medication, intra-dialytic complications, and left ventricular geometry and functions assessed by echocardiography.

 One hundred and seventy-six prevalent HD patients will be randomized into two arms: study group and control group.
 ...
 If OH is negative value , and: - Systolic blood pressure is 36 %); we will increase dry weight accordingly.
 ...
 - Systolic blood pressure> 150 mmHg we will perform a captopril test (CT) If the CT is positive we will use ACE inhibitors / ARBs as anti hypertensive drugs and dry weight will be increased if intradialytic hypotension episodes and/or clothing and/or erythrocytosis ( htc> 36 %) are also present If the CT is negative we will repeat the BCM measurement and if it gives same results we will perform ABPM for confirmation.

 We will not need to reach the dry weight immediately.

 If severe BP drop precludes reaching DW in one session, an isolated ultrafiltration or additional dialysis session will be added.

 In the control group, BCM results obtained at the beginning, at the 6th, and 12th months will not be given to the treating physicians.

 Dry weight estimation will be guided by clinical findings, telecardiography, and echocardiography as used to be.

 The planned duration of the study is 12 months.

 All patients will be seen in every month during the study.

 Additional visits will be scheduled if any symptoms and intolerance are suspected.

.

 Effects Of Volume Control Guided by Body Composition Monitor (BCM) on Blood Pressure and Cardiac Condition in Hemodialysis Patients@highlight
