(thirdQuint)Computerized Glucose Control in Critically Ill Patients.
 ...
 However, subsequent randomized controlled trials have failed to confirm a mortality benefit with intensive insulin therapy among critically ill patients, in whom stress hypoglycemia is common.

 Moreover the Normoglycemia in Intensive Care Evaluation - Survival Using Glucose Algorithm Regulation (NICE-SUGAR) study, an international multicentre trial involving 6104 patients, the largest trial of insulin therapy to date, showed a lower 90-day mortality in the control group targeted blood glucose levels inferior to 180 mg/dl when compared to the intervention group with tight glucose control [80 - 110 mg/dl].

 In addition, many studies and meta-analyses have reported high rates of hypoglycemia with tight glucose control.

 Consequently, considerable controversy has emerged as to whether tight glucose control is warranted in all critically ill patients especially as tight glucose control (without appropriate computer protocol) causes a significant increase in nurse workload.
 ...
 The expected all cause 90-day mortality in the control group is 25 % (identical to the observed all cause 90-day mortality in the control group of the NICE-SUGAR trial).

 Considering that all cause 90-day mortality in the experimental group (computer protocol group) is expected to be 22 % (absolute reduction of 3 %), considering an alpha risk and a beta risk respectively of 0.

05 and 0.

20 and three intermediate analyses performed according to the O'Brien-Fleming design, 3,211 patients per treatment arms are needed and will be recruited from the participating 60 centres, all located in France.

.

 Computerized Glucose Control in Critically Ill Patients@highlight

The aim of the study is to determine whether the use of the CGAOtm software is associated with a decrease in 90-day mortality when compared with the use of standard care methods for glucose control with target blood glucose levels inferior to 180 mg/dl.

 The CGAOtm software is designed to assist physicians and nurses in achieving tight glucose control (defined by a target for blood glucose levels between 80 and 110 mg/dl) in critically ill patients.
