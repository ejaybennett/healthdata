(thirdQuint)L-Arginine Supplementation With or Without Enzyme Inhibitors Treating Erectile Function of Prostate Cancer Survivors.
 ...
 Secondary - Evaluate the toxicity of treatment with L-arginine with or without phosphodiesterase-5 inhibitors.

 - Estimate trial accrual, retention, adherence, and variability.

 - Assess changes in quality of life (QOL) and sexual function as defined by changes in the QOL of these patients using the Expanded Prostate Cancer Index Composite, changes in the other domains of the IIEF (i.

e.

, orgasmic function, sexual desire, intercourse satisfaction, and overall satisfaction), changes in the Sexual Encounter Profile, and changes in the percentage of "yes" (positive) responses to either of the two global efficacy questions.

 OUTLINE: Patients are stratified according to age ( 65 years) and current use of phosphodiesterase-5 (PDE-5) inhibitors (yes vs no).
 ...
 Patients complete the International Index of Erectile Function and the Expanded Prostate Cancer Index Composite-26 at baseline and at weeks 4 and 8.

 Patients also complete the Sexual Encounter Profile Questionnaire, FACT-P, and the Global Efficacy Questionnaire at weeks 4 and 8.

.

 L-Arginine Supplementation With or Without Enzyme Inhibitors Treating Erectile Function of Prostate Cancer Survivors@highlight
