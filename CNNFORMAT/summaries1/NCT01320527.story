(thirdQuint)A Clinical Trial of a Vitamin/Nutriceutical Formulation for Alzheimer's Disease.
 ...
 A 1-year, open-label trial with NF with mild to moderate AD patients demonstrate improvement in cognitive performance (Dementia Rating Scale, Clock-drawing) within 3-6 months.

 Caregivers reported maintenance of daily performance and improved mood (ADCS-Activities of Daily Living and NeuroPsychiatric Inventory).

 A placebo-controlled study with moderate to late-stage AD indicates delayed cognitive decline and maintenance of daily activities.

 No adverse events were reported.

 A multi-site trial with >90 individuals aged 45-73 without dementia indicated that NF statistically improved executive function (Trails B-A) vs.

 placebo within 3 months, which increased further at 6 months.

 The placebo group demonstrated identical improvement in a 3-month open-label extension.

 Following NF withdrawal, participants returned to baseline; statistically-significant improvement was restored once NF was individuals resumed.
...
.
 ...
 A Clinical Trial of a Vitamin/Nutriceutical Formulation for Alzheimer's Disease@highlight
