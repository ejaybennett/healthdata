(thirdQuint)An Immunologic Study of Treatment-Naive HIV Patients Starting a Darunavir/Ritonavir- or Efavirenz-Based HAART.

 This is an ex-vivo study (study which takes place outside the organism and records immune parameters from stored blood and cells of a defined population without any intervention by the researcher) to evaluate the kinetics (study of the rate of change) of immune recovery quality and function in stored plasma blood samples of treatment-naive (not previously treated with antiretroviral drugs) patients with advanced human immunodeficiency virus (HIV) infection starting a Darunavir/Ritonavir (DRV/r)- or Efavirenz (EFV)-based highly active antiretroviral therapy (HAART) regimen.

 In previously stored plasma blood samples, the role of DRV/r compared with EFV in reducing T-lymphocyte activation, DRV/r compared with EFV in recovering T-lymphocyte immune phenotype in peripheral blood and thymic production, and DRV/r compared with EFV in recovering T-lymphocyte function (functional immunity) will be studied.
...
.
 ...
 An Immunologic Study of Treatment-Naive HIV Patients Starting a Darunavir/Ritonavir- or Efavirenz-Based HAART@highlight
