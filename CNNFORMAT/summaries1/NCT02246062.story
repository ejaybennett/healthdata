(fifthQuint)Impact of Preanesthetic Information and Behavioral Intervention Using Smartphone on Anxiety of Children.

 Introduction Intense preoperative anxiety in children has been associated with difficulty in anesthetic induction.

 In addition, anxiety of relatives is a factor of great importance and influence on the preoperative anxiety levels of children and effectively contributes to the development of behavioral changes in postoperative period.

 Distress before surgery has been associated with short- and long-term consequences, including risks of emergence delirium and maladaptive postoperative behaviors.

 Strategies to decrease children's anxiety can provide suitable induction and minimizes these risks.
 ...
 Furthermore, there have emerged efficient behavioral intervention programs that use toys, cartoons, video games and smartphones.
...
org) and allocated into four groups: control group (CG), in which the relative receive only conventional verbal information one day before the procedure at ward; informative group (IG), in which the relative, in addition to conventional verbal information, received a leaflet containing information about the anesthetic procedure one day before the surgery at ward; smartphone group (SG), in which the relative received only conventional verbal information one day before the procedure and the child received smartphone application immediately before entering the operating room; smartphone and informative group (SIG) in which the relative, in addition to conventional verbal information, received a leaflet containing information about the anesthetic procedure one day before the surgery and the child received smartphone application immediately before entering the operating room.
 ...
 The study begins always in the ward (W), one day before the procedure, during preanesthesia evaluation and on the conventional provision of information about anesthesia.

 One of the researchers applies the observational m-YPAS scale for child and then the relatives are fully informed about the characteristic of the study and will be asked to sign the consent form.

 At the end of the preanesthetic evaluation (APA) the relatives of the IG and SIG groups receive an information leaflet.

 At the day of the procedure, in the waiting room (WR) of surgical centers, before the child is taken to the operating room (OR), the child anxiety is assessed by m-YPAS scale.

 All groups will also answer a sociodemographic questionnaire and open statement for satisfaction about the information received.

 The children of the groups SG and SIG, before taken to the OR receive smartphones for playing, remaining always accompanied by the relatives until the end of induction.

 In the OR, all children undergo standard monitoring and, immediately before induction of anesthesia through conventional technique (either intravenous or inhalational), are re-evaluated using m-YPAS (OR time).

 Level and prevalence of children's anxiety (m-YPAS), will be measured at three times: ward (W), waiting room (WR) and operating room (OR) immediately before induction.

 The observational m-YPAS was used as originally proposed by Kain et al.

 A partial score was given for each domain, based on the score observed by the researcher, divided by the number of categories in that domain.

 The score for each domain is added to the others and then multiplied by 20.

 Cut-off scores to classify patients are: without anxiety (23.

4-30), with anxiety (-error of 5%, -error of 20%, and confidence interval of 95%, totaling 84 patients, 21 in each group.

.

 Impact of Preanesthetic Information and Behavioral Intervention Using Smartphone on Anxiety of Children@highlight

Background: Preoperative Anxiety is a negative factor in anesthetic and surgical experience.

 Among the strategies for reducing children's anxiety, non-pharmacological strategies are as important as the pharmacological ones, but their its validity is still controversial.
 ...
 Methods: Eighty four children, 4-8 years old, ASA I, II and III, undergoing elective surgical procedures and their relatives are randomly allocated into four groups: control group (CG) where the relative received conventional information about anesthesia; info group (IG), relative received an information leaflet about anesthesia; device group (DG), relative received only conventional verbal information and the child received smartphone application immediately before entering the operating room; device and info group (DIG) relative received a leaflet containing information and the child received smartphone application.

 Children's anxiety will be assessed using the modified Yale Preoperative Anxiety Scale (m-YPAS) on three occasions: at the ward (W), surgical theater in the waiting room (WR) and at the operating room (OR).

 Statistics analysis will employ by Kruskall-Wallis and Mann-Whitney tests for prevalence and level of anxiety in the groups.
