(firstQuint)Vaginal Culture Using INVOcell Compared to Traditional IVF Incubation.

 This is a Phase III, single center, open label randomized comparative trial to evaluate intravaginal culture using INVOcell vs.

 traditional IVF to generate day 5 embryos Pilot: 40 couples (80 patients), randomized to receive either intravaginal culture (n=20) using the INVOcell or traditional IVF (n=20) Primary Endpoints: Blastocyst generation rate: number of day 5 embryos of "good quality" defined as 2BB or greater (expansion of embryo 2,3,4,5 or 6 and inner cell mass and outer cell mass grades of A or B) or higher using the Gardner Grading System divided by the number of eggs incubated Patient acceptability of INVOcell and intravaginal culture.
 ...
 Vaginal Culture Using INVOcell Compared to Traditional IVF Incubation@highlight
