(firstQuint)Exercise During Active Surveillance for Prostate Cancer.
 ...
 Based on this sample size, our study has 80% power with a two-tailed alpha <0.

05 to detect a clinically meaningful effect of 3.

5 ml/kg/min on our primary outcome of VO2max.

 This power will also be sufficient for detecting differences in our secondary biomarkers and patient-reported outcomes if the effects are at least moderate (i.

e.

, a standardized effect size of d=0.

60).

.

 Exercise During Active Surveillance for Prostate Cancer@highlight
