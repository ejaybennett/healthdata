(secondQuint)Effects of Dynamic Hyperinflation on the Left-ventricular Diastolic Function in Healthy Male Subjects.
 ...
 The novel concept of Expiratory Stenosis Breathing (ESB) is based on the method of Metronome-Paced Tachypnea (MPT) of Cooper et al.

 Therefore the investigators use a metronome to indicate a specific breathing frequency (BF) and the relation of inspiration : expiration (I : E) in order to let subjects hyperinflate.

 Subjects get split into two groups each hyperinflating three times for 90sec by one of the two methods before doing a cross-over and switch groups to do the same in the other group.

 At the end of the 90sec there is a measurement of the Inspiratory Capacity (IC) and an echocardiography in order to objectify dynamic hyperinflation respectively the change in diastolic function.

 During ESB participants hyperinflate with a BF - 30/min and a I : E - 1 : 3.

 In addition they have to breathe through an expiratory-effective stenosis (3, 2 and 1,5mm) on the mouthpiece of the pneumotachograph to simulate the collapsing airways in COPD-patients.

 In contrast, during MPT subjects hyperinflate with a BF - 40/min, I : E - 1 : 1; BF - 40/min, I : E - 1 : 2; BF - 30/min, I : E - 1 : 2.
...
.
 ...
 Effects of Dynamic Hyperinflation on the Left-ventricular Diastolic Function in Healthy Male Subjects@highlight
