(fifthQuint)Data Analysis of a Managed Care Weight Reduction Trial.

 This study will involve secondary data analysis for a study done by Wylie-Rosett et al.

 in 2001.

 Using a 3-arm, 12-month randomized clinical trial, Wylie-Rosett et al.

 evaluated the costs and effects of incremental components of a weight-loss program.
 ...
 For the increasing levels of intervention intensity, the mean 12-month weight losses were 2.

2, 4.

7, and 7.

4 pounds, with the respective cost per participant being $12.
...
74.
 ...
 The decreases in mean BMIs for these respective intervention levels were 0.
...
2.
 ...
 All groups reported a decrease in energy and fat intake and an increase in blocks walked (p<.
...
01).
 ...
 (2001) concluded that, in a weight-loss program, computers can facilitate selecting behavioral change goals.
...
.
 ...
 Data Analysis of a Managed Care Weight Reduction Trial@highlight

This study will involve secondary data analysis for a study done by Wylie-Rosett et al.

 in 2001 that evaluated the costs and effects of incremental components of a weight-loss program.
