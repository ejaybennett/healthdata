(fifthQuint)English Diabetes Self-Management Program.

 1.

 Implement and evaluate in a 6-month randomized controlled evaluation an experimental self-management program for patients with type 2 diabetes.

 Outcomes for evaluating the intervention's impact include health status (health-related quality-of-life and metabolic control) and health care utilization.

 Mediating outcomes are health behaviors and self-efficacy.
 ...
 This proposed evaluation will examine the following questions: Hypothesis 1.

 People participating in the Diabetes Self-Management Program (SDSMP), when compared six months after baseline to randomized wait-list controls receiving usual care, will demonstrate: 1.
 ...
 The changes in health related quality of life, metabolic status, health behaviors and health care utilization will be maintained for one year.

 Hypothesis 3.

 Twelve to fifteen health care organizations in California will be interested in disseminating the program.

 This will be demonstrated by their willingness to send 2-3 persons each to a 5 day training which will allow their organization to replicate and perpetuate the program.

 Hypothesis 4.

 8-10 health care organizations in California will have offered at least two Diabetes Self-Management Programs to people with Type 2 diabetes one year following the above dissemination training.

 (It should be noted that this hypothesis can not be tested during the funded portion of the program.

 However, it our intent to contact all organizations participating in dissemination training one year following the training to determine what they have done with the program).

 The results of this follow-up will be reported to The Foundation.

).

 English Diabetes Self-Management Program@highlight
