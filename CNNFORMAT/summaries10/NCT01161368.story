(fifthQuint)A Study Evaluating the Efficacy and Safety of Lapatinib + Vinorelbine in ErbB2 Positive Metastatic Breast Cancer Patients.
 ...
 The sample size is not based on statistical consideration.

 Thirty 30 patients are considered appropriate for a phase II study to gain first information on the efficacy and safety of the study treatment in the study indication.

 Only descriptive statistical methods will be used to summarize the study results.

 Kaplan-Meier estimates will be calculated for PFS and OS.

 Median PFS and OS time and corresponding two sided 95% confidence intervals will be provided.
 ...
 Secondary outcomes are overall survival (OS) and objective response rates (ORR) using RECIST.

 Safety outcomes are adverse events, safety laboratory data, physical examinations, vital signs, LVEF, ECG data and ECOG performance status Definitions: The objective response rate is the rate of subjects with complete response (CR) or partial response (PR).

 Progression-free survival: The time to progression or death is defined as the time from study entry until the first observation of disease progression or death due to any cause (whichever occurred earlier).

 Only those death will be considered, which occurs within 84 days of the last tumor assessment or study entry (whichever is later).
 ...
 Overall survival will be calculated from study entry until death.

 For patients lost to follow-up, data will be censored at the time the patient was last determined to be alive.
...
.
 ...
 A Study Evaluating the Efficacy and Safety of Lapatinib + Vinorelbine in ErbB2 Positive Metastatic Breast Cancer Patients@highlight
...
The objective of this phase II study is to gain first information on the efficacy (PFS, ORR and OS) and safety of lapatinib plus vinorelbine in patients with HER2 positive metastatic breast cancer pretreated with a combination therapy (chemotherapy and/or hormonal therapy) including lapatinib and presenting with tumor progression.
 ...
 Secondary objectives are to assess the efficacy of the study treatment with respect to the objective response rates as assessed by RECIST criteria version 1.

1, the overall survival and to evaluate the safety profile of the combination by recording the adverse events and abnormal laboratory values associated with the study treatments.
