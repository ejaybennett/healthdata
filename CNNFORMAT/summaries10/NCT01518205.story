(fifthQuint)HELP-Apheresis in Diabetic Ischemic Foot Treatment (H.
...
F).
 ...
 The randomization stratified according to the lesion gravity level (class TEXAS I vs II vs III),allocation 1:1.

 The randomization list will be generated by the statistic software "Stata 11".

 The lists of randomization (one list for each class TEXAS ) will be generated and will be stored by the coordinator centre.

 When a patient satisfies the study inclusion criteria, will be contacted the coordinator centre (by phone/mail) for group allocation.
 ...
 Furthermore, in patients of experimental arm, blood samples will be collected at basal and at the end of LDL-apheresis sessions no.

 2 and 10 in order to determine CBC, fibrinogen, total cholesterol, HDL-cholesterol, LDL-cholesterol, Triglycerides, Lp(a), CRP, PTX3 (time schedule, after 1 and 9 weeks).

 The value of the lab tests obtained at the end of apheresis will be normalized due to a possible hemodilution, according to the following formula: F dil= (1 - Htc pre-apheresis) / ( 1 - Htc post-apheresis).

 Xcorrect = Xmeasured * Fdil.
 ...
 Transcutaneous oximetry: basal, at 4th week (i.

e.

 after the 5th apheretic session).

 at 9th week (at the end of the 10 apheresis sessions) and after the next 3-6-9-12 month follow-up.
...
.
 ...
 HELP-Apheresis in Diabetic Ischemic Foot Treatment (H.
...
Diabetic foot (DF) is a common, severe and costly complication of diabetes.

 DF is underlied by neuropathy, atherosclerosis of distal arteries and infection, which result in tissue ulcers and necrosis.

 Alterations in microcirculatory function and in blood rheology may concur in causing tissue damage.
 ...
 A total of 132 patients will be enrolled.

 Participants will be centrally randomized to receive traditional therapy alone (TT) or in association with LA.

 TT includes standard medication of ulcers, antiaggregant therapy and statins.

 LA will be performed with HELP system, for a total of 10 sessions in 9 weeks.

 The primary end-point of the study is ulcer healing; secondary endpoints include improvements of peripheral oxygenation, resolution of pain, reduction of circulating inflammatory markers, cardiovascular events during one year's follow-up.

 This clinical Study has been approved by local EC on 25 may 2011 (Study number 1953).

 TO BE NOTED: since diabetic patients in our "Diabetic-Foot UNIT" often presented foot ulcers more severe than class II Texas, a formal amendment has been submitted to EC for recruiting patients with diabetic foot ulcer of class III Texas.

 The amendment was already approved on 5 may 2012.
