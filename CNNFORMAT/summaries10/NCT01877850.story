(firstQuint)Utility of a Weaning Protocol in ICU.
 ...
 For all this patients are calculated modified-BWAP(BWAP-M) and TOBIN indexes.

 The "Case" patients started the weaning protocol process only if BWAP-M value is more than 15 or BWAP-M 10-15 with Tobin index < 100.

 If not, the BWAP-M and Tobin will be calculated every day.

 The Control patients will start weaning by clinical judgement even if the BWAP-M value is less than 10.
...
.
 ...
 Utility of a Weaning Protocol in ICU@highlight
