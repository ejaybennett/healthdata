(fifthQuint)Low Dose Metronomic Poly-chemotherapy for Metastatic CRC.
 ...
 Treatments based on this type of regimen have already been studied on other models of cancer and showed the capacity of suppressing tumor growth by a new category of anti-tumor effects.

 Namely, by affecting factors and mechanisms which prevail in the microenvironment that surrounds tumor deposits, thus circumventing the resistance of their cancer cells to chemotherapy.

.

 Low Dose Metronomic Poly-chemotherapy for Metastatic CRC@highlight

This study investigates the activity of a new regimen of treatment for patients with metastatic colorectal carcinoma.

 This includes a combination of well-known chemotherapy agents and anti-inflammatory agents, when administered orally at low daily doses and without planed brakes (Low Dose Metronomic regimen), in contrast with the conventional and already exhausted regimens of treatment at Maximal Tolerated Doses (MTD) which required pre-planned brakes between treatment days.
