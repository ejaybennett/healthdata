(fifthQuint)Using an Interactive Game to Reduce Fear and Increase Spine Motion in Low Back Pain.
 ...
 Specifically, in game session 1, the spine motion of the avatar is equal to that of the participant (gain=1); in session 2 spine motion of the avatar is 5% less than the participant (gain=0.

95); in session 3 spine motion of the avatar is 10% less than the participant (gain=0.
...
.
 ...
 Using an Interactive Game to Reduce Fear and Increase Spine Motion in Low Back Pain@highlight
...
A fundamental clinical problem in individuals with chronic low back pain is the significant alteration in movement patterns that restrict lumbar spine motion.
 ...
 This is particularly true for individuals with fear of re-injury with movement (i.
