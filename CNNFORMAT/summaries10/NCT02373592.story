(fifthQuint)Implementation of Foot Thermometry and SMS and Voice Messaging to Prevent Diabetic Foot Ulcer.

 Detailed Description: Thermometry is a promising emerging modality for the prevention of diabetic foot ulcers according to different clinical trials.

 However, patient compliance with self-monitoring temperature at home is a concern, as they may be forgetful or find it difficult to get into a consistent routine of daily monitoring.

 Therefore, the investigators propose to determine the utility of SMS and voice messaging to remind the patients to perform the thermometry, and to assess the impact on diabetic foot ulceration.
 ...
 Subjects will be provided with a TempStat (foot thermometer), a device that captures a thermal image of feet through colors.

 Some alarm signs have been pre-specified: 1) When the thermal image shows yellow spots in any area of any feet for two consecutive days, 2) when the thermal image shows different colors in contralateral areas of the feet for two consecutive days or, 3) a dermal lesion is detected at any time.

 In any of these three scenarios, subjects will be instructed to contact the study nurse by phone or text message.

 For the first two types of alarm signs, once the study nurse is contacted he/ she will ask about the presence of lesions in the patient's feet and the patient's activity on the previous two weeks, and will provide recommendations on how to decrease activity until temperatures normalize.

 If TempStat measurements continue to show alarm signs for more than one week after the telephone consultation, the participant will be asked to contact the nurse and schedule a face-to-face evaluation to assess the presence of an infection and/or ulcer with a masked assessor.
 ...
 Experimental: Thermometry plus SMS and voice messaging Thermometry-related intervention activities will be the same as those established for the thermometry-only group.

 In addition, this group will receive reminders to use the TempStat (two messages) and promote foot care (six messages).

 The content of these eight messages has been developed and validated through both via SMS and voice messaging.

 During the first two weeks of the intervention, only reminders to use the TempStat will be sent, daily, Monday to Friday, both SMS and voice messaging.
...
.
 ...
 Implementation of Foot Thermometry and SMS and Voice Messaging to Prevent Diabetic Foot Ulcer@highlight
