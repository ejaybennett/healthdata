(fifthQuint)Remediation of Visual Perceptual Impairments in Schizophrenia.

 It is increasingly clear that people with schizophrenia have a range of visual perception impairments, including in low-level vision (e.

g.

, acuity, contrast sensitivity) and mid-level vision (e.

g.

, perceptual organization, coherent motion detection).

 These impairments are significantly related to poorer performance on cognitive (e.

g.

, visual learning and memory) and social cognitive (e.

g.

, facial emotion decoding) measures, and to worse functional outcomes.
 ...
 Results of the R61 will be used to identify the treatment (UE, CIT, or UE&CIT) and duration (i.

e.

, dose) that most effectively and efficiently improves the target(s).
...
.
 ...
 Remediation of Visual Perceptual Impairments in Schizophrenia@highlight
