(firstQuint)Investigation of Clinical Feature and Brain Function in Narcoleptic Patients.
 ...
 Functional magnetic resonance imaging (fMRI) has been used in human to nonivasiverlyn investigate the neural mechanisms.

 This technique also apply to measures the variations in brain perfusion, structure and morphology in narcolepsy patients by assessing the blood oxygen level-dependent (BOLD) signal diffusion tensor imaging (DTI and voxel-based morphometry(VBM) This study compare the feature of PSG and fMRI between narcolepsy with RBD, narcolepsy without RBD, control subject to evaluates the PSG and cerebral metabolism and functions in narcolepsy with/without RBD.

.

 Investigation of Clinical Feature and Brain Function in Narcoleptic Patients@highlight
