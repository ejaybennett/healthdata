(fifthQuint)Clinical and Instrumental Evaluation of Late Dysphagia in Patients With Oropharynx and Nasopharynx Cancer, Candidates to Combined Radiochemotherapy With Intensity Modulated Technique (IMRT).
 ...
 The Primary aim is the Evaluation of changes of instrumental scores for swallowing function, evaluated at 6 and 12 months from the end of the RTCT (variations between dichotomous variables or dichotomous yields); the Secondary aims are the correlation between instrumental scores and clinical score and the correlation of the dose received from each of the SWOARs with the deterioration of the instrumental and clinical scores Inclusion Criteria 1.

 Histological diagnosis of squamous cell carcinoma or undifferentiated carcinoma of the otoiatric district 2.

 Subsider of the primitive: (Nasopharynx Stage II and III); Oropharynx Stage III-IVA 3.

 ECOG Status 0-2 4.

 Chemiotherapy concomitant at radiotherapy (Cisplatin 100mg / m2 every 21 days or 40mg / m2 weekly) Exclusion criteria 1.

 Histological diagnosis different from squamous or undifferentiated cell carcinoma 2.

 Subsider of the primitive different from Nasopharynx, Oropharynx 3.

 Nasopharynx Stage IV; Oropharynx Stage IVB and C 4.

 ECOG 3 5.

 Prior induction chemotherapy 6.

 Prior oncological surgery on the ENT district 7.

 Prior radiation treatment on the ENT district 8.

 Concomitant diseases that could modify the swallowing function (ex Amyotrophic Lateral Sclerosis or Multiple Sclerosis) 9.

 A history of excessive use of benzodiazepines or similar (ex patients in psychiatric therapy) or eastroesophageal reflux resistant at medical therapy Methods Evaluation of the swallowing functions effectuated by Videofluoroscopy (VFS) and Endoscopic Fibroscopy of the Swallowing (FEES) in the 20 days before the beginning of the treatment (Baseline Evaluation) and then at a distance of 6 and 12 months from the end of the treatment.
 ...
 Radiotherapy Radiotherapy treatment have to be necessarily performed with IMRT technique (static or dynamic), after TC acquisition of the anatomical volume of interest (from the skull base to the sternum-clavicular junction) with slices of 2.
...
5 mm.
 ...
 The instrumental parameters to be studied are the following: - Pre-deglutitory Fall: Deficit in the oral phase; delay in triggering the swallowing act; nasal regurgitation (Velopalatin insufficiency) - TTF (Faringeal Transit Time): expression of the transit time of the bolus through the pharynx - IRF (Pharyngeal Retention Index): expression of the bolus residue percentage in pharynx (glosso-epiglottic vallecule and / or piriform sinuses and / or posterior laryngeal commissure, pharyngeal lateral wall) following the deglutitory act - Penetration / Aspiration: expression of the bolus entry into the airways above the glottal plane (Penetration) or beyond the glottal plane (Aspiration) and the effectiveness of the tussigen reflex mechanisms.
 ...
 Statistical Methodology Primary objective n.

 1 The Mc Nemar Test will be used to evaluate the significant changes in instrumental scores related to the different parameters of dysphagia between the baseline and 6 and 12 months.

 The p-value and the power of the study are fixed at 0.

05 and 0.

80 respectively.

 To make the deterioration of one or more (variable) parameters of dysphagia (eg, predegulatory and aspiration fall) significant after radiochemotherapy, which involves a variation from 5% (baseline) to 25% (6 or 12 months post-treatment), 35 patients are needed.

 Primary objective n.

 2 To evaluate the correlation between instrumental scores and the clinical score of dysphagia (quantitative variables), Pearson correlation analysis will be used.
...
80 respectively.
 ...
 To make a coefficient of correlation between instrumental and clinical scores equal to 0.

3, 85 patients are needed.
...
80 respectively.
 ...
 To make a correlation coefficient of 0.

3 between the doses received by each individual SWOAR and the worsening of the instrumental scores of one or more parameters of dysphagia significant, about 85 patients are needed.
...
.
 ...
 Clinical and Instrumental Evaluation of Late Dysphagia in Patients With Oropharynx and Nasopharynx Cancer, Candidates to Combined Radiochemotherapy With Intensity Modulated Technique (IMRT)@highlight
...
Nowadays radio-chemotherapy is considered an alternative to surgical treatment in patients with locally advanced cancer of the cervico-cephalic district (LA-HNC), in order to guarantee organ preservation.
 ...
 A therapeutic strategy of organ preservation should guarantee the greater probability of tumor control and the minimum damage to the organ functions.

 Moreover, the reduction of symptoms, related to changes in swallowing function and possible complications, could lead to an improvement in the patient's quality of life and to a significant reduction in hospitalization costs.

 Intensity Modulated Radiotherapy (IMRT), have shown very promising results both in terms of increased tumor control and reduction of toxicity, due to a reduction in dose of radiation to the major salivary glands, pharyngeal mucosa and also to the structures responsible for swallowing.

 For a correct and complete evaluation of the deglutitory function should be useful the use of both clinical scales and instrumental methods.

 It is strongly recommended by the international scientific community to use, in association with the clinical evaluation, appropriate instrumental examinations for a correct evaluation of the swallowing function both before and after radiotherapy.

 The examens that are recognized as gold standards in the study of dysphagia are the Endoscopic Fibroscopy of Swallowing (FEES) and Videofluoroscopy (VFS).

 The protocol envisages the use of Swallowing Videoendoscopy (FEES) and Videofluoroscopy (VFS), that have to be performed in the baseline conditions to assess the presence or absence of dysphagia cancer related, and after 6 and 12 months to evaluate the effect of the treatment.

 Patients should also complete a questionnaire for the assessment of quality of life in relation to dysphagia problems.

 The Primary aim is the Evaluation of changes of instrumental scores for swallowing function, the Secondary aims are the correlation between instrumental scores and clinical score and the dose received from each of the SWOARs with the deterioration of the instrumental and clinical scores.

 The evaluation of the swallowing functions effectuated by VFS and FEES have to be done in the 20 days before the beginning of the treatment (Baseline Evaluation) and then at a distance of 6 and 12 months from the end of the treatment.

 Clinical evaluation of the impact of dysphagia on quality of life by administering a specific MDADI (MD Anderson Dysphagia Inventory) questionnaire at baseline conditions and then at 6 and 12 months.

 Radiotherapy treatment have to be necessarily performed with IMRT technique (static or dynamic).

 For the optimization process of "Inverse Planning" the primary risk organs (P-OARs) and the secondary risk organs must be both identified as "Objective Structures" (S-OARs), which include the organs responsible for swallowing, indicated by the acronym SWOARs.

 In the treatment planning process, the highest priority must be given to respect the constraints on the P-OARs, the PTV coverage must have a higher priority than the constraints on the S-OARs.

 In the case of extensive overlapping between PTV and a secondary risk organ (eg for the upper constrictor muscle in patients with large nasopharyngeal tumor) it's a medical decision to set any dosimetric constraint and to limit the average dose received from the structure in analysis.

 At the end of radiotherapy planning, the average doses received from each of the SWOARs must be recorded and will be used in the final statistical analysis.

 The use of image fusion with MRI for the definition of both target volumes and OARs is strongly recommended.

 Finally, the radiation treatment must include the use of on-line verification and correction systems for the patient's Set-Up through three-dimensional imaging.

 The instrumental assessment of the swallowing function involves the execution, under basal conditions (in the 20 days before the beginning of RT) and subsequently at a distance of 6 and 12 months from the end of RT, both of the FEES and of the VFS.
