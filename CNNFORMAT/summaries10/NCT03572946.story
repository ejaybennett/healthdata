(secondQuint)Targeted Biopsy or Standard Biopsy for Clinical Significant Prostate Cancer Detection.

 Prostate biopsy with multiple samples using a standardized template (standard biopsy, SB) under transrectal ultrasound (TRUS) guidance is the current standard diagnostic approach in suspicion of prostate cancer (PCa).

 However, many biopsies are unnecessary or cannot detect clinically significant PCa (csPCa).
...
.
 ...
 Targeted Biopsy or Standard Biopsy for Clinical Significant Prostate Cancer Detection@highlight
