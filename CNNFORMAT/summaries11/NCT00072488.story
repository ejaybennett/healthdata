(thirdQuint)Whole-Body MRI and Conventional Imaging in Detecting Distant Metastases in Young Patients With Solid Tumors or Lymphoma.

 OBJECTIVES: Primary - Compare non-inferior diagnostic performance of whole-body MRI (i.

e.

, combination of turbo short-tau inversion-recovery (STIR) and out-of-phase imaging) vs conventional imaging (i.

e.

, the combination of chest CT scan, scintigraphy [bone, gallium, meta-iodobenzylguanidine (MIBG), or optional fludeoxyglucose F 18 positron emission tomography (FDG-PET)] and abdominal/pelvic CT scan/MRI as indicated) for detecting distant metastases for use in staging common tumors in pediatric patients.

 Secondary - Determine the incremental benefit of adding out-of-phase T1-weighted gradient-recalled echo imaging to turbo STIR for detecting distant disease in these patients.
 ...
 Patients undergo conventional MRI, CT scan, and/or scintigraphy (e.

g.

, bone, meta-iodobenzylguanidine [MIBG], or gallium) and experimental whole-body MRI sequences.
...
.
 ...
 Whole-Body MRI and Conventional Imaging in Detecting Distant Metastases in Young Patients With Solid Tumors or Lymphoma@highlight
