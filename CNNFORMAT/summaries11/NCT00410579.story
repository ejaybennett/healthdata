(thirdQuint)Patient-Reported Outcomes in Long-Term Survivors of Colon and Rectal Cancers.

 OBJECTIVES: - Characterize 3 separate types of patient-reported outcomes (quality of life [e.

g.

, generic and disease-specific], functional outcomes [e.

g.

, bowel and sexual function and activities of daily living], and clinical symptoms [e.

g.

, pain, fatigue]) in long-term (5+ years) survivors of colon and rectal cancers in a large national sample recruited from five National Surgical Adjuvant Breast and Bowel Project (NSABP) treatment trials.

 - Explore the degree to which patient-reported outcomes are impacted by individual characteristics (e.

g.

, specific predisposing factors, enabling resources, and need), by health behaviors (e.

g.

, use of services for cancer-related and non-cancer-related issues), and, when appropriate, by the specific treatments that were received.
...
.
 ...
 Patient-Reported Outcomes in Long-Term Survivors of Colon and Rectal Cancers@highlight
