(firstQuint)Automated Anesthesia During Bronchoscopy.

 The Bispectral Index (BIS) is an electroencephalogram-derived measure of anesthetic depth.

 We have built a combined closed-loop anesthesia system using BIS as the control variable, two proportional-integral-differential control algorithms, a propofol and a remifentanil target-controlled infusion systems as the control actuators.

 A recent study has shown that such system is able to provide clinically adequate anesthesia.

 The aim of the present study is to assess the system during rigid bronchoscopy.
...
.
 ...
 Automated Anesthesia During Bronchoscopy@highlight
