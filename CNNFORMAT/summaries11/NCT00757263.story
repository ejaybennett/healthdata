(thirdQuint)Study of Genes and the Environment in Patients With Ovarian Cancer in the East Anglia, Oxford, Trent, or West Midlands Regions of the United Kingdom.

 OBJECTIVES: - To obtain epidemiological information and biological material on a population-based series of ovarian cases.

 - To define the proportion of ovarian cancer incidence attributable to mutations in known predisposing genes (e.
...
, BRCA1 and BRCA2).
 ...
 Patients complete an epidemiological questionnaire.

 The questionnaire will request identifying information on the patient's first-degree relatives.

 Blood samples are collected from patients.

 DNA is extracted from these blood samples and from samples collected from cancer-free control participants in MREC-SEARCH-CONTROL as well as from additional controls through the European Prospective Investigation of Cancer (EPIC) study (a population based study of diet and health based in Norfolk, East Anglia).

 DNA samples are analyzed for polymorphisms of low penetrance cancer susceptibility genes.
...
.
 ...
 Study of Genes and the Environment in Patients With Ovarian Cancer in the East Anglia, Oxford, Trent, or West Midlands Regions of the United Kingdom@highlight
