(thirdQuint)Examining the Immune Response in Patients With Gaucher Disease and Hepatitis C.
 ...
 This autosomal recessive disease is pan-ethnic, but it is especially prevalent among Ashkenazi Jews.

 From over 300 different mutations reported in the glucocerebrosidase gene, five account for 98% of the disease-producing alleles.

 Of these mutations, N370S (or 1226G) occurs in 1 out of 17 Ashkenazi individuals, leading to a disease frequency of 1:850 in this ethnic group.
 ...
 Study importance: The host metabolic background exerts a profound effect on antiviral immunity, which may influence the clinical course of chronic HCV infection.
 ...
 Statistical Analysis: Data are presented as the mean standard deviation (SD).

 The Kruskal Wallis non-parametric ANOVA test was used to identify differences between the study groups.

 The student t-test and non-parametric Mann-Whitney test were used to compare quantitative variables between the study groups as appropriate; P <0.

05 was considered to be significant.

.

 Examining the Immune Response in Patients With Gaucher Disease and Hepatitis C@highlight
