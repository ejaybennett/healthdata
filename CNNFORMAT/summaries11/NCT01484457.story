(fifthQuint)Controlled Insulin Delivery: Combining Technology With Treatment.
 ...
 We have developed the Artificial Pancreas System (APS(C)) and used it to clinically evaluate a control strategy that allows efficient glycemic control without any a priori meal information.

 The Artificial Pancreas device uses the Artificial Pancreas System (APS(C)) platform with the OmniPod insulin pump, the DexCom SEVEN PLUS CGM and a multi-parametric model predictive control algorithm (mpMPC) with an insulin-on-board (IOB) safety constraint.

.

 Controlled Insulin Delivery: Combining Technology With Treatment@highlight
...
Hypothesis: Closed-loop control systems for an artificial pancreas using multi-parametric model predictive control can be developed and evaluated safely in patients with Type 1 Diabetes Mellitus (T1DM) to control blood glucose concentrations.
 ...
 This study seeks to combine real-time continuous glucose sensing with automated insulin delivery in a closed-loop system that will achieve euglycemia in patients with T1DM.

 The end result of this line of research will be an artificial pancreas that will provide around-the-clock glucose regulation through controlled insulin delivery in response to detected patterns of change in glucose levels.
