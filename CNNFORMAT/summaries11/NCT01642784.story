(secondQuint)Complete Infarct Related Artery Revascularization in Acute Myocardial Infarction.
 ...
 comparing chosen treatment strategies for multiple lesion IRA 3.

 comparison of complete vs.

 target lesion-only PCI in IRA in acute MI (myocardial infarction) patients.
 ...
 This study will collect data on all consecutive patients with STEMI and NSTEMI undergoing immediate coronary angiography which demonstrated at least two independent (requiring two stent platforms) critical lesions in infarct related artery (one of which is considered as target/culprit lesion that have caused the myocardial infarction and requires immediate PCI).

 Patients will be treated (multiple or single lesion stenting) according to local standard and operator's decision.

 Patient follow up phone call and/or visit (according to local protocols) will be performed at 12 months from enrollment if applicable by local standards.

.

 Complete Infarct Related Artery Revascularization in Acute Myocardial Infarction@highlight

Objective of this registry study is to compare strategy of complete vs.

 target lesion-only primary PCI (percutaneous coronary intervention) in IRA (infarct related artery) in STEMI (ST elevation myocardial infarction) patients.
