(fifthQuint)Rehabilitation of Patients With Lung Chronic Obstructive Pulmonary Disease.
 ...
 The evaluation procedure will be: functional independence measure (FIM); london chest activity of daily living (LCADL); scale medical research council (MRC); the world health organization disability assessment schedule 2.

0 (WHODAS 2.

0); anthropometric examination; walk test of six (6) minutes; step test; As the repetition maximum (RM); muscle activation - electromyography; grip strength of the upper limbs (DMS); ultrasound diaphragm dynamometer; spirometry; respiratory muscle strength; saint george in respiratory disease questionnaire (SGRQ).
 ...
 Statistical analysis will be performed using the Statistical Package for Social Sciences for Windows (version 17.

0).

.

 Rehabilitation of Patients With Lung Chronic Obstructive Pulmonary Disease@highlight
...
Chronic obstructive pulmonary disease (COPD) is characterized by the obstruction is not fully reversible airway, where the severity of the disease and the prognosis is not determined solely by changes in lung function.
 ...
 The PR (pulmonary rehabilitation) will last 60-120 minutes each.

O group A (control) will receive treatment of traditional pulmonary rehabilitation and without resistive training for upper limb (UL) and group B will receive the same treatment control with additional training of upper limb strength.
