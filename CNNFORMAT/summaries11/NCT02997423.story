(thirdQuint)Cytochrome C Oxidase Activity in Newly Diagnosed Glioblastoma Multiforme (GBM).
 ...
 In particular, tumors with high CcO activity are associated with shorter OS time as compared to tumors with low CcO activity.

 SOC consists of post-surgical radiation therapy with concurrent Temozolomide followed by up to 12 cycles of adjuvant Temozolomide.
 ...
 Tumor tissue will be submitted by participating centers for measurements of the CcO/Citrate Synthase (CS), MGMT promoter methylation.

 The subjects will agree to receive the SOC treatment.

 The therapeutic option at the time of first recurrence is at the discretion of the treating physician.

 PFS and OS times will be compared with high vs.

 low CcO activity and with the MGMT methylation status of the tumor.

 At the time of death or at 24 months s/p enrollment (whichever comes first), the site PI will complete an exit form documenting the details of enrollees' treatment history and date(s) of any tumor progression.

.

 Cytochrome C Oxidase Activity in Newly Diagnosed Glioblastoma Multiforme (GBM)@highlight
