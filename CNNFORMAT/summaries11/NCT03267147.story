(thirdQuint)PREVALENCE OF Anti-CCP POSITIVITY AND SUBCLINICAL SIGNS OF INFLAMMATION IN PATIENTS WITH NEW ONSET OF NON-SPECIFIC MUSCULOSKELETAL SYMPTOMS.
 ...
 The specificity of anti-CCP antibodies for the diagnosis of RA is high (94.
...
0%).
 ...
 Furthermore, the presence of anti-CCP antibodies at the first visit to the clinician predicts radiographic progression, as demonstrated by many studies that have shown a strong association of anti-CCP positivity with the development of bone erosions.

Early diagnosis of RA coupled with rational use of disease-modifying anti-rheumatic drugs (DMARD) has been shown to have a favourable effect on the course of the disease.
 ...
 In addition, ultrasound will be performed to assess joint inflammation as well as fluorescence optical imaging technique (Xiralite(R)) to sensitively illustrate changes in microvascularisation as a marker of subclinical inflammation.
...
.
 ...
 PREVALENCE OF Anti-CCP POSITIVITY AND SUBCLINICAL SIGNS OF INFLAMMATION IN PATIENTS WITH NEW ONSET OF NON-SPECIFIC MUSCULOSKELETAL SYMPTOMS@highlight
