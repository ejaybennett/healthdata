(thirdQuint)Multicenter Orthopaedic Outcomes Network (MOON) ACL Reconstruction (ACLR): Onsite Follow-up.

 The purpose of this study is identify risk factors for signs and symptoms of osteoarthritis two and ten year post ACL reconstruction from information available at the time of surgery; including patient characteristics (age, gender, body mass index (BMI), activity level, clinical knee alignment), their injuries ("pop" heard at the time of injury, concurrent meniscus, articular cartilage, and collateral ligament injuries), and treatment decisions made during the initial surgery (e.

g.

 meniscus and articular cartilage treatments.
...
.
 ...
 Multicenter Orthopaedic Outcomes Network (MOON) ACL Reconstruction (ACLR): Onsite Follow-up@highlight
