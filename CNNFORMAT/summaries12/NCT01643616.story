(secondQuint)Ultrasound Guided Distal Sciatic Nerve Block - a Comparison With Nerve Stimulator Technique.

 Classical methods for nerve localization (loss of resistance, cause of paresthesias, nerve stimulation technique)assumed that the target is a close approximation to the nerve, without epineural perforation.

 Intraneural injections were considered as evitable, with high risk for nerve damages.

 Ultrasound guidance provided for the first time a real-time visualization of the spread of local anesthetic.

 Some recent studies proved, that an intraneural injection using nerve stimulator technique is common and not necessarily accompanied with nerve damages.
...
.
 ...
 Ultrasound Guided Distal Sciatic Nerve Block - a Comparison With Nerve Stimulator Technique@highlight
