(fifthQuint)PharmacOdynamic compaRison of piTavastatin Versus atOrvastatin on Platelet Reactivity.
 ...
 Levels of platelet reactivity in patients on DAPT can be influenced by concomitant treatment with medications (i.

e.

 statins) that inhibit the CYP3A4 system involved in the activation of clopidogrel.

 Atorvastatin and simvastatin are metabolized by CYP3A4.

 Pitavastatin, unlike other statins, is little metabolized, most of the dose being excreted unchanged in bile, and biotransformation through the cytochrome P450 system is minimal.

 Indeed, pitavastatin's cyclopropyl group diverts the drug away from metabolism by CYP3A4 and allows only a small amount of clinically insignificant metabolism by CYP2C9.
...
.
 ...
 PharmacOdynamic compaRison of piTavastatin Versus atOrvastatin on Platelet Reactivity@highlight

Levels of platelet reactivity in patients on Dual Antiplatelet Therapy (DAPT) can be influenced by concomitant treatment with medications (i.
