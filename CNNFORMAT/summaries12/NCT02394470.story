(fifthQuint)BioImpedentiometry, Lung UltraSound and cONgestion in Heart Failure.
 ...
 Daily body weight, vital signs and fluid balance give only an indirect assessment of the level of congestion.

 Deuterium oxide dilution is the non-invasive reference method for total body water assessment.
 ...
 BIA is a noninvasive method for the study of body composition based on the measurement of body electrical resistance; BIA may allow measurement of whole body and segmental, e.

g.

 pulmonary, fluids.

 However data on the value of BIA for the monitoring of HF patients are still scarce, inconclusive and relative to small cohorts of patients.

 Lung ultrasound (LUS) through evaluation of B-lines, reverberation artifacts in the presence of extravascular lung water has been proposed as a semiquantitative tool to assess pulmonary congestion.

 B lines showed a good correlation with multiple indicators of congestion.
 ...
 Group 3 (Advanced Chronic Heart Failure -Ad-CHF) Ad-CHF patients on periodic levosimendan undergo monthly levosimendan infusions in the outpatient clinic.

 Baseline assessments will be performed the day of levosimendan administration, before infusion start(T0) and after 80 +/- 12 hours, i.

e at the peak haemodynamic effect of levosimendan (Tp).
...
.
 ...
 BioImpedentiometry, Lung UltraSound and cONgestion in Heart Failure@highlight
