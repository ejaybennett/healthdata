(secondQuint)The DESappear Study: Drug Eluting Scaffold.
 ...
 Data will be collected via electronic data capture (EDC) and reportable Events will be reviewed by a medical monitor and classified using the MedDRA system.

 The information entered by the research centres will be source data verified (monitored) by an independent Contract Research Organisation (CRO.

) A Data Monitoring Committee (DMC) with appropriately qualified members independent of the study will meet to review and adjudicate on events at predetermined intervals, according to the charter.

 Primary safety and efficacy endpoints will be evaluated at 6 months There will be no formal hypothesis testing in the study, endpoints will be evaluated with 95% confidence intervals around the observed point estimates.

 The endpoints will be evaluated with Kaplan-Meier methodology.

.

 The DESappear Study: Drug Eluting Scaffold@highlight
