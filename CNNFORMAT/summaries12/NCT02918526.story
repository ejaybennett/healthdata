(thirdQuint)Hemodynamic Study With PRAM of the Cardiovascular Response to the Positioning of the Extraglottic Device.
 ...
 Numerous studies have sought methods to reduce this risk (1-5).

 The extraglottic not involving either laryngoscopy or their passage through the vocal cords, have proven protective of the possible cardiovascular complications resulting from the placement of respiratory prosthesis (6,7).
 ...
 This is a measurement method of the cardio-circulatory performance of a patient that does not require calibration and / or insertion of a pre-estimated data because the method of analysis of the wave form of the arterial pressure is developed completely a priori (8).

 The measurement derives from the simultaneous analysis of the components of a pulsatile flow and the continuous flow as a ratio between the area under the curve of the pulsatile portion of the systolic pressure and the characteristic impedance Z (t).

 The PRAM method has proven effective in many clinical settings (9).

 The Medical Device (DM) will be used in accordance with the indications of use for which it has acquired the CE mark.

 A morphology detection system linked to high blood pressure curve detected through non-invasive Masimo oximetry system supplied to the Hospital will be used Purpose of the study The purpose of the research will be to record the hemodynamic response measured by traditional methods (non-invasive blood pressure and ECG) and PRAM method in patients undergoing placement laryngeal mask compared with the hemodynamic response measured in patients undergoing laryngoscopy and tracheal intubation for performing surgery in gynecological area and assess the differences with the two methods Methods This will be a prospective observational study.

 Data will be collected from all consecutive patients undergoing general anesthesia for gynecologic surgery for a period of 3 months or until the minimum number of 94 patients (see section statistical analysis).

 In the operating room the patient will undergo to active pre-warming with hot air, peripheral venous cannulation and premedication with midazolam 0,04 mg/kg, and fentanyl 1.

5 mcg/kg body weight.

 After the positioning of the standard monitoring systems (ECG, Non-Invasive Blood Pressure, Pulseoximetry, Neuromuscular Transmission), the signal from the Pulseoximetry will also be analyzed by the MostCare monitoring system that allows to apply the measuring method PRAM noninvasively.

 After 3 minutes of high flows O2, propofol 2 mg/kg body weight and rocuronium 0.

9 mg/kg body weight will be administered sequentially to the patient.

 Anesthesia will be maintained with propofol continuous infusion (9-12 mg/kg body weight /hour) and remifentanil continuous infusion (0.

2 mcg/kg body weight /minute ).

 At the disappearance of the adductor muscle response to electrical stimulation of the thumb "Train of four" (TOF) applied to the ulnar nerve the positioning maneuver of the respiratory device will be performed: - with direct laryngoscopy in the case of endotracheal intubation - with direct insertion in the case of laryngeal mask placement.

 Proper placement will be evaluated by chest auscultation, spirometry and analysis of the concentration and the carbon dioxide curve in exhaled gases.
...
.
 ...
 The two groups will be compared on the basis of age and anthropometric parameters.

 An analysis of the hemodynamic response of the two groups of patients to the positioning of the respiratory device will then conduct.

 Statistical analysis A recent study (11), that analyzed the cardiac index changes in response to tracheal intubation with laryngoscope Mcintosh in comparison to the video laryngoscope laryngoscopy, showed a difference of 1 L/min/m2 (from 3.
...
4 with laryngoscope McIntosh vs 3.
...
.
 ...
 Hemodynamic Study With PRAM of the Cardiovascular Response to the Positioning of the Extraglottic Device@highlight
