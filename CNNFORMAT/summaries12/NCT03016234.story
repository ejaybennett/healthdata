(fifthQuint)IOP Changes With Different Anesthetic Agents During Laparoscopic Colorectal Surgery.
 ...
 After measurement of initial IOP with topical opthalmic anesthetics, general anesthesia will be induced with pentothal sodium 5-6mg/kg (group D) or propofol (group P) 2-2.
...
.
 ...
 IOP Changes With Different Anesthetic Agents During Laparoscopic Colorectal Surgery@highlight
...
This study is aimed to evaluate how intraocular pressure (IOP) is changed depending on surgical position (Trendelenburg versus reverse Trendelenburg) in the same patient and to compare the effects of different anesthetics on IOP (desflurane versus propofol) in patients undergoing laparoscopic colorectal surgery.
 ...
 Mean arterial blood pressure, peak airway pressure, end tidal carbon dioxide, and IOP (using a Tono-pen(R) Avia tonometer) on both eyes were measured at defined intervals during the procedure.
