(firstQuint)Respiratory Monitoring During Right Heart.

 Differentiation between different kinds of pulmonary hypertension (PHTN) requires right heart catheterization.

 Monitoring heart failure patients is challenging in many.

 The study will enroll patients undergoing right heart catheterization (RHC) for the evaluation of heart failure and PHTN, based on the regular clinical practice.

 The regular indices as the right ventricle pressure (RVP), pulmonary artery pressure (PAP), pulmonary artery wedge pressure (PAWP), and cardiac output will be measured with the Swan Ganz Catheter and recorded.
...
.
 ...
 Respiratory Monitoring During Right Heart@highlight
