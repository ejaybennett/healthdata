(fifthQuint)Role of Angiogenesis in Dermatologic Diseases: A Potential Therapeutic Target.

 Previously or newly collected biospecimens from various dermatologic diseases including port wine stains, hemangiomas, angiofibromas, Kaposi's sarcoma, angiosarcoma, scars, rosacea and psoriasis will be evaluated for markers of angiogenesis.

 Additionally, researchers can use discarded human skin tissue samples from skin biopsy/surgery sites which are removed for closure but are not submitted for histopathologic analysis.
 ...
 Additional, tissue samples will be used to isolate three cell types: endothelial cells, keratinocytes, and fibroblasts.

 Tissue samples will be digested to isolate the cells which will be cultured separately and then incorporated into an in-vitro model to observe how blood vessels form in skin affected by port wine stains as compared to vessel growth in unaffected skin.

.

 Role of Angiogenesis in Dermatologic Diseases: A Potential Therapeutic Target@highlight
