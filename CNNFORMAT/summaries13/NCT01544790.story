(fifthQuint)Robot-assisted Thoraco-laparoscopic Esophagectomy Versus Open Transthoracic Esophagectomy.

 Rationale: As stated in the 2010 revised Dutch esophageal carcinoma guidelines, the golden standard for surgical treatment of esophageal carcinoma is open transthoracic esophagectomy.

 Recent evidence suggests that robot-assisted thoraco-laparoscopic esophagectomy using the Da Vinci (R) robot can provide an extensive resection, with possibly better or at least equal radical (R0) resection rates and an equal number of dissected lymph nodes.

 This is accompanied with markedly reduced blood loss and reduction of overall complications with shorter intensive care unit (ICU) and hospital stay.

 Therefore, the robot-assisted thoraco-laparoscopic esophagectomy is now at a stage that it should be compared to the current standard of care in a randomized controlled trial.
 ...
 Patients will receive the following interventions: Group A.

 Robot-assisted thoraco-laparoscopic esophagectomy, with gastric conduit formation.

 Group B.

 Open transthoracic esophagectomy, with gastric conduit formation.
 ...
 Robot-assisted Thoraco-laparoscopic Esophagectomy Versus Open Transthoracic Esophagectomy@highlight
