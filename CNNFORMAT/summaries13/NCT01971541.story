(fifthQuint)Groups for Regaining Our Wellbeing (GROW).
 ...
 In an exploratory aim, we will also assess whether there is a clinically meaningful response as defined by improvement in both PTSD symptoms and QOL (defined as a reliable change of 12 points on the CAPS and 10 points on the MCS, respectively, according to the reliable change index).

7, 8 One hundred fifty-two Veterans with PTSD will be randomized to MBSR (n = 76) or CPT-C (n = 76).
...
.
 ...
 Groups for Regaining Our Wellbeing (GROW)@highlight
