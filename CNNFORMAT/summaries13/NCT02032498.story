(fifthQuint)Evaluation of Two Techniques for the SLN Detection in BC Patients.
 ...
 The radioactive SLN would be retrieved ex vivo in the axillary piece (with the gamma probe, after intramammary and peritumoral injections of radiocolloids the day before the surgery, or at least 3 hours before, with scintigraphic preoperative images as already performed routinely for patients described in the introduction 1 of this letter).

 These radioactive lymph nodes would thereafter been controlled for their possible fluorescence (with our fluorescence camera and after periareolar injection of ICG in the operating room just before the surgery).

 Finally, in the service of Pathology, all the lymph nodes found by the pathologist in the axillary piece will be controlled for their possible fluorescence.

 With this approach, the surgeon will not have to search for SLN and the operative duration will not be extended.

 Secondary objectives: The current literature about the results of SLNB technique has not yet considered the influence of the addition of SPECT-CT imaging (standard approach in our institute since more than 3 years) to planar imaging.
 ...
 The fluorescence of the detected lymph nodes will be analysed semi-quantitatively and related to their pN+ characteristics (pNi, pN mu , pN1, pNmacro).

 This first analysis may have major implications when our surgeons will perform an in vivo research of fluorescent SLN (see also Bourgeois et al.

 2003).

 Finally, we propose to analyse the kinetic and the vascular characteristics (aspects of the vessels on the images) of ICG migration from its injection point to the axilla.

 We will try to define possible predictive parameters of extended and/or macroscopic involvement of axillary lymph nodes.

.

 Evaluation of Two Techniques for the SLN Detection in BC Patients@highlight
...
The revision of our data shows that since its introduction in our institution (Jules Bordet Institute) in 1998 (until 2010, the year of the last review of cases), 53 patients underwent neoadjuvant therapy before selective sentinel lymph node dissection followed by conventional axillary dissection.
 ...
 The analysis of these cases shows that: - The lack of demonstration of sentinel lymph nodes observed in 8 cases (6 cN0) is associated in 75% of them with a pN+ status - If scintigraphic imaging is "positive" (demonstration of the sentinel lymph nodes: 35 cN0 and 10 cN+), our results appear favorable with a single false negative SLN result (False Negative Rate = 1/20 or 5%).
