(secondQuint)Duration of Benefit for OnabotulinumtoxinA in Treatment of Chronic Migraine.

 Recognizing a commitment to evidence-based science as the pathway to optimize clinical outcomes for patients with chronic migraine (CM) we believe this investigator initiated study (IIS) will: 1.

 Help clinicians recognize the importance of scheduling patients with CM at intervals not exceeding 12 weeks.

 2.

 Provide biopsy evidence supporting sensory mechanisms involved in the mechanism of action (MOA) of onabotulinumtoxinA (BTX).

 This does not exclude potential valuable contributions of denervation of motor neurons, but may support a more balanced and understandable mechanism for BTX in treating CM.

 3.

 Provide clinicians important educational information for patients to better manage expectations of using BTX in managing CM and answering critical questions such as: 1.

 How long does it take for BTX to begin providing a clinical benefit? 2.

 What is the expected duration of this benefit? - Failure to understand unmet expectations either real or otherwise results in defining BTX treatment as a failure by patients and/or clinicians.
 ...
 This study proposes to accomplish these goals through an exploratory comparison of the clinical efficacy and natural history of BTX measured at weekly time intervals.

 Subjects reporting short (10 weeks) duration of clinical benefit will provide the primary comparison.

 Histological examinations (in a subset of subjects) of neuronal changes associated with regeneration of terminal neuronal endplates will be used to support these clinical observations.

 This study will follow subjects through 3 injection cycles or 36 weeks.

 Biopsies will be performed on consenting subjects prior to their first and second injection cycles.

 Group Assignment At Visit 3, subjects will be assigned to one of three groups (Groups A, B, C) based on their answers to the following questions: 1.

 Since your last BTX treatment, do you think there has been improvement in your chronic migraine? If the answer to Q1 is yes, subject will answer Q2 and Q3.

 If the answer is no, subject is assigned to Group C and no further answers are required: 2.

 How many days did it take for you to first notice benefit from BTX injections? 3.

 How long did you feel you received benefit from BTX (number of weeks)? Subjects will be assigned into 3 groups: 1.

 Group A are subjects reporting 10 or less weeks of benefit from BTX; 2.

 Group B are subjects reporting >10 weeks of benefit from BTX; 3.
