(thirdQuint)Timing of Complete Revascularization for Multivessel Coronary Artery Disease in STEMI.
 ...
 complete revascularization of all non-culprit significant lesions in a single session during initial hospitalization; 2.

 same revascularization in a single session after 30 days; 3.

revascularization or it's deferral based on ischemia testing using Dobutamin stress echocardiography.
...
.
 ...
 Timing of Complete Revascularization for Multivessel Coronary Artery Disease in STEMI@highlight
