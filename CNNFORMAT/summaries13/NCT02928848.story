(secondQuint)Baseline Severity and tDCS in PPA.
 ...
 In the current study, the investigators are examining whether tDCS could be used to enhance language abilities (e.

g.

, picture naming) in individuals with PPA variants primarily characterized by difficulties with speech production (non-fluent and logopenic).

 Participants are being recruited from the Penn Frontotemporal Dementia Center to receive 10 days of both real and sham tDCS (counter-balanced, full-crossover design; participants are naive to stimulation condition).
...
.
 ...
 Baseline Severity and tDCS in PPA@highlight

In the present sham-controlled study, the investigators examine whether tDCS could be used to enhance language abilities (e.
