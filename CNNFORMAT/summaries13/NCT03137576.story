(firstQuint)Erector Spinae Plane Block Versus Paravertebral Block During Non-intubated Thoracoscopic Lung Resections.
...
.
 ...
 ESPB will be compared with a largely employed procedure for loco regional pain management: the Paravertebral block (PB).

 Both procedures are performed under ultrasonographic guidance to allow proper visualization of the target site.

 Surgery is carried out by means of a minimally invasive approach (Video Assisted thoracic Surgery) with two keyhole incisions on the affected side.
