(fifthQuint)Severe Alcohol-use Disorder: a tDCS and Response Inhibition Training Intervention.

 Treating Alcohol dependence remains notoriously difficult despite use of several medications, psychotherapeutic and psychosocial interventions.

 Alcohol dependence is thought to reflect an abnormal interplay between two neural systems: an overly active impulsive one driven by immediate rewards prospects and a weak reflective one, tuned on long-term prospects.

 The investigators proposes that two non-pharmacological interventions, Transcranial Direct Current Stimulation (tDCS) and Inhibitory Control Techniques (ICT) may act on both systems when combined.

 tDCS has been found to improve working memory, which is necessary to evaluate long-term consequences of actions.

 ICT is able to modify the automatic approach tendencies towards appetitive cues.
...
.
 ...
 Severe Alcohol-use Disorder: a tDCS and Response Inhibition Training Intervention@highlight
