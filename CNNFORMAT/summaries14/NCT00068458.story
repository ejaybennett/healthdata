(thirdQuint)Survival TRaining for ENhancing Total Health (STRENGTH).

 OBJECTIVES: - Compare the efficacy of exercise alone or combined with a modified diet as home-based interventions to prevent increases in body fat during adjuvant chemotherapy in women with stage I, II, or IIIA breast cancer.
 ...
 OUTLINE: This is a pilot, randomized, multicenter study.

 Patients are stratified according to body mass index (no more than 25 kg/m^2 vs more than 25 kg/m^2), race (white vs non-white), and prior exercise history (vigorous exercise of at least 30 minutes, 3 times a week prior to diagnosis) (yes vs no).
...
.
 ...
 Survival TRaining for ENhancing Total Health (STRENGTH)@highlight
