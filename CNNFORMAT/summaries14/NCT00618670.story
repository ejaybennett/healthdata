(secondQuint)Home-based vs.

 Supervised Exercise for People With Claudication.
 ...
 Further, both the home-based and supervised exercise rehabilitation programs will result in greater changes in ambulatory function, vascular function, and health-related quality of life than a light resistance training exercise program.

 Finally, we hypothesize that the changes in walking efficiency, calf muscle circulation, and calf muscle oxygen will each be predictive of improved ambulation following the home-based exercise program as well as the supervised exercise program.

 The 3-month program will consist of walking 3 times per week, with progressive increases in duration and intensity.

 The two walking exercise programs will be matched on the estimated caloric expenditure during the training sessions.

 Patients in the control group will perform light resistance training without any walking exercise.

.

 Home-based vs.

 Supervised Exercise for People With Claudication@highlight
