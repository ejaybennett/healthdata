(thirdQuint)Studying Blood and Tumor Tissue Samples in Women With Invasive Breast Cancer, Ductal or Lobular Carcinoma in Situ, or Benign Breast Disease.
 ...
 Secondary - To perform exploratory studies identifying potential targets for novel nucleic acid and proteomic-based early detection assays.

 OUTLINE: Patients undergo baseline peripheral blood specimen collection pre-biopsy and then periodically for up to 10 years.

 Specimens are analyzed for circulating tumor cells via quantitative real-time reverse-transcriptase PCR, immunofluorescence, and bidirectional pyrophosphorolysis-activated polymerization allele-specific amplification; and for protein profiles via mass spectometry, liquid chromatography, enzyme digestion, and tandem mass spectometry.

 Patients' tumor tissue (invasive breast cancer [IBC] only) is analyzed for p53 via IHC.
...
.
 ...
 Studying Blood and Tumor Tissue Samples in Women With Invasive Breast Cancer, Ductal or Lobular Carcinoma in Situ, or Benign Breast Disease@highlight
