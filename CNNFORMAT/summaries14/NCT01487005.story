(thirdQuint)Cardiovascular Effects of Exposure to Ozone.
 ...
 The study is based on the suppositions that: 1) elderly people are a susceptible group for cardiovascular effects; and 2) effects are more likely with exercise.

 The study will involve approximately 90 healthy volunteers aged 55 and 70 who meet strict criteria for inclusion.

 They will be exposed for 3 hours to clean air, 0.

07 ppm O3 (near the current NAAQS), and 0.

12 ppm O3 (a level measured in several locations in the US).

 A suite of cardiovascular and pulmonary endpoints will be measured on the day before the exposure and up to 22 hours after the exposures.

 The study is being conducted at three centers using a common protocol and common SOPs.

 Most the endpoints will be analyzed by core laboratories to reduce the variability in the results.

 A Data Coordination and Analysis Center will assemble all the data generated by the three centers and conduct the statistical analyses on the combined data sets.

 The study has 3 main objectives: 1.
...
.
 ...
 Cardiovascular Effects of Exposure to Ozone@highlight
