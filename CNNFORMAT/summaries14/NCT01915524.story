(thirdQuint)Trial of RNActive-Derived Cancer Vaccine and Local Radiation in in Stage IV Non Small Cell Lung Cancer (NSCLC).

 The Phase Ib study is the first clinical study with the new lung cancer vaccine CV9202.

 The vaccine is composed of 6 RNActive compounts, each encoding for a different antigen which is overexpressed in NSCLC compared to healthy tissue.
 ...
 Patients will be enrolled into 3 strata based on histologic and molecular subtypes as follows: Stratum 1: Patients with metastatic stage IV NSCLC and non-squamous histology, without activating epidermal growth factor receptor (EGFR) mutations, who have achieved partial response (PR) or stable disease (SD) after at least 4 cycles of platinum- and pemetrexed-based first-line chemotherapy, and an indication for maintenance therapy with pemetrexed.
...
.
 ...
 Trial of RNActive-Derived Cancer Vaccine and Local Radiation in in Stage IV Non Small Cell Lung Cancer (NSCLC)@highlight
