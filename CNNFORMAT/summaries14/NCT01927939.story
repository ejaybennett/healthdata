(fifthQuint)18F-FDG PET Metabolic Phenotype in Evaluating Therapeutic Response for Breast Cancer Patients With Bone Metastases.

.

 Background: Although 99mTc MDP bone scintigraphy is a sensitive tool for screening metastatic bone status, it is not a satisfactory imaging modality in evaluating residual disease after therapy.

 18F-FDG PET has been an effective imaging tool for many malignancies including breast cancer, not only in diagnosis and staging, but also in monitoring response and following up disease status after therapy.
 ...
 Primary outcome: Using 18F-FDG uptake to evaluate the metastatic bone status after treatment.

 The PET results will be compared with the results in Tc-99m MDP bone scintigraphy.
