(firstQuint)Use of Touch and no Touch Guide-wire Techniques for Deep Biliary Cannulation: the TNT Study.
...
3%.
 ...
 More importantly, significantly reduced the incidence of PEP from 8.

6% to 1.

6%.

 There are several variations of this technique; the tip of the sphincterotome is inserted initially a few millimeters through the papillary orifice and then introduce the guide-wire to the target ("touch technique").

 Another variation is direct cannulation with the guide-wire hovering a few millimeters through the catheter or sphincterotome ("no touch technique").
...
.
 ...
 Use of Touch and no Touch Guide-wire Techniques for Deep Biliary Cannulation: the TNT Study@highlight
