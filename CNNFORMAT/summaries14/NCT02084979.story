(thirdQuint)A Controlled Trial of Patient Centered Telepsychiatry Interventions.

 This project addresses a critical public mental health problem: the need to improve access to high quality, mental health services for diverse populations through improving the flow of clinical work across care settings (primary care and specialty care) by implementing an efficient, provider compatible, administratively simple health IT solution: Asynchronous Telepsychiatry.

 To assess the impact of this novel approach, this two-year randomized controlled trial of clinical outcomes seeks to evaluate the superiority of the asynchronous telepsychiatry (ATP) consultation model on access, quality, cost and outcomes of care over the usual care for adults referred from primary care clinics for psychiatric evaluation and treatment.
...
.
 ...
 A Controlled Trial of Patient Centered Telepsychiatry Interventions@highlight
