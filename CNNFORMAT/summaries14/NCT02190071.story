(secondQuint)Comparison Between Base and Cover Slide From Endoscopic Ultrasound Guided Fine Needle Aspiration for Pancreatic Cancer.
 ...
 - cytologic smear (by pull apart method) - cell block - histologic biopsy 4.
 ...
 One identical and skilled pathologist inspects these slide in blind method.

 (She cannot show the label of bottle so that she does not know what bottle is A or B.

) 6.

 She record the positive or negative in each bottle.

 (If there is only one slide is positive in malignant cell, the bottle is positive.

) 7.

 In these manner, we collect the all subjects' cytopathologic results as a pair of outcome.

 All the possible combinations are following four examples: - (cover/base) = (positive/positive) = (+/+) - (cover/base) = (positive/negative) = (+/-) - (cover/base) = (negative/positive) = (-/+) - (cover/base) = (negative/negative) = (-/-) 8.

 Then we are going to take a two-sided non-inferiority test of proportion using McNemar's test.

.

 Comparison Between Base and Cover Slide From Endoscopic Ultrasound Guided Fine Needle Aspiration for Pancreatic Cancer@highlight
