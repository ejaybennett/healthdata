(secondQuint)Nutrient-Dense Complementary Foods on Catch-up Growth and Nutritional Status of Stunting Children.
 ...
 Data from food consumption survey will be use to develop optimized CFRs by using Linear Programming (LP) approach with software Optifood v 2.

0.

 Data from LP analysis such as nutrient gaps will be use to formulate fortified biscuit (3 type of nutrient dense).

 Biscuit ingredients will use local foods.

 Acceptability trials will be conducted to see the acceptance of the biscuit in the community settings (color, smell, taste and portion).
 ...
 Intervention -- optimized CFRs + Biscuits (3 groups) Biscuits will be distributed for 6 days consumption per week (12 months).

 The waste of the biscuits will be weighted to get actual biscuit consumptions.

 Mothers/caregivers will be encouraged to practice CFRs to improve child's nutritional adequacy.

 Monthly body weight and length/height measurement.

 Nutrition education for mothers/caregivers by field staff.
 ...
 Nutrient-Dense Complementary Foods on Catch-up Growth and Nutritional Status of Stunting Children@highlight
