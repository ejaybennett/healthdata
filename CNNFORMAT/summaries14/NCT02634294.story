(fifthQuint)Peg Interferon -2b for Relapsed Hematological Malignancies After Allo-HSCT.
 ...
 Eligible patients were treated with pegylated interferon alpha-2b (Peg Intron(R); Schering-Plough (Brinny) Company, Innishannon, County Cork, Ireland) 1~1.

5ug/kg qw, until occurrence of grade II or higher grade of acute GVHD, or no response to treatment after 8 doses of treatments.

 Patients were followed up every week.

 Physical exams and blood tests including complete blood count (CBC), chemical were performed every week.

 Disease status evaluation was performed every month.

 Number of subjects: 50 Single center, one group, prospective.

.

 Peg Interferon -2b for Relapsed Hematological Malignancies After Allo-HSCT@highlight

Aim: to observe the graft versus tumor effect of Pegylated Interferon-2b in patients with hematological malignancies relapsed after allogeneic hematopoietic stem cell transplantation (alloHSCT) Patients: patients relapsed after alloHSCT, men and women aged 14-60 years, without vital organ dysfunction or ongoing graft-verus-host disease (GVHD).

 Number of subjects: 50, Single center, one group, prospective.

 Drug: pegylated interferon alpha-2b (Peg Intron(R); Schering-Plough) 1~1.
