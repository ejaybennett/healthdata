(firstQuint)Schema Therapy for Chronic Depression.
 ...
 A total sample size of 64 (32 in each group) would be required to provide 80% power at a 2-sided significance level of 5% to detect a risk difference of 35% (response rate: 55% for schema therapy vs.

 20% for active monitoring), assuming a dropout rate of 10%.

.

 Schema Therapy for Chronic Depression@highlight
