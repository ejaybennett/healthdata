(thirdQuint)Efficacy of Chlorhexidine as a Final Irrigant in Single-visit Root Canal Treatment.
 ...
 Ninety asymptomatic maxillary anterior teeth with periapical lesions were treated by a single operator using the step-back technique with manual instrumentation with 2.

5% sodium hypochlorite (NaOCl) and 5% ethylenediaminetetraacetic acid (EDTA) as irrigants.
 ...
 Postoperative pain at 24-48 hours and changes in apical bone density indicating radiographic healing were evaluated statistically using the Mann-Whitney U-test followed by the Friedman and the Wilcoxon tests (=.

05).

.

 Efficacy of Chlorhexidine as a Final Irrigant in Single-visit Root Canal Treatment@highlight
