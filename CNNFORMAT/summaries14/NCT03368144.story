(fifthQuint)Belgian Trial Evaluating the ClearLumen II Peripheral Thrombectomy System Recanalization of (Sub)Acute Thrombotic Femoropopliteal Occlusions.
 ...
 Patients should also be geographically stable, willing and able to cooperate in this clinical study and remain available for follow-up.
 ...
 During the procedure, the occlusion needs first to be recanalized by conventional guidewire technique, since the ClearLumen II Peripheral Thrombectomy System is an over-the-wire system (0.

035").

 After assessment of the lesion by angiography via a common femoral artery approach (contralateral/ipsilateral) the occlusion is intraluminally crossed with the wire according to physician's discretion.

 Afterwards, the device is introduced and the catheter is activated.

 Then the catheter is slowly advances into the occlusion.

 Several passages of the occlusion may needed to clean out all wall-adherent thrombotic material.
 ...
 The regular follow-up is necessary to monitor the condition of the patient and the result of the procedure.

 Patients will be invited for a follow-up visit 1 month after the index procedure.

 The following data will be collected during this follow-up visit: medication record, physical examination, rutherford categorization, ABI and color flow doppler ultrasound.

.

 Belgian Trial Evaluating the ClearLumen II Peripheral Thrombectomy System Recanalization of (Sub)Acute Thrombotic Femoropopliteal Occlusions@highlight
