(firstQuint)An Epidemiologic Study on PD-L1 Expression Combined With Clinical Observation in the Chinese MIUBC Patients.

.

 The primary objective of this observational study is: cent To investigate the prevalence of high PD-L1 expression in Chinese MIUBC patients.
 ...
 Note: PD-L1 High (>=25% tumor cell membrane positivity for PD-L1 or 1) IF IC area >1%: >=25% tumor associated immune cell positivity for PD-L1; 2) If IC area=1%: 100% tumor associated immune cell positivity for PD-L1).

 PD-L1 Low if criteria not met for PD-L1 High.

 The second objectives of this observational study are: - To investigate the PD-L1 expression profile in TC or IC in Chinese MIUBC patients.
 ...
 The exploratory objectives of this observational study are: - To explore the relationship between the demographic characteristics and expression of PD-L1 and other exploratory biomarkers including immune cell (IC) subset CD8+ T cells, tumor mutation burden (TMB), neoantigen burden and gene expression level.
