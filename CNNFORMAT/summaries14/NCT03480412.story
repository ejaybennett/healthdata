(fifthQuint)Second Step Protocol in Poor Ovarian Responder (POR).
 ...
 According with the Bologna Criteria we can diagnose a Poor Ovarian Response or an expected Poor Ovarian Response when at least two of the following three features are present: - Advanced maternal age (40 years) or any other risk factor for POR; - A previous POR (3 oocytes with a conventional stimulation protocol); - An abnormal ovarian reserve test (i.

e.

 AFC -Antral Follicular Count- 5-7 follicles or AMH ,0.

5-1.

1 ng/ml).

 The diagnosis and the prediction of poor ovarian response consent the selection of the best treatment with the aim of the retrieval of an high number of oocytes.
 ...
 The Luteal Phase Stimulation was initially proposed for fertility preservation procedures, but in last years is used in POR patients too.

 The recently diffused "wave theory" support this technique.

 According to the wave theory two or three cohorts of antral follicles are recruited during the follicular and luteal phase of each ovarian cycle and in one of this follicular wave will be selected the dominant follicle.

 A trial performed in 2014 (Kuang et al, 2014) pubblished results of repeated luteal phase stimulation (Shanghai Protocol) showing that double ovarian stimulations in the same menstrual cycle provide more opportunities for retrieving oocytes in poor responders.

 More recently another trial (Ubaldi et al 2016) did not observe significant differences in term of number of oocytes retrieved and euploid blastocyst rate from follicular versus luteal phase stimulation.
 ...
 When at least two follicles had reached 17-18 mm in diameter, ovulation will be triggered with a single subcutaneous bolus of urinary human chorionic gonadotropin (10.

000 UI ) and oocyte retrieval will be performed after 35 hours.
...
.
 ...
 Second Step Protocol in Poor Ovarian Responder (POR)@highlight
