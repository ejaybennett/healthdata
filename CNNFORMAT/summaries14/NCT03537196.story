(fifthQuint)DRug Use & Infections in ViEtnam - Hepatitis C (DRIVE-C).

 Objectives : The primary objective of this study is to assess the effectiveness of a model of hepatitis C screening and integrated care targeting PWIDs in Hai Phong, Vietnam.

 This model will encompass all steps involved in achieving HCV cure among PWIDs: i) Mass detection of hepatitis C infection among PWIDs: in the community through a large community-based Respondent Driven Sampling survey (RDS); and in OPC and methadone treatment centers where serological testing should have been made, but not HCV RNA to confirm hepatitis C infection.
 ...
 The strategy of care includes a large community-based mass screening, a simplified treatment protocol based on a combination of DAAs, taking into account co-morbidities (addiction, HIV), physician training and important support of CBOs for linkage to care after screening, treatment adherence and prevention of reinfection after cure.

 In addition, 2 others components are included in thestudy: - A modeling exercise to assess the impact of the intervention at the population level, - A cost-effectiveness analysis to further inform policy-makers.

 Patients will be followed for 48 weeks after initiating HCV treatment.

 The estimated enrolment is 1050 participants.
 ...
 Participant recruitment will take place through DRIVE RDS survey and DRIVE cohort follow-up visit in two community sites managed by peer-groups in Hai Phong.

 All participants with positive HCV serology will be screened for hepatitis C and positive HCV RNA will be proposed for DAA treatment in 3 hospital-based HCV clinics.
 ...
 The primary endpoint is the proportion of all patients in success of the model of care, defined by HCV RNA < 15 IU/mL at the end of the study (Week 48 visit).

.

 DRug Use & Infections in ViEtnam - Hepatitis C (DRIVE-C)@highlight

The study aims to assess the effectiveness of a model of hepatitis C screening and integrated care, targeting people who inject drugs (PWIDs) in Hai Phong, Vietnam.

 In a wider perspective, this model linked to mass screening through repeated Respondent Driven Sampling (RDS) surveys, to simplified treatment protocol, and to large community-based support to improve referral to care, retention in care, adherence to treatment and prevention of reinfection, may have the potential to eliminate HCV among PWIDs in this city.
