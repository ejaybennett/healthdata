(fifthQuint)Umbrella Review of the DASH Dietary Pattern and Cardiometabolic Risk.

 Background: The DASH Dietary Pattern, which emphasizes intake of fruits and vegetables, low-fat or non-fat dairy, nuts, and legumes and limits saturated fat and red meat intake, is associated with reduced cardiovascular disease and diabetes risk in prospective cohort studies and has been shown to lower blood pressure and other intermediate cardiometabolic risk factors in randomized controlled trials.

 Despite the endorsement of the DASH Dietary Pattern by major international diabetes and cardiovascular guidelines, the European Association for the Study of Diabetes (EASD) guidelines for nutrition therapy have not made any specific recommendations for the DASH dietary pattern.

 The present umbrella review using the Grading of Recommendations Assessment, Development, and Evaluation (GRADE) approach was commissioned by the Diabetes and Nutrition Study Group (DNSG) of the EASD to summarize the available evidence from recent systematic reviews and meta-analyses of prospective cohort studies and randomized controlled trials of the relationship between the DASH dietary pattern and cardiometabolic risk.

 Need for proposed research: Public health policy and clinical practice guidelines are established with the use of systematic reviews and meta-analyses of randomized controlled trials and prospective cohort studies, which are regarded as the highest levels of evidence.

 As dietary guidelines and public health policy have shifted toward food and dietary-pattern based recommendations, there is a need to summarize the evidence from systematic reviews and meta-analyses assessing the effect of the DASH dietary pattern trials on cardiometabolic risk factors.
 ...
 Data sources: MEDLINE and EMBASE will be searched using appropriate search terms.
 ...
 Data extraction: Two or more investigators will independently extract relevant data and assess risk of bias of the individual studies using the Newcastle-Ottawa Scale for observational studies and the Cochrane Risk of Bias Tool for controlled clinical trials.

 All disagreements will be resolved by consensus.

 Outcomes: The primary outcome will be incident cardiovascular disease (CVD) in the prospective cohort studies and systolic blood pressure in the randomized controlled trials.

 Secondary outcomes will include incident coronary heart disease (CHD), stroke, and diabetes in the prospective cohort studies and diastolic blood pressure, blood lipids (total-C, LDL-C, HDL-C, and triglycerides), glycemic control (HbA1c, fasting blood glucose, fasting blood insulin, homeostasis model assessment of insulin resistance [HOMA-IR]), adiposity (body weight), and inflammation (C-reactive protein).
