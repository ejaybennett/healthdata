(thirdQuint)Quality of Life in Patients Undergoing Radiation Therapy for Primary Lung Cancer, Head and Neck Cancer, or Gastrointestinal Cancer.

 OBJECTIVES: - To determine if patient-reported quality of life (QOL) can be improved by the real-time use of QOL data in patients with primary lung, head and neck, or gastrointestinal cancer undergoing radiotherapy.
 ...
 - Group 1 (control): Patients complete QOL assessments (e.

g.

, the Linear Analog Self Assessment [LASA]) at weeks 1, 3, and 5 during treatment and the last week of treatment.

 They also complete the Interpersonal Patient-Provider Relationship Scale (IPPRS) and Was it Worth It (WIW) questionnaires on the final day of treatment.

 Data is not shared with the physician, the patient, or any other clinical assistant that may be supporting the physician (e.

g.

 nurse, or nurse practitioner).

 - Group 2 (active): Patients complete QOL assessments (e.

g.

, LASA) and the IPPRS and WIW questionnaires as in group 1.

 Information from the questionnaires is shared with the physician, nurse, and/or nurse practitioner and the patient immediately prior to the on-treatment visit.

.

 Quality of Life in Patients Undergoing Radiation Therapy for Primary Lung Cancer, Head and Neck Cancer, or Gastrointestinal Cancer@highlight
