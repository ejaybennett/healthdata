...
.
 ...
 The cohort will be ascertained using: - the medical records from the treatment centers in order to characterize the childhood cancer, estimate doses of radiotherapy received by all organs and measure the chemotherapy administered; - the French National Identification Registry and the French Death Registry in order to obtain the vital status and the causes of the deaths for the former patients - a self-questionnaire that covers the entire future of the survivors (e.

g.

 social status, family network, fertile offspring, access to care, access to bank loans, occupation,.
...
.
 ...
 In an initial cohort, we have already studied the iatrogenic effects of the cancer treatments.

 We have estimated the doses of ionising radiations delivered by radiotherapy to the target volume and by organs at distance.
...
.
 ...
 French Childhood Cancer Survivor Study@highlight
