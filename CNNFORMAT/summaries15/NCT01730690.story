(fifthQuint)Bacterial Meningitis in Adults: Analysis of the Determinants of Mortality and Neurosensory Sequelae.

 Introduction: Bacterial meningitis is a rare (about 1,200 cases per year in France, 50% occurring in adults) and serious disease (20% mortality during the acute phase; neurosensory sequelae in 30% of survivors).
 ...
 No standardized clinical, microbiological and prognostic data collection concerning bacterial meningitis in adults is available in France.
 ...
 Secondary objectives: To describe the epidemiological characteristics of community-acquired bacterial meningitis in adults, changes in these characteristics and their relations with the vaccine status of the affected adult and his/her family; to characterize clinical and microbiological failures and their determinants (pharmacological, microbiological, immunological, etc.

); to analyse the determinants of neurosensory sequelae and failure to return to work after 1 month, 6 months and 12 months.

 Primary endpoint: In-hospital mortality (D30).

 Secondary endpoints: History including vaccination of the case and the family, clinical, microbiological (species, susceptibility, virulence factors, cerebrospinal fluid CSF) culture on D0 and H48), imaging characteristics; treatments, CSF antibiotic concentrations, neurological sequelae (modified Rankin, Glasgow Outcome Scale, IQCODE) at M1, M6 an M12, quality of life test SF12, WHO QoL, CESD) at M1, M6, M12, hearing loss (audiometric tests, hereditary hearing impairment (HHI), telephone speech test in noise) at M1, M6, M12.

 Methodology, study design: National observational cohort study with comprehensive recruitment in participating centres.

 Legal classification of the project: Epidemiological study.

 Number of subjects required: The inclusion of 150 cases of meningitis per year would allow the collection of about 450 cases over a period of 3 years.

 For a mortality rate of 20%, we would be able to estimate this percentage with a confidence interval of 3.

7% (95% confidence interval: 16.

3-23.

7).

 With 90 deaths, a power of 80% and a level of significance of 5% (two-tailed), this sample size would demonstrate relative risks of 1.

8 for a prevalence of the risk factor of 25% and 2.

6 for a prevalence of the risk factor of 10%.
 ...
 Non inclusion criteria: Age less than 18 years old or refusal to participate.

 Inclusion period: 3 years.

 Duration of participation for one patient: 12 months.

 Number of participating centers: Constitution in participating centers of a dual investigator team comprising a clinician (infectious diseases physician, intensive care physician, or neurologist) and a microbiologist (participating in the national network of "OBSERVATOIRES REGIONAUX DU PNEUMOCOQUE" [Regional Pneumococcal Observatories]).

 Declaration by the microbiologist to the data management centre.

 On-site validation of cases by the dual investigator team and then by a national multidisciplinary validation unit.

 Mean number of inclusions per month and per centre: 0.

5.

 Bacterial Meningitis in Adults: Analysis of the Determinants of Mortality and Neurosensory Sequelae@highlight
