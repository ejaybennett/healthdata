(thirdQuint)Health Outcomes of Recently Diagnosed Myelodysplastic Syndrome (MDS)/Chronic Myelomonocytic Leukemia (CMML) Patients Depending on Treatment Strategy (Wait and See, Support, Active Treatment).
 ...
 The minimum follow-up period of a participant patient will be 36 months from recruitment, until survival can be documented, differentiating between 1.

 Patients starting immediate active treatment: data will be collected every 3 months or every time an event arises during the active treatment phase.

 After the final dose of the initial treatment therapy, data collection will take place every 6 months during the post-treatment follow-up phase, regardless of the number of times the patient attends medical appointments, up to a minimum of 36 months' follow-up from the start of active treatment.

 2.

 Patients for whom initial treatment strategy is support treatment or observation: a minimum follow-up period of 36 months will be established from the date of inclusion in the study, with data collection every 6 months or whenever an event occurs, regardless of the number of times the patient attends a medical appointment.

 The need for treatment for MDS (o CMML, where applicable) during this period will be considered an event, after which data will be collected every 3 months or each time an event occurs during the entire active treatment phase.

 After the final dose of the initial treatment therapy, data collection will take place every 6 months during the post-treatment follow-up phase, regardless of the number of times the patient attends medical appointments, up to a minimum of 36 months' follow-up from the start of active treatment.

 Patients will be included consecutively, without the treatment prescription decisions affecting the decision to include the patient in the study.
 ...
 Primary objective: To assess clinical evolution from the time of diagnosis in patients with MDS or CMML, within normal clinical practice.
 ...
 EFS is defined as the period of time elapsed between diagnosis of the condition (MDS or CMML) and the appearance of one of the following events: - Progression of the disease, or - All-cause death, or - Appearance of a clinically significant condition requiring a change in initial therapeutic strategy, or - Appearance of an adverse event* requiring treatment to be suspended.

 *This applies to all patients included in the study, under active or support treatment.

 Secondary objectives: 1.

 To describe the demographic, clinical (including MDS or CMML classification as per WHO 2008 (5, 19)), and analytical characteristics of patients recently diagnosed with MDS or CMML.

 Clinical characteristics include a health assessment as per the CIRS-G scale (Cumulative Illness Rating Scale for Geriatrics), the comorbidity rating for SMD (MDS-CI) by Della Porta and Malcovatti, 20 or other scale used across all participating sites in normal clinical practice, and the performance status of the patient as per ECOG scale.

 2.

 To describe the therapeutic strategies initially applied for patients with MDS or CMML, based on clinical characteristics (specific cytogenetic alterations, adverse events, etc.

), age, health status (CIRS-G scale), ECOG and IPSS (IPSS-R) or CPSS, in addition to the reasons for adopting different initial therapeutic strategies.
...
.
 ...
 Health Outcomes of Recently Diagnosed Myelodysplastic Syndrome (MDS)/Chronic Myelomonocytic Leukemia (CMML) Patients Depending on Treatment Strategy (Wait and See, Support, Active Treatment)@highlight

Post-authorisation observational study to assess the evolution in normal clinical practice of patients recently diagnosed with myelodysplastic syndrome (MDS) or chronic myelomonocytic leukaemia (CMML), depending on the moment when active treatment is initiated.

 Subjects will be recruited from approximately 50 haematology sites in Spain.
