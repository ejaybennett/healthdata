(thirdQuint)Effectiveness of an Exoskeleton Gait Training Versus Manual Therapy in Subacute Post Stroke Patients.
...
.
 ...
 People who suffer a stroke, when regain ambulatory function, walk with typically asymmetrical gait pattern, slow, and metabolically inefficient.

 These characteristics are associated with difficulty advancing and bearing weight though the more affected limb, leading to instability and increased risk of falls.
 ...
 Advantages of this approach are that little to no ambulatory function is required to initiate locomotion and early post stroke training effects are transferred of improvements in over ground gait including: symmetry, speed, and endurance as well as motor impairment and balance scores.

 An example of electromechanical devices is Lokomat, a robotic gait orthosis combined with harness-supported body weight system is used together with a treadmill.

 However the main difference from treadmill training is that the patient's legs are guided by the robotic device according to a preprogrammed gait pattern.

 A computer-controlled robotic gait orthosis guides the patient, and the process of gait training in automated.
