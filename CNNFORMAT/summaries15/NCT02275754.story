(fifthQuint)Redes III Patient Navigator Qol Study.
 ...
 This proposed 5-year Redes En Accion research study involves a mixed-methods approach that occurs in two phases across two distinct and diverse HL communities.
 ...
 Phase II also will evaluate the extent to which intervention-associated improvements in these outcomes are mediated by targets of the PNLCNS program (e.

g.

, communication with medical team, meeting unmet needs and improving health behaviors).

 The RCT involves a 2 X 4 randomized repeated measures design with experimental condition (combined patient navigation [PN] over 3 months with access to LCNS PN services[PNLCNS] vs.

 a PN only condition) as the between-groups factor, and time-point (baseline/pre-randomization [T1]; post-PNLCNS [about 3-months post-T1; T2], and about 6- [T3] and about 12-months [T4] follow-up post-T2) as the within-groups factor; total follow-up is 15 months.
 ...
 The investigators will also evaluate the extent to which other factors such as preparation for consultation (i.

e.

, medical visit) and satisfaction with cancer care are associated with our QOL and treatment follow-up compliance outcomes.
...
.
 ...
 Redes III Patient Navigator Qol Study@highlight
