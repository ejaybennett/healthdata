(thirdQuint)Adaptive Intervention Strategies in Conduct Problems Prevention.

 This project proposes to conduct feasibility research to inform implementation of a future full-scale SMART design (i.

e.

, sequential, multiple assignment, randomized trial) that will be used to construct adaptive intervention strategies (AIS) for conduct problems prevention.
 ...
 In the first stage participants will be randomized to one of two 'brief-type' intervention options, either the youth-focused Teen Intervene-Brief program (TI-B; Winters & Leitten, 2007) or the parent-focused Everyday Parenting-Brief program (EP-B; Dishion et al.
