(fifthQuint)Transforming Primary Care Payment in Hawaii.

 The goal of this project is to transform the Hawaii Medical Services Association (HMSA) primary care provider payment model to better incentive population health while bending the increasing trend of health spending in the state.
 ...
 The aim is to build on the success of the Alternative Quality Contract (AQC) program implemented by BCBS of Massachusetts.
...
.
 ...
 Transforming Primary Care Payment in Hawaii@highlight
