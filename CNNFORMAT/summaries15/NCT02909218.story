(secondQuint)MaxART: Early Access to ART for All in Swaziland.
 ...
 The MaxART Early Access to ART for All (EAAA) implementation study was designed to determine the feasibility, acceptability, clinical outcomes, affordability, and scalability of offering early antiretroviral treatment to all HIV-positive individuals in Swaziland's government-managed health system.

 This is a 3-year randomized stepped wedge design with open enrollment for all adults 18 years and older across 14 rural health facilities in Swaziland's Hhohho Region.

 Primary endpoints are retention and viral suppression.

 Secondary endpoints include ART initiation, adherence, drug resistance, tuberculosis, HIV disease progression, and cost per patient per year.

 Sites are grouped to transition two at a time from the control (standard of care) to intervention (EAAA) stage at each 4-month step.

 This balanced design will result in approximately one half of the observations being under an intervention clinic, and the other half under control.
...
.
 ...
 MaxART: Early Access to ART for All in Swaziland@highlight
