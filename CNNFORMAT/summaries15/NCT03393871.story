(firstQuint)Myocardial Mass Determination by FFRct and Absolute Coronary Blood Flow.
 ...
 Especially in the setting of percutaneous coronary intervention (PCI), it would be valuable to have information about the absolute and relative myocardial mass distal to the location where the intervention is planned.

 Such information is valuable for risk estimation and can also be helpful in multivessel disease to determine the most adequate way of revascularization.
 ...
 A relatively new development in CT technology is the calculation of fractional flow reserve (FFR) by CT scanning, according to a sophisticated algorithm developed by Heartflow Inc.

 One of the baseline assumptions in that algorithm is that myocardial mass is proportional to resting blood flow, which seems a plausible assumption from a rational physiological point of view.
 ...
 The background for performing the present study is to compare these mass calculations by CT scanning and by invasive measurements, thereby corroborating both methods.

.

 Myocardial Mass Determination by FFRct and Absolute Coronary Blood Flow@highlight
