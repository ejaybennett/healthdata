(secondQuint)On-Demand Use of Pantoprazole: Determinants for Chronic Use of Acid Suppressive Medication.

 2-5% of the general population is chronic user of acid suppressing medication (proton pump inhibitors, H2 receptor antagonists), mostly because of gastro-oesophageal reflux disease (GORD).

 Prescription data from health insurances show that the number of chronic users increases every year, which has large economic consequences.

 There are indications however that on-demand and intermittent therapy can be as effective as daily use.

 No evidence exists regarding patients who are likely to benefit from intermittent, on-demand therapy or even termination.

 In this study several aspects of chronic use of acid suppressive therapy are investigated in family practice patients.

 Chronic users are transferred to pantoprazole 20 mg for 4 weeks.

 Patients with adequate relief of symptoms are randomized in two groups for a period of 13 weeks.
...
.
 ...
 On-Demand Use of Pantoprazole: Determinants for Chronic Use of Acid Suppressive Medication@highlight
