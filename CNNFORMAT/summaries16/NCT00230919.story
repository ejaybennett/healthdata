(thirdQuint)Weight Loss and Changes in Cardiovascular Risk Markers With a Low Glycemic Diet Compared With a Standard Diet.
 ...
 The present study is performed in in 200 overweight and moderate obese individuals, that is in men with body mass index (BMI) from 28 to 40, and women with BMI 28-35.

 To be included, the participants should also have at least one component of the metabolic syndrome.
 ...
 Each group will have 9 dietary counselling sessions in the course of the study; baseline, week 2, month 1,3,4,5,6 and 9.

 Recommended total energy intake will be individualized based on the metabolic rate at rest for each subject, and using a physical activity level of 1,4.
 ...
 As secondary objectives the study will compare the consequences of the two strategies with respect to 3, 6, and 12 months development of the variables glucose/insulin, insulin sensitivity index, number of metabolic syndrome factors, high sensitive C-reactive protein, lipids, lipoprotein B and anthropometric indices (waist /hip ratio).

 Serum will be frozen for additional parameters as leptin, adiponectin, ghrelin and ICAM.

 Also to be studied is an additional weight at 18 months follow-up, when no more advice is given past the 9-month visit.

.

 Weight Loss and Changes in Cardiovascular Risk Markers With a Low Glycemic Diet Compared With a Standard Diet@highlight

Overweight and obesity is increasing in most countries, including Norway, and the optimal diet for reducing weight is under discussion.

 The present study in overweight and moderate obese individuals compares a low glycemic load diet with a standard low-fat diet (as recommended from the National Nutrition Council) in an open, randomized trial over 12 months, with changes in weight loss and changes in cardiovascular risk markers as endpoints.
