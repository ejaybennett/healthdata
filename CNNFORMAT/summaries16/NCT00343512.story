(fifthQuint)Docetaxel Followed by Surgery in Treating Women With Stage II or Stage III Breast Cancer.

 OBJECTIVES: Primary - Pathologic complete response rate (pCR) of dose dense docetaxel in the neoadjuvant setting.

 Secondary - Safety and toxic effects of this regimen in these patients.
 ...
 - Neoadjuvant docetaxel with hematopoietic support: Patients receive docetaxel IV over 1 hour on day 1.

 Patients also receive pegfilgrastim subcutaneously (SC) on day 1 or 2 of each course OR filgrastim (G-CSF) or sargramostim (GM-CSF) SC daily beginning between day 2-4 of each course and continuing until blood counts recover.
 ...
 Patients undergo tumor biopsy and blood collection periodically for pharmacokinetic, genetic, and molecular biomarker correlative studies.

 Samples are examined for changes in p21 protein expression (and/or p21 phosphorylation) and the protein expression profile.
...
.
 ...
 Docetaxel Followed by Surgery in Treating Women With Stage II or Stage III Breast Cancer@highlight
...
RATIONALE: Dose-dense scheduling with (peg)filgrastim support may improve the clinical and pathologic complete response rate (pCR) and safety profile of single agent neoadjuvant docetaxel therapy.
 ...
 PURPOSE: To evaluate whether dose-dense scheduling with (peg)filgrastim support may improve the clinical and pathologic complete response rate (pCR) and safety profile of single agent neoadjuvant docetaxel therapy.

 To determine the changes in molecular markers that occurs with single agent docetaxel, tissue will be obtained at the end of the four cycles of docetaxel (either by repeat biopsy or definitive surgery).
