(thirdQuint)Adapted Physical Activity Effect and Fatigue in Patients With Breast Cancer.
 ...
 The aim of the study is the assessment of the effects of a physical activity retraining program on aerobic capacity, strength and fatigue, in a breast cancer population treated by adjuvant chemotherapy.

 A total of 44 subjects is required.

 The programme is organised as follows: Arm A (aerobic and strength training) and during the 27 weeks of treatment (chemotherapy and radiotherapy); Arm B (control group).

 This study includes 3 assessments phases (T0: before adjuvant chemotherapy; T1 (week 27) and T2: final evaluation at the 54th week).

 These assessments include: cardiopulmonary exercise test including maximal oxygen uptake test (VO2max), six-minute walk test, muscular testing, assessment of physical activity (IPAQ questionnaire), fatigue (MFI20 questionnaire), quality of life (EORTC QLQ C30), anxiety and depression symptoms (HADS) and nutritional evaluation: BMI and total body photonic absorption.

.

 Adapted Physical Activity Effect and Fatigue in Patients With Breast Cancer@highlight
