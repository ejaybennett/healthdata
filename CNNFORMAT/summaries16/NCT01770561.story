(thirdQuint)Feasibility Study of an Integrated Sensor and Infusion Set.
 ...
 Descriptive statistics will be used to assess non-inferiority of the Integrated sensor and infusion sets sensors compare to control Enlite sensors.

 Insulin delivery functionality will be evaluated based on BG profiles obtained during peri-prandial periods during which BG measurements will be performed at 15, 20, 30 min intervals according to a SMBG schedule.
 ...
 Post-prandial BG areas under the curve (AUC), Tmax (time to maximum rise of BG), and Cmax (maximum post-prandial BG) values will be calculated for each meal (breakfast, lunch, and dinner) consumed during both inpatient days and compared.
...
.
 ...
 Feasibility Study of an Integrated Sensor and Infusion Set@highlight
