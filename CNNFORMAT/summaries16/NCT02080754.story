(fifthQuint)Sellick Interest in Rapid Sequence Induction.

 Introduction: Lung aspiration is an inherent complication of the loss of protective upper airway reflexes during general anesthesia.

 Its incidence is low in elective surgery, when preoperative fasting rules have been complied and in absence of risk factors for regurgitation of gastric contents.

 In emergency conditions, non-compliance with preoperative fasting rules and delayed gastric emptying increase the risk of regurgitation and therefore lung aspiration of gastric contents.

 In this context, a rapid sequence induction of anaesthesia is recommended to minimize the risk of regurgitation which combines the use of short delay and short duration of action anesthetics agents associated with the application of a Sellick maneuver.

 The goal of this maneuver is to collapse the esophagus by compressing it between the cricoid cartilage and the fifth cervical vertebra.

 Because of the low level of evidence supporting the Sellick maneuver in the literature, this maneuver, remains controversial although recommended.
 ...
 Primary endpoint: Incidence of lung aspiration Secondary endpoints: Cormack and Lehane Grade , frequency of difficult intubation, frequency of impossible intubation, effect of releasing the Sellick maneuver on these three criteria, frequency of aspiration pneumonia within 24 hours, frequency of complications due to the Sellick maneuver (esophageal rupture and cricoid cartilage fracture rates) and mortality at day 28 or at hospital discharge.

 Methods: This is a multicenter, randomized, double-blind, non-inferiority trial.

 We compare a group of patients benefiting from a rapid sequence induction without achieving the Sellick maneuver, where the movement is fake (sham group) with a group of patients undergoing a rapid sequence induction with effective execution of this maneuver (Sellick group).

 The two patient groups differ only by the effective or sham application of the Sellick maneuver .

 In both arms, the Sellick maneuver , whether real or fake , can be released at the request of the person performing orotracheal intubation in particular to improve intubating conditions or in case of active vomiting.

 However, it should be kept in case of need for ventilation facemask.
...
.
 ...
 Sellick Interest in Rapid Sequence Induction@highlight
