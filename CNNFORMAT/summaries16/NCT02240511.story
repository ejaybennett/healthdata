(fifthQuint)Resistance Exercise Program and Branched Chain Amino Acid Supplementation in Heart Failure Patients.

 Heart failure (HF) is a complex syndrome which results from structural and/or functional alterations that limit the ability to respond to physiological demands(1,2).

These abnormalities involve metabolic and neuro-hormonal factors such as tumor necrosis factor- (TNF-), one of the most important catabolic cytokines related with changes in body composition, interleukin 1 (IL-1), IL-6, interferon Y, and transmission growth factor (3-9), which produce catabolic and anabolic imbalance and promote loss of fat free mass (FFM) with or without loss of fat mass (FM) in patients with HF.
...
.
 ...
 Resistance Exercise Program and Branched Chain Amino Acid Supplementation in Heart Failure Patients@highlight
...
Heart Failure (HF) is a complex syndrome which can include the physiological, neural hormonal and metabolic complications known as "Cardiac Cachexia" (CC).
 ...
 In the development of CC there is a release of catabolic cytokines (Tumor Necrosis Factor-, interleukins 1 and 6)that cause a decrease of fat free mass and fat mass.
