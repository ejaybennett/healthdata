(fifthQuint)Enhanced Homestead Food Production Plus+ Program in the Lake Zone, Tanzania.
 ...
 In 2010, HKI introduced an enhanced-HFP (E-HFP) model in Burkina Faso and included a strengthened nutrition education component; the Essential Nutrition Actions (ENA) framework.

 This E-HFP program was evaluated by IFPRI and yielded some encouraging results.

 With regards to nutritional outcomes, however, the primary finding was that, while the E-HFP program improved hemoglobin concentration-an indicator of iron status-the evaluation failed to note a significant impact of the program on improving children's growth.

 The primary explanation for the absence of a measurable improvement in children's growth was the lack of complementary health interventions that aim to specifically reduce children's disease burden, which, along with the lack of adequate food and care, is an underlying cause of undernutriton (UNICEF 1990).

 Building on lessons learned from the Burkina Faso E-HFP program and a 2011 Tanzania HFP program, a new model, the Enhanced Homestead Food Production Plus (E-HFP+), was developed for Tanzania to improve the nutritional status of infants and young children.

 The new model strengthens the Behavior Change Communication (BCC) on malaria prevention, WASH, and gender components and enhances links with the health sector.

 The model will also test two new concepts: 1.
 ...
 Enhanced Homestead Food Production Plus+ Program in the Lake Zone, Tanzania@highlight
