(fifthQuint)Radiofrequency Ablation in Breast Cancer.

 Main objectives of the project: - To evaluate the usefulness of radiofrequency ablation (RFA) to achieve a lower percentage of positive margins.
 ...
 An international scale will be used and the scores will be compared.

 There will be two independent assessments, one for the physician and another for the patient.
 ...
 RFA is considered as complete when no viable tumor tissue is evidenced by oxidation-reduction reaction mediated by NADH-diaphorase after surgical resection.

 Mitochondrial dysfunction will be also evaluated by semiquantitative and quantitative method using the enzyme cytochrome c oxidase or Complex IV (COX) and tunel.

 Any residual viable tumor tissue will be considered as incomplete RFA.
 ...
 To demonstrate the safety of RFA by cluster "cool-tip" electrode in breast cancer tumors a.

 To quantify all side effects that may occur after the RFA and / or surgery and to correlate the complication rate in each group with severity.

.

 Radiofrequency Ablation in Breast Cancer@highlight
...
Background/Main objective: Radiofrequency ablation (RFA) is a minimally invasive procedure widespread accepted in the treatment of different tumors, especially in the liver but its benefit is not yet well-known in breast cancer.
 ...
 Our main objective is to evaluate the usefulness of RFA in 40 years, infiltrating ductal breast carcinoma by biopsy.

 The tumor must be unique, visible by ultrasound, smaller than 2cm and located > 1 cm from the chest wall and the skin.

 Patients will be followed up for a period of two years to assess cosmetic result, short -term and long -term complications and recurrences.
 ...
 Therefore this procedure may reduce the risk of second surgeries and the removed volume of tissue.

Consequently the final cosmetic result should be improved.
