(fifthQuint)Comparison of an Artificial Pancreas Versus Threshold Low Glucose Suspend in Type 1 Diabetic Children.

 The study is an open randomized control trial preceded by a run-in period and follows a cross-over design.

After inclusion, the therapy will be moved to sensor augmented pump therapy with a dedicated training to continuous glucose monitoring using study system (study CGM).
 ...
 Until 08:00 Day 2, insulin delivery will be managed in open-loop mode, i.

e.

 insulin doses will be decided according to capillary glucose measurements.

 From 08:00 Day 2, one algorithm will be activated according to the randomization order, i.

e.

 either the threshold low glucose suspend (TLGS) algorithm (threshold will be set at 70 mg/dl) or the closed-loop algorithm.

 Insulin delivery will then be managed in open-loop mode with activated TLGS or by the closed-loop algorithm until 08:00 Day 4.

 In both cases, meals will be of free content and taken around 09:00, 13:00, 17:00 and 20:00.
 ...
 The algorithm will be inactivated at 08:00 Day 4.

 The study pump will be removed and replaced by patient's usual pump.
...
.
 ...
 Comparison of an Artificial Pancreas Versus Threshold Low Glucose Suspend in Type 1 Diabetic Children@highlight
