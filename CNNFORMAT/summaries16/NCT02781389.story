(thirdQuint)Vismodegib on Locally Advanced Basal Cell Carcinoma Under Real World Conditions.

 This is a multi-center non-interventional study with 53 patients with locally advanced BCC who start Vismodegib (received at least one dose) in Q4 2015.

 Duration of recruitment will be one year.

 Patients will be followed prospectively until disease progression, death, or for 3 years from first dose Vismodegib (whichever occurs first).

 The primary effectiveness objective for this study is as follows: cent To evaluate the duration of response defined as duration from first documented response of complete response (CR) or partial response (PR) until disease progression (as determined by the treating physician, which might include and will be categorized in the following groups: clinical assessment, histological assessment, imaging assessment) for laBCC patients.
 ...
 Vismodegib on Locally Advanced Basal Cell Carcinoma Under Real World Conditions@highlight
