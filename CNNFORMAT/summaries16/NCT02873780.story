(firstQuint)Comparison of 3-Minute Step Test (3MStepT) and 6-Minute Walk Test (6MWT) in COPD Patients.

 The 6 minute walk test (6MWT) is the best field test to determine oxygen desaturation during effort, in COPD patients.

 However, the test need a 30m corridor.

 The 3 minute step test (3MST) is a other field test used in COPD patients.

 But no study shows that 3MST can be used to determine oxygen desaturation.
...
.
 ...
 Comparison of 3-Minute Step Test (3MStepT) and 6-Minute Walk Test (6MWT) in COPD Patients@highlight
