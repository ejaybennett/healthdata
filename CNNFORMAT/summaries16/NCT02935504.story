(secondQuint)PRogram In Support of Moms (PRISM): A Pilot Study.
 ...
 PRISM aims to improve perinatal depression treatment and treatment response rates through: (1) access to psychiatric telephone consultation for Ob/Gyn providers; (2) clinic-specific implementation of stepped care, including training support and toolkits; and, (3) proactive treatment engagement, patient monitoring, and stepped treatment response to depression screening/assessment.

 Four practices were randomly assigned to PRISM versus an active comparison group called MCPAP for Moms which is a state-wide telephonic perinatal psychiatry program.

 The Investigators will compare the effectiveness of PRISM vs.

 MCPAP for Moms to improve depression severity and treatment participation in pregnancy through 3 months postpartum among patients.

.

 PRogram In Support of Moms (PRISM): A Pilot Study@highlight
