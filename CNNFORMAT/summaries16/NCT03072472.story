(firstQuint)BowelScope: Accuracy of Detection Using ENdocuff Optimisation of Mucosal Abnormalities.
 ...
 With the aid of the colonoscopic cuff Endocuff Vision(R), the investigators aim to improve visualisation of the colonic mucosa by flattening colonic folds and manipulating them away from the field of forward view the investigators hypothesise that the Endocuff Vision(R) will improve adenoma detection rates by providing better fold retraction, a wider field of view and better scope tip stabilisation.

 This clinical randomised study will be conducted in subjects referred and scheduled for screening flexible sigmoidoscopy via the NHS English Bowel Scope Screening (BSS) Programme and will compare Endocuff Vision(R)-Assisted Flexible Sigmoidoscopy (EAFS) with Standard Flexible Sigmoidoscopy (SFS).

.

 BowelScope: Accuracy of Detection Using ENdocuff Optimisation of Mucosal Abnormalities@highlight
