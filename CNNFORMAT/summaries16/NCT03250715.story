(fifthQuint)Effects of Low Level Laser Therapy on Functional Capacity and DNA Damage of Patients With Chronic Kidney Failure.

 Chronic kidney disease (CKD) consists of kidney damage and progressive and irreversible loss of kidney function and in its later stage (terminal phase) is called chronic kidney failure (CKF).

 Although hemodialysis (HD) substitutes some of the lost renal functions, patients suffer from some changes that characterize uremic syndrome, such as peripheral motor neuropathy, osteomalacia, cardiac and musculoskeletal myopathies, anemia, among other alterations.

 This study aims to verify the effects of low level laser therapy (LLLT) on functional capacity, DNA damage, lower limbs muscle strength, quadriceps muscle architecture, muscle pain and perception of lower limb fatigue, inflammatory profile, oxidative stress and quality of life of patients with chronic kidney failure on hemodialysis.

 Patients will be randomized into two groups: the control group and the LLLT group.

 The control group will only be evaluated and reassessed.

 The LLLT group in addition to the evaluations will receive LLLT three times a week for eight weeks during HD.

 The evaluations will be performed pre-intervention, after 4 and 8 weeks of therapy.

 However, the muscle architecture evaluation will be performed only at pre intervention and after 8 weeks.
...
.
 ...
 Effects of Low Level Laser Therapy on Functional Capacity and DNA Damage of Patients With Chronic Kidney Failure@highlight
