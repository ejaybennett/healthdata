(fifthQuint)Growth Hormone as a Determinant of Weight Regulation.
 ...
 Subjects identified as having "low-normal" (3 ug/L) 24h GH will then be admitted to the hospital for a 2 wk overfeeding protocol (~2000 kcal/d >TDEE - with restricted physical activity), immediately followed by a 4 wk caloric restriction protocol (~750 kcal/d <TDEE) to compare changes in weight, body composition and intra-abdominal adiposity between these groups that differ markedly in their GH secretion (GH measured before the diet) [Specific Aim 2].

 A subset of subjects with low-normal GH will receive intravenous GH throughout the 2 wk overfeeding period at either: 1.

 a constant rate or 2.

 as a pulsatile infusion (to mimic endogenous secretion).
...
.
 ...
 Growth Hormone as a Determinant of Weight Regulation@highlight
...
With the alarming increase in the prevalence of obesity, identifying factors that predispose individuals to weight-gain is of critical importance.
 ...
 Because GH influences many of the key metabolic processes that contribute to BMR (e.

g.

; protein synthesis, proteolysis, substrate cycling), the investigators anticipate that the resistance to weight-gain in persons with elevated GH concentrations will be associated with an increase in BMR due to acceleration of some or all of these processes.
