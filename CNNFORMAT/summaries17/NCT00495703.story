(fifthQuint)The Activity Intervention for Chemobrain.
 ...
 Adjuvant treatment has been reported to affect multiple cognitive domains, but three domains appear to be most strongly affected (i.

e.

, executive functioning, declarative memory, motor function).
 ...
 To begin this research, we will: 1) conduct a randomized exercise intervention trial among cancer survivors that report persistent cognitive problems following chemotherapy (exercise, n=30 vs.

 standard of care, n=30); 2) explore possible mediators and moderators of the intervention effect on cognition; and 3), conduct a cross-sectional study comparing cancer survivors enrolled in the trial (n=60) and matched controls (n=40) to evaluate the cognitive status among survivors in the intervention.

 We will employ a proven home-based exercise intervention and state of the art cognitive testing of relevant cognitive domains (e.

g.

, Randt Memory Test, Trail Making B, Stroop task, T ask switching, Response compatibility) that we have used in preliminary studies.
...
.
 ...
 The Activity Intervention for Chemobrain@highlight
