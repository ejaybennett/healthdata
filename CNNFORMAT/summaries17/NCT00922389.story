(thirdQuint)A Clinical Trial on Diabetic Foot Using Peripheral Blood Derived Stem Cells for Treating Critical Limb Ischemia.

 One devastating complication of diabetes is peripheral arterial disease (PAD) including critical limb ischemia (CLI), which may result in limb loss.

 Epidemiological evidence confirms an association between diabetes and increased prevalence of peripheral arterial disease (PAD).

 The prevalence of peripheral vascular disease among the Indian diabetic population is 13%.

 This therapy provides a targeted approach i.

e.

 by improving blood perfusion in the ischemic area of the lower limb by inducing neovascularization, which would be further evaluated by measuring the change in transcutaneous partial pressure of oxygen (TCpO2), NMR angiography of local vessels, ulcer healing, pain relief, limb salvage, ABI index etc.
...
.
 ...
 A Clinical Trial on Diabetic Foot Using Peripheral Blood Derived Stem Cells for Treating Critical Limb Ischemia@highlight
