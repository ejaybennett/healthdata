(thirdQuint)Amino-acid PET Versus MRI Guided Re-irradiation in Patients With Recurrent Glioblastoma Multiforme.
 ...
 The goal of this study is to evaluate the impact of radiotherapy target volume delineation based on AA-PET (new strategy) on the clinical outcome of patients with recurrent glioblastoma (GBM) compared to target volume delineation based on contrast enhanced T1 weighted MRI (T1Gd-MRI) (traditional, established strategy).

 Concerning therapeutic safety, the topography of recurrence outside the primary target volume as well as the localization of necrosis after the re-irradiation will be determined.

 All side effects will be assessed by CTCAE version 4.

0 and the safety analyses will present the worst grade of acute and late side effect by treatment arm for the whole study period (treatment and follow up).

 Patients will be asked to complete a quality of life (QoL) questionnaire (as assessed by the E-ORTC QLQ-C15 PAL) in regular time intervals.
...
.
 ...
 Amino-acid PET Versus MRI Guided Re-irradiation in Patients With Recurrent Glioblastoma Multiforme@highlight
