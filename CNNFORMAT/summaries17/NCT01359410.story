(fifthQuint)Reinforced Staple Line on Leak Rate in Distal Pancreatectomy.
 ...
 Either a reabsorbable polytrimethylene carbonate mesh (SEAMGUARD(R)) or reabsorbable strips of bovine pericardium (PERI-STRIPS DRY(R)) will be used to reinforce the stapled pancreatic transection line in the test group.

 In order to have a uniform test method, the investigators will utilize a laparoscopic stapling device for both open and laparoscopic procedures and a uniform staple size (4.
...
.
 ...
 Reinforced Staple Line on Leak Rate in Distal Pancreatectomy@highlight
