(thirdQuint)Comparison of Information Recorded in MINAP, GPRD and HES: a CALIBER Study.
 ...
 Starting from a 'best case definition' MINAP MI definition (based on the CALIBER phenotype algorithm, which itself is based on the international definition of MI), to examine the way in which the MINAP MI is recorded in GPRD and HES.

 This analysis will examine STEMI and NSTEMI separately.
 ...
 A detailed protocol for this study is available on request.

 This study has been approved by the Independent Scientific Advisory Committee (ISAC) and by the MINAP Academic Group (MAG).

 Study investigators: R.

 Boggon, GPRD; Dr S.

 Denaxas, UCL; Professor H.

 Hemingway, UCL; E.

 Herrett, LSHTM; Dr A.

 Shah, UCL; Professor A.
...
.
 ...
 Comparison of Information Recorded in MINAP, GPRD and HES: a CALIBER Study@highlight

Medical information is increasingly processed electronically.

 This study will describe the similarities and differences in the data recorded by different databases of electronic healthcare database.

 These will include the General Practice Research Database (GPRD) and the Myocardial Ischaemia National Audit Project (MINAP) and hospital episode statistics (HES).
