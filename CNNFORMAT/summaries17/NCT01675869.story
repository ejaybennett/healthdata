(secondQuint)Executive Function/Metacognitive Training for At-Risk Preschoolers.
 ...
 Because executive functioning (EF) has been consistently been proposed as a putative factor in the development of disruptive behavior disorders an intervention targeting EF (e.

g.

, inhibition, working memory), attention, and metacognition during early childhood could likely affect the development of disruptive behavior disorders in preschoolers.
 ...
 Exploratory aims include assessing whether children in the ETAM group show gains compared to those in AC on targeted (trained) outcomes (i.

e.

, measures of EF) and untrained outcomes (i.

e.

, ADHD symptoms, academic readiness, social competence).

 Investigators will also assess whether gains are maintained as well as investigate potential moderators/mediators.

.

 Executive Function/Metacognitive Training for At-Risk Preschoolers@highlight
