(fifthQuint)Intra Peritoneal Chemo Hyperthermia (IPCH) : Cellular and Metabolic Consequences.

 Intra Peritoneal Chemo Hyperthermia (IPCH) is a recently validated option for the treatment of peritoneal carcinomatosis from colorectal or ovarian origin.

 This therapeutic program demonstrated a significant improvement of the late stages (i.

e.

 carcinomatosis) of the disease (survival median > 33 months).

 IPCH induces morbidity as high as 20% and mortality less than 4%.

 From a clinical point of view, within the first 24 hours after IPCH, patients undergo a systemic inflammatory response syndrome, and therefore require to be monitored in an intensive care unit.

 From a metabolic perspective, preliminary data have been shown a significant "anaerobic style" disturbance of energetic metabolism, suggesting a deep cellular energetic deficit throughout IPCH process.
...
e.
 ...
 2 from peritoneum disease-free and 2 from invaded peritoneum , each representing a volume less than 1 cm3 and 2 biopsies from healthy colonic tissue for the colon-related cancer and 4 biopsies (peritoneum n=2, tumoral tissue n=2) for ovarian-related cancer.

 All biopsies are done during the surgery under general anesthesia, and each biopsy per site before/after IPCH.

 Assessment criteria - main criteria : Heat shock protein expression (blood/cell ratio) compared to baseline values.
 ...
 The normal distribution is verified using the d'Agostino-Pearson test.

 For intragroup comparisons, the repeated measures ANOVA is done.

 For intergroup comparisons, an univariate analysis is done, using the Student t-test and the Fisher exact test.

 Taking into account the planned sample size and the annual number of IPCH, the scheduled length of the study is 18 months.

.

 Intra Peritoneal Chemo Hyperthermia (IPCH) : Cellular and Metabolic Consequences@highlight
