(firstQuint)Harm Reduction With Pharmacotherapy (HaRP).
 ...
 Innovative, low-barrier approaches (e.

g.

, Housing First and alcohol management programs) have been applied with this population and are efficacious in reducing alcohol use and related problems as well as utilization of publicly funded services and associated costs.
 ...
 One medication that could address this treatment gap is extended-release naltrexone (XR-NTX; marketed as Vivitrol(R)).
 ...
 Finally, we will test treatment effects on publicly funded service costs (i.

e.

, emergency medical services, ER visits, hospital admissions, and county jail).
...
.
 ...
 Harm Reduction With Pharmacotherapy (HaRP)@highlight
