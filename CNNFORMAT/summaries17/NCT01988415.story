(firstQuint)New Treatment Algorithm to Reduce Spherical Aberration After LASIK Correction for Myopia.
 ...
 Commercially available software used to calculate the LASIK treatment profile was used in one eye (active comparator [i.

e.

, control]) and VSS-Rx1 OPM software was used in the fellow eye (experimental).

 Subjects were masked to the use of either the commercially available or VSS-Rx1 OPM software.

.

 New Treatment Algorithm to Reduce Spherical Aberration After LASIK Correction for Myopia@highlight
