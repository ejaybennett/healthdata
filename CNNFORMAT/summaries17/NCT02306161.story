(fifthQuint)Combination Chemotherapy With or Without Ganitumab in Treating Patients With Newly Diagnosed Metastatic Ewing Sarcoma.

 PRIMARY OBJECTIVES: I.

 To determine if the event-free survival (EFS) in patients with newly diagnosed metastatic Ewing sarcoma treated with multiagent chemotherapy is improved with the addition of ganitumab (AMG 479).
 ...
 REGIMEN B (VDC/IE + ganitumab): INDUCTION THERAPY: Patients receive Induction therapy as in Regimen A and receive ganitumab IV over 30-60 minutes or 60-120 minutes on day 1 of weeks 1, 3, 5, 7, 9, and 11.
...
.
 ...
 Combination Chemotherapy With or Without Ganitumab in Treating Patients With Newly Diagnosed Metastatic Ewing Sarcoma@highlight

This randomized phase III trial studies how well combination chemotherapy with or without ganitumab works in treating patients with newly diagnosed Ewing sarcoma that has spread to other parts of the body.

 Monoclonal antibodies, such as ganitumab, may block tumor growth in different ways by targeting certain cells.

 Drugs used in chemotherapy, such as vincristine sulfate, doxorubicin hydrochloride, cyclophosphamide, ifosfamide, and etoposide, work in different ways to stop the growth of tumor cells, either by killing the cells, by stopping them from dividing, or by stopping them from spreading.

 It is not yet known whether combination chemotherapy is more effective with or without ganitumab in treating patients with newly diagnosed Ewing sarcoma.
