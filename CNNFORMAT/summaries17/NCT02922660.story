(thirdQuint)Comparison of Desflurane Anesthesia Versus TIVA-TCI in Patients Undergoing Ophthalmic Ambulatory Surgery.
 ...
 Enrolled patients are randomly assigned into 2 groups: group TIVA (TIVA-TCI with propofol) and group Des (Desflurane).

In group TIVA, anesthesia is maintained with propofol and remifentanil.

 Propofol is continuously administered via a target-controlled infusion (TCI) pump intraoperatively.

 In group Des, anesthesia is maintained with desflurane.

All patients received anaesthesia depth monitoring with bispectral index (BIS).
...
.
 ...
 Comparison of Desflurane Anesthesia Versus TIVA-TCI in Patients Undergoing Ophthalmic Ambulatory Surgery@highlight
