(secondQuint)Biomarker Guided Antibiotic Treatment in Community-Acquired Pneumonia.
 ...
 Preconditions: significance level () 5 % and power () 80 %.

 Test: unpaired T-test.

 Mean treatment time 11 days (SD 5) in this population.

 Relevant detection limit defined at 2 days.

 The bonferroni correction has been used to correct for the fact that 2 primary analysis will be performed, why = 0.

005/2 = 0.

025.

 Estimated 100 patient in each arm, thus n = 300.

 Site monitoring and auditing.

 The study is monitored by the unit for Good Clinical Practice, Bispebjerg Hospital, Denmark.

.

 Biomarker Guided Antibiotic Treatment in Community-Acquired Pneumonia@highlight
