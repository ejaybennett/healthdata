(firstQuint)"Ounce-equivalents" in the Protein Foods Group: Benefits of Quality.

 Over the past 35 years the United States Department of Agriculture (USDA) Dietary Guidelines for Americans (DGAs) has sought to translate recommendations on nutrient requirements (i.

e.

, Recommended Dietary Allowances) from the Food and Nutrition Board of the Institute of Medicine (IOM) into practical nutritional advice for the American public.
 ...
 It is stated among other equivalents cited, that 1 ounce (oz.

) of meat is equivalent to 1 tablespoon (Tbsp.

) of peanut butter and 1/4 cup (0.

5 ounces) of cooked kidney beans.

 But are they really equivalent? This indicates that the "ounce equivalents" of protein foods in MyPlate are not equivalent in any parameter that might be used to assess nutritional benefit, and demonstrates that the bias against animal proteins is in the Dietary Guidelines.

 The misrepresentation of the equivalencies of various food sources of protein in MyPlate raises the question of the process by which this occurred, and how can the process be influenced to more accurately reflect that high quality of animal proteins? Therefore, developing convincing data to correct the MyPlate "ounce equivalents" of protein foods is an achievable goal.
...
.
 ...
 "Ounce-equivalents" in the Protein Foods Group: Benefits of Quality@highlight
