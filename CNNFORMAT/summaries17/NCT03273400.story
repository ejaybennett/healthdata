(fifthQuint)Effect of Mobilisations on Lumbar and Hamstring.
 ...
 This will be conducted by the lead author, Paul Chesterton, a physiotherapist with appropriate insurance and qualifications.
 ...
 To record the surface electromyography (SEMG) activity in the muscles of the participants in this study the Zerowire Cometa system will be used.

 This system will record the muscle activity wirelessly.
 ...
 Skin preparation will consist of shaving the area to remove any hair then wiping the area with alcohol wipe then the placing noraxon dual electrode in appropriate position in relation to recommendations by Seniam (2003).

 The electrodes are placed in line to the pennant of the muscle.

 Electrodes will be attached according to European recommendation (seniam) at the Paraspinal muscles, and the Biceps Femoris of the dominant leg.

 A baseline sEMG will then be taken whilst the participant is at rest for 60seconds.
 ...
 The plinth will rest on force plates to allow the authors to analyse the force placed through the vertebrae.
 ...
 Data analysis will occur using the zerowire cometa system version 1.

6.

 The raw rate will be smoothed and rectified using a Butterworth algorithm with a high pass filter with a cut of frequency of 20Hz at order 5 with the data will be rectified using route mean square (RMS) set at a window of 20ms.

.

 Effect of Mobilisations on Lumbar and Hamstring@highlight
...
To compare the immediate and short-term effects of L4 and L5 Unilateral Posterior Anterior (UPA) Mobilisations on the lumbar and hamstring range of motion and EMG activity of the Erector Spinae and Hamstring muscles.
 ...
 Using a pre-test post-test crossover design subjects lumbar flexion and active knee extension with be recorded prior to and following unilateral zygapophyseal joint mobilisations.

 Measures will be taken immediately after and then 5, 10, 15, 20, 30 and 60 minutes intervals post intervention.

 Mobilisation force will be measured via force plates to ensure consistent mobilisation pressure.

 Following data collection statistical analysis will be undertaken to analyse any potential benefit of lumbar mobilisations to influence the EMG activity of the Erector Spinae and Hamstrings.

 Functional assessment of lumbar range of motion and hamstring range of motion to be conducted and analyse any effect on movement