(thirdQuint)Pentaglobin in CRE and PA Neutropenic Infections.
 ...
 This study will have two co-primary endpoints: To demonstrate a 50% reduction in 30-day mortality for carriers developing a pre-engraftment bloodstream infection sustained by carbapenem-resistant Enterobacteriaceae or Pseudomonas aeruginosa (earlier primary endpoint).
...
3C within 4 months from the start of start of intensive chemotherapy or transplant Days of hospitalization within 4 months from the start of intensive chemotherapy or transplant Days of i.

v.

 antimicrobials within 4 months from the start of intensive chemotherapy or transplant Non-relapse mortality (NRM) at 4 months from the start of intensive chemotherapy or transplant Patients will be treated according to the standard procedures, which will be decided by each Center according to local policies (e.

g.

 chemotherapy cycles for acute leukemia, choice of conditioning regimen for allo- Hematopoietic stem cell transplantation and graft-versus-host- disease prophylaxis, anti-microbial prophylaxis).
 ...
 Treatment and management of febrile neutropenia in Carbapenem-resistant Enterobacteriaceae or Pseudomonas aeruginosa carriers Antimicrobial treatment active against the multidrug-resistant strain should be started in case of neutropenic fever, defined as a single oral temperature of 38.

3C or a temperature of 38.

0C sustained over a one-hour period.
 ...
 Patients should receive the best available first-line therapy, usually a combination therapy, based on the in vitro susceptibility results of the pre-treatment screening swab in combination to Pentaglobin 5ml/kg over a 12h i.

v.

 infusion for 3 consecutive days.

 Empirical treatment should be subsequently streamlined according to microbiological results (both positive and negative) Pentaglobin should be started within 12h from the onset of fever, regardless of the presence of hemodynamic stability.

 Septic shock should be diagnosed and managed according to standard procedure The duration of the antimicrobial therapy or subsequent lines of therapy will be decided by local investigators according to clinical judgment.

 Cycles of Pentaglobin can be repeated according to clinician judgment (usually at least 1 week).
 ...
 In order to address the multiplicity issue, the Bonferroni method to adjust the significance level will be applied as follows: - the early endpoint (i.

e.

 the "30-day mortality for carriers developing a pre-engraftment bloodstream infection sustained by CRE or PA") will be tested at the 3.

0% significance level using the Simon (minimax) phase II study design; - the late endpoint (i.

e.

 the "OS at 4 months from the start of intensive treatment in pre-treatment carriers") will be tested at the 2.

0% significance level.

 Adaptive study design Early primary endpoint: 30-day mortality rate for carriers developing a pre-engraftment bloodstream infection sustained by Carbapenem-resistant Enterobacteriaceae or Pseudomonas aeruginosa.

 The test was planned to determine whether it will be possible to obtain a consistent rate of reduction in 30-day mortality for carriers developing a pre-engraftment bloodstream infection sustained by CRE or PA.

 In the proposal, to reject the null hypothesis that p=0.

80 (mortality rate: 0.

20) with Type I error probability () equal to 0.

03 and 80% power (1-), a maximum of 40 evaluable patients has to be accrued.
 ...
 Late primary endpoint: Overall Survival at 4 months from the start of intensive treatment in pre-treatment Carbapenem-resistant Enterobacteriaceae or Pseudomonas aeruginosa carriers.

 The later endpoint is the Overall Survival at 4 months.

 This sample size was calculated using the "Sample size tables for exact single-stage phase II design" (A'Hern RP, Statistics in Medicine 2001).

 Considering an expected Overall Survival at 4 months of 70% from the start of intensive treatment in pre-treatment carriers, the number of patients required to evaluate an increase on the Overall Survival from 50% (P0) to 70% (P1) with 90% power at the 2.

0% significance level (one side) is 68.

 So, the total number of patients to be enrolled in this study is 120, including the 68 patients needed for the later endpoint.

 Calculations were made using PASS software.
...
.
 ...
 Pentaglobin in CRE and PA Neutropenic Infections@highlight
