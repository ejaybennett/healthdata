(thirdQuint)Combination Chemotherapy Plus Radiation Therapy Followed by Peripheral Stem Cell Transplantation in Treating Patients With Non-Hodgkin's Lymphoma.
 ...
 - Regimen A: Patients with poor prognosis intermediate-grade lymphoma (IGL) in first CR or IGL or low-grade lymphoma (LGL) in second or greater CR receive mobilization with filgrastim (G-CSF) subcutaneously (SC) daily on days 1-7.

 Autologous peripheral blood stem cells (PBSC) are harvested and selected for CD34+ cells on days 5 and 6 (and day 7 if needed).

 - Regimen B: Patients who are currently on the MSKCC standard dose salvage therapy protocol with ifosfamide, carboplatin, and etoposide (ICE) for recurrent or refractory IGL receive additional mobilization with G-CSF after completion of the last course of ICE.

 Patients with recurrent or refractory IGL, immunoblastic lymphoma, or LGL who have not previously received ifosfamide and are not currently on the MSKCC standard dose salvage protocol with ICE receive ifosfamide IV and carboplatin on day 2 and etoposide IV on days 1-3 (standard-dose ICE) followed by G-CSF SC.

 When blood counts recover, autologous PBSC are harvested and selected for CD34+ cells.

 - Regimens A and B: If additional hematopoietic growth factors (HGFs) become available, they may be administered concurrently with G-CSF.

 If inadequate CD34+ cells are collected, then autologous bone marrow is harvested.

 - Conditioning: Patients who are under age 60 and have not received dose-limiting radiotherapy are treated on regimen C.

 Patients who are age 60 and over and patients who are under age 60 and have received dose-limiting radiotherapy are treated on regimen D.
 ...
 - Transplantation: PBSC or bone marrow is reinfused on day 0.

 Patients receive G-CSF SC every 12 hours beginning on day 1 and continuing until blood counts recover.

 If additional HGFs become available, they may be administered concurrently with G-CSF.
...
.
 ...
 Combination Chemotherapy Plus Radiation Therapy Followed by Peripheral Stem Cell Transplantation in Treating Patients With Non-Hodgkin's Lymphoma@highlight

RATIONALE: Drugs used in chemotherapy use different ways to stop tumor cells from dividing so they stop growing or die.

 Combining chemotherapy with radiation therapy and peripheral stem cell transplantation may kill more tumor cells.
