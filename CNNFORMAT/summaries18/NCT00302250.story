(firstQuint)The STRETCH Study: Distensibility on Endothelial-Dependent Vasoreactivity in Subjects With Systolic Hypertension.

 The secondary objectives of the double-blind segment are to: - Compare the effects of alagebrium vs placebo on the change from baseline in endothelial-mediated vasoreactivity immediately after exercise, as assessed by pulse perfusion-mediated vasodilation (PPMV).

 - Confirm results observed in the single-blind segment.

 - Explore several variables as potential independent predictors of vascular stiffness and endothelial function.

 These parameters include age, body mass index, gender, renal disease, history of cardiovascular disease, serum cholesterol, and antihypertensive medication use.
