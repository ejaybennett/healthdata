(fifthQuint)Naive T-Cell Depleted DLI Following Allo Stem Cell Transplant.
 ...
 We have been interested in selecting T-cells based on their naive or memory phenotype to understand the contribution of each of these cells to the pathogenesis of GvHD.

 Naive T-cells (CD62L+ or CD45RA+) are T-cells that have not encountered antigens specific for their T-cell receptor.
 ...
 If a donor has not encountered host alloantigens, GvHD-inducing host-reactive T-cells should be contained in the naive T-cell compartment.

 In contrast, all the memory phenotype cells should not recognize host alloantigens.

 If this hypothesis is correct as suggested by several published studies, CD62L- T-cells, which are devoid of naive T-cells and represent a subset of memory T-cells, should not be able to induce GvHD.

 The study hypothesis is depletion of naive T-cells from the donor lymphocyte inoculum will abrogate GVHD while providing immunocompetent memory T-cells to affect an anti-infection and a graft versus tumor response.

 In this study, we will determine the maximum tolerated dose of a naive T-cell depleted donor lymphocyte infusion given to patients following HLA-matched allogeneic stem cell transplantation.
...
.
 ...
 Naive T-Cell Depleted DLI Following Allo Stem Cell Transplant@highlight
...
Allogeneic stem cell transplantation offers the hope of cure for a wide variety of hematologic malignancies.
 ...
 The study hypothesis is depletion of naive T-cells from the donor lymphocyte inoculum will not cause GVHD while providing T-cells to affect both anti-infection and anti-tumor responses.
