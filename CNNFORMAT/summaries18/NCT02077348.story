(fifthQuint)Metabolic Signalling in Muscle- and Adipose-tissue Following Insulin Withdrawal and Growth Hormone Injection.
...
.
 ...
 An interesting pathway is suppression of lipolysis.

 The most important and rate-limiting lipase in triglyceride hydrolysis is adipose triglyceride lipase (ATGL)(1-5).

 A connection between ATGL and G0/G1 switch gene (G0S2) has been shown (6,7).

 During lipolysis ATGL is up-regulated and G0S2 is down-regulated and the promoter region for G0S2 has binding-sites for glucose, insulin dependent transcription factors and peroxisome proliferator-activated receptors y (PPAR-y)(8).

 One former study has shown that fasting reduces G0S2 and increases ATGL in humane adipose-tissue(7).

 The anti-lipolytic effects of insulin, could be thought, to be mediated through increased transcription of G0S2 which then in turn inhibits ATGL.

 Conversely, increased lipolysis during lack of insulin.

 Growth hormone and growth hormone dependent synthesis og IGF-1 (Insulin-like growth factor - 1) is crucial for human growth before and during adolescence.

 As an adult GH and IGF-1 are still potent growth factors and also they exert essential regulatory properties on human metabolism(9,10) GH- signalling pathways go through the GH-receptor, which phosphorylates and thus activates the receptor associated Janus Kinase 2 (JAK2).

 The signals from this point have been examined in numerous studies.
 ...
 GH stimulates lipolysis, but exactly how the lipolytic properties of GH are mediated is not fully understood.

 However, it is shown that GH has an effect on hormone-sensitive lipase (12) (HSL).
 ...
 Humane intracellular signaling-pathways during development of ketosis/ketoacidosis are not well-known.

 The investigators believe that understanding these pathways and the exact mechanisms behind the development of ketoacidosis, is of great importance.
...
Diabetes mellitus type I (DM I) is characterized by lack of endogenous insulin and these patients are 100% dependent on insulin substitution to survive.
 ...
 Growth hormone (GH) is also a potent anabolic hormone, responsible for human growth and preservation of protein during fasting.

 GH (in concert with lack of insulin) induces lipolysis during fasting.

 It is not known how GH exerts its lipolytic actions.
 ...
 Lack of insulin (ketosis/ketoacidosis) 3.

 Good glycemic control and GH injection