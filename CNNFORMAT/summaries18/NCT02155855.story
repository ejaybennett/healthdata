(firstQuint)Telemedicine for Adolescents With Insulin-dependent Diabetes.

 Study Group Study group will be asked to test blood glucose at least 4 times a day Each time the study subject takes a meter reading the meter time-stamps the reading.
 ...
 Device will be programmed to coax patients when readings are due.

 Parents will be notified by device about the blood glucose testing results.

 Provider will set device to alert patient or patient's family if patient has not yet tested or uploaded a test or send alerts to parent if uploaded numbers are outside an identified range ( 300 mg/dL).
 ...
 Control group Subjects will continue routine care which requires blood glucose testing at least 4 times a day.
...
.
 ...
 Study group will have two virtual visits (months 3 and 6) Control group will have all quarterly visits in person.

 A laptop will be used for virtual visits and will be set up with the help of the TTUHSC Information Technology Security Officer.

.

 Telemedicine for Adolescents With Insulin-dependent Diabetes@highlight
