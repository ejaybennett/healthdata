(fifthQuint)Use of PillCam ESO2 in Triaging Patients Present With Upper GIB.
 ...
 - Legally a patient has to be signed off by a clinician within 6 hours.

 The finding of fresh blood or coffee ground will be documented.

 Upper GI pathology that may lead to bleeding will also be recorded.

 Capsule Endoscopy (CE) After confirming patient has been fasted for at least 5 hours, the subject ingested the PillCam(R) ESO 2 (Given Imaging Ltd.

, Yoqneam, Israel) (PillCam ESO) using the Simplified Ingestion Procedure.

 Thirty to sixty minutes prior to capsule ingestion, each subject received a single dose of intravenous Maxolon 10mg.

 Intravenous Maxolon, through its motilin receptor agonist effect, has been shown to promote gastric motility and improve visualization of the gastric mucosa at endoscopy.

 Moreover, use of Maxolon was thought to facilitate the capsule entering the duodenum.

 Using the REAL time viewer, UGI tract images (esophagus to the second portion of the duodenum) were obtained in real time at the patient's bedside.

 The video images that are transmitted by the PillCam ESO 2 are displayed in real time on the tablet computer screen.
 ...
 Other demographic data and parameters for Blatchford score calculation will be collected.

 10 ml of blood will be taken for routine blood checking.

 Patients will receive standard care according to EGD findings.

.

 Use of PillCam ESO2 in Triaging Patients Present With Upper GIB@highlight

Background - Patients presented to hospital with coffee ground vomiting and black stool may not be actually having upper gastrointestinal bleeding (UGIB) - Hospital admission can be avoided if serious UGIB can be excluded - To date, the only useful tool to triage patient for hospital admission in UGIB is by using clinical score such as Rockall score or Blatchford score - These scores are cumbersome and only exclude the most benign cases, but they are not useful in differentiating those who needs intervention - In our pilot study, investigators found that capsule endoscopy can be used to identify patients with fresh blood and real coffee ground substance in the stomach and it is superior to nasogastric tube - Most of UGI lesions leading to bleeding can be diagnosed by capsule endoscopy Objectives The current study is designed 1.

 to validate capsule endoscopy is an effective method in identifying patients with UGIB 2.

 to study whether the capsule endoscopy can reduce requirement of hospital admission in patients with suspected UGIB 3.

 to study if capsule endoscopy can help to identify patients with UGIB that may require urgent (within 24 hours) endoscopy and intervention 4.

 to study the cost-effectiveness of capsule endoscopy being used as a triaging tool in the management of UGIB 5.
