(fifthQuint)Simplified Pulse Wave Velocity Measurement, Validation Study of the pOpmtre in Children.
 ...
 Different methods can be used to measure pulse wave velocity in children: these include applanation tonometry devices such as the SphygmoCor (R) system.
 ...
 The pOpmetre(R) uses 2 distal oxygen saturation sensors on finger and toe to deduce pulse wave velocity.

 This device has already been validated in adults.

 The aim of this study is to validate the pOpmetre in children between 4 and 8 years old.

 In that purpose, patients are installed in the supine position, at rest.

 The child's mensurations are measured.

 The two pOpmetre sensors are put on finger and toe.
 ...
 Pulse wave velocity is measured with the pOpmetre using the time delay between finger pulse signal and toe pulse signal.

 The values got with the two devices are compared using a Bland and Altman graph.

 The pOpmetre is considered to be validated if the 95% confidence interval of the bias is included between -0.

5 m/sec and 0.

5 m/sec that is about 10% of the normal value at that age (5.
...
.
 ...
 Simplified Pulse Wave Velocity Measurement, Validation Study of the pOpmtre in Children@highlight
...
Arterial stiffness is an important marker of cardiovascular risk.
 ...
 An easier method called pOpmetre using saturation sensors is validated in adults but not in children.

 The objective of this study is to compare the pulse wave velocity values measured with the pOpmetre(R) with those of the SphygmoCor(R) to validate the pOpmetre in children between 4 and 8 years old.
