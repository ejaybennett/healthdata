(firstQuint)Impact on the Oxidative Stress of the Different Analogues of Insulin in People With Type 1 Diabetes.

 (Ineox Study).

 To evaluate by a randomized study in a group of people with DM 1 the influence in parameters of oxidative stress of the treatments with the different current analogs of Insulin by analyzing: 1.

 - The circulating levels of oxidative stress markers: A) Anti oxidation: Total antioxidant capacity (CAT), B) Oxidation: 8-iso-prostaglandin F2 alpha (8-iso-PGF2), acid reactive substances Thiobarbituric (TBARS) and LDL-oxidized.
