(secondQuint)Developing Models for Fatigue Monitoring in Obstetrics and Gyne- Cology Residents Using Wearables.
 ...
 Elevated fatigue is an indication that a person may not be fit-to-task (i.

e.

, task efficacy).

The investigators main goal is to use readily available body-worn sensors, such as an activity wrist-band, to continuously monitor for fatigue as a possible antecedent to predictions of task-efficacy in the area of Obstetrics and Gynecology.
 ...
 The investigators aim is to extend HRV based models with additional personal measures (e.

g.

, age, weight, activity level), possibly with the extraction of additional data-driven features, to improve model accuracy at the individual level.
...
.
 ...
 Developing Models for Fatigue Monitoring in Obstetrics and Gyne- Cology Residents Using Wearables@highlight
