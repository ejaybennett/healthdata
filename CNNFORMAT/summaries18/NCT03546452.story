(thirdQuint)A Prospective Study to Evaluate the Consistency of Next-Generation Sequencing(NGS)-Panels by Using Malignant Hydrothorax Form NSCLC.
...
, Ltd.
 ...
 Each IVD enterprise will complete the test within 7-10 working days and fill out the results in accordance with the report template provided by this research project (provided by Guangzhou Burning Rock Medical Examination Institute Co.

, Ltd.

) and submit to sponsor by email.
...
.
 ...
 A Prospective Study to Evaluate the Consistency of Next-Generation Sequencing(NGS)-Panels by Using Malignant Hydrothorax Form NSCLC@highlight

A prospective study to evaluate consistency of different NGS-panel.

 Cell free DNA is purified from each malignant hydrothorax from NSCLC .

Different NGS-panels are applied to perform in vitro diagnosis to detect Single Nucleotide Variants(SNV) and to calculate TMB value in these DNA samples.

Consistency of enrolled NGS-panels are then evaluated by statistical analysis.
