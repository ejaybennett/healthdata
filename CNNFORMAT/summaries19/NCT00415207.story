(thirdQuint)Pharmacogenomics of Paclitaxel in Ovarian Cancer.
 ...
 We will use tissue from patients who participated in one of two clinical trials that are both closed for inclusion.

 Genotypic data from this tissue will be correlated with toxicity and survival data drawn from a research database.
...
This study will try to determine whether or not certain genes are responsible for the huge variation in toxicity and effect observed between patients treated with paclitaxel (chemotherapeutic drug).
 ...
 Specifically we will study this retrospectively in patients who participated in clinical trials that are now closed.

 All patients had ovarian cancer and received paclitaxel/carboplatin chemotherapy after primary surgery.
