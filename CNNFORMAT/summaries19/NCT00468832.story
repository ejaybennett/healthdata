(fifthQuint)Longitudinal Study of the Natural History of Duchenne Muscular Dystrophy (DMD).

 Phenotyping Study Aims Aim 1: Longitudinally assess body function and body structure (impairment) through the measurement of anthropometrics, muscle strength and pulmonary function in subjects with DMD through the multicenter CINRG network.
 ...
 AIM 11: To determine the impact of development and growth on outcome measure performance,we will assess physical function on a group of healthy, typically developing male children and adults between 6 and 30 years of age for outcome measures of motor function and strength including the9-HPT, 6MWT, NSAA, timed function tests and quantitative muscle strength (QMT).

 Test results from this cohort will be used to develop initial percent predicted for age values for these assessments.

 SNP Genotyping Study Aim Our goal of the proposed study is to define polygenic modifiers of disease progression, and also response to treatment with glucocorticoids (prednisone and deflazacort).

 The most common type of human genetic variation is the single-nucleotide polymorphism (SNP, a base position at which two alternative bases occur at an appreciable frequency (>1%) in the population.

 SNPs are 90% of variation in the human genome.

 SNPs occur on the average of 1 per 1000 to 2000 bp throughout the 3.

2 billion bp of the human genome while coding region SNPs (cSNPs) occur on the average of 1 per 346 bp.

 Genome-wide Association Study Aim Our goal of the proposed study is to isolate genomic DNA and find possible correlations of clinical phenotypes with gene loci associated with mild vs.

 severe clinical presentation, progression, or response to steroids.

 Serum Biomarkers Study Aim Our goal is to discover and validate sensitive and specific serum biomarkers for DMD.

.

 Longitudinal Study of the Natural History of Duchenne Muscular Dystrophy (DMD)@highlight

The purpose of this study is to establish the largest long-term assessment of people with Duchenne muscular dystrophy (DMD).

 In this study, the investigators associated with the Cooperative International Neuromuscular Research Group CINRG) will take a detailed look (for a minimum of eight years) at DMD participant's physical abilities, the medical problems they experience, and how they use health care services.

 Physical abilities will be compared to a group of healthy controls.
