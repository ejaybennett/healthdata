(secondQuint)Reduction of the Glycemic Index by a Novel Viscous Polysaccharide.

 Recently, a commercial novel viscous polysaccharide (NVP)complex has been developed which is marketed in both the USA and Canada under the trade name PGX(R) (PolyGlycopleX) (InovoBiologic Inc, Calgary, AB, Canada).

 This complex consists of three viscous non starch polysaccharides which are processed using proprietary technology (EnviroSimplex(R)) to produce compressed granules which delays the onset of viscosity and increases palatability of the fiber when added to food.
...
.
 ...
 Reduction of the Glycemic Index by a Novel Viscous Polysaccharide@highlight
