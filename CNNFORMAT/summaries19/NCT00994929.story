(fifthQuint)Efficacy and Safety of IL-11 in DDAVP Unresponsive.
 ...
 Study subjects will include adults, age >= 18 years, with hemophilia A, moderate, defined as factor VIII 0.

01-0.

04 U/ml, or mild, defined as factor VIII >= 0.

05 U/ml; or with VWD defined by low VWF:RCo and /or low VWF:Ag, past bleeding history, and/or family history of VWD.
...
.
 ...
 Efficacy and Safety of IL-11 in DDAVP Unresponsive@highlight
...
The purpose of this study is to determine the biologic efficacy and safety of rhIL-11 when given subcutaneously in adults with moderate or mild hemophilia A or Von Willebrand disease unresponsive to DDAVP.
 ...
 Biologic efficacy will be measured by the number and percent increase of VWD coagulation tests (FVIII:C, VWF: Ag, VWF: RCo, closure time, APTT, and VWF multimers) to the normal range, or at least to 1.

5-3 time baseline, following dosing of rhIL-11 when given daily for 4 days, and boosted by DDAVP infusion on day 4, in those in whom DDAVP is not contraindicated.
