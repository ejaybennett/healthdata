(firstQuint)Intraoperative Protective Ventilation in Abdominal Surgery (IMPROVE Study).

 Postoperative complications are associated with a significant and quantifiable rate of both morbidity and mortality, increased length of hospital stay and cost of care.

 Intra-abdominal surgery, especially upper abdominal surgery, is an important risk factor of both pulmonary and extra-pulmonary complications.

 Up to 15-20% of patients will develop postoperative respiratory failure which may require respiratory support.

 Recent data from both experimental and clinical studies suggested that, compared with conventional ventilation using high tidal volume (TV) without positive end-expiratory pressure (PEEP), intraoperative lung protective ventilation using low tidal volume, PEEP and recruitment maneuvers (RM) could reduce postoperative complications.

 Conventional ventilation promotes sustained cytokine production and could therefore contribute to development of lung injury with in patients with normal lungs.
...
.
 ...
 Intraoperative Protective Ventilation in Abdominal Surgery (IMPROVE Study)@highlight
