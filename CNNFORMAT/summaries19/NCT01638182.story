(thirdQuint)Biocomparison Study.

 Vitamin K is a group name for the naturally occurring phylloquinone (K1) and menaquinones (MK-n; K2).

 The latter can be subdivided into the short-chain (e.

g.

 MK-4) and the long-chain (e.
...
g.
 ...
 In the dietary range, MK-7 has been suggested to be the most effective cofactor for the carboxylation of Gla-proteins, such as osteocalcin (OC) and matrix-Gla protein (MGP).

Until now, no randomized controlled trial has compared the efficacy of K1 versus MK-7 in a nutritional dose range.
