(fifthQuint)Plasma microRNA Profiling as First Line Screening Test for Lung Cancer Detection: a Prospective Study.

 Three decades of research have shown that radiological screening of heavy smokers can detect resectable early lung cancers with higher frequency but benefit on mortality is still debated.

 The preliminary results of the first two randomized spiral-CT screening trials appear conflicting, with one study showing no benefit and the other a limited mortality reduction (-7%).

 In the next 3-4 years the ongoing randomised trials in Europe will provide conclusive data on the efficacy of CT-screening for lung cancer.

 Nonetheless, no major impact on mortality is to be expected.

 A possible explanation of these finding is that not all aggressive lung tumors arise from identifiable slow-growing precursors, thus suggesting a possible paradigm shift in our understanding of the natural history of lung cancer.

 In this respect the identification of biologic and molecular features of indolent and aggressive disease could be useful to define clinical predictors of high risk lesions and select suitable cohorts of patients who might benefit of current treatments as well as to identify genetic signatures that might represent novel therapeutic targets.
 ...
 Overall, the results of this large prospective study will permit to establish the potential of our plasma microRNA assay as a first-line screening test for lung cancer detection in a routine clinical practice for high-risk population screening with a low cost, non toxic and non invasive procedure.

 Moreover, the related functional studies foreseen in the project could lead to the identification of novel, miRNA targeted, therapeutic approaches for this malignancy.

.

 Plasma microRNA Profiling as First Line Screening Test for Lung Cancer Detection: a Prospective Study@highlight
