(fifthQuint)Reprogramming Insoles In Regulating Blood Pressure In Hypertensive Subjects.

 Posture can be defined as the way body acquires at any given time in relation to gravity line, and suffers influence of sensory information from different segments, organs and systems, integrated to cerebral cortex.

 Once information is associated, analyzed and compared, is sent to tonic and phasic-tonic muscles that will perform necessary adjustments to maintain posture.

 When sensory information captured by body are unbalanced, body reacts to this information with deformities and misalignment like flat feet, scoliosis, among others.

 Posturology is a way of treating these alignment changes, which is based on use of postural reprogramming insoles (PRI) to return individual to an appropriate posture.

 The PRI is composed of a central artifact which stimulates autonomic system, via tonic postural system, promoting posture adaptation/regulation.
 ...
 Therefore, it is necessary to encourage dietary control, increased patient support and new forms of affordable and effective non-pharmacological treatment, in addition to measuring the impact disease causes in life and living of those patients.
 ...
 Health-related quality of life (HRQOL) is evaluated based on objective and measurable data, applied to sick people to identify committed dimensions and discomfort degree associated with limitation disease and/or therapy can cause.

 Thus, health professionals can effectively measure impact of interventions on health-related quality of life.
 ...
 THEORETICAL RATIONALE Imbalances that affect posture are a reflection of asymmetry in Tonic Postural System (TPS).

 The simplified model of organization of STP states that equilibrium depends on the fascia and muscles viscoelastic system to maintain balance against body mass actions, gravity, and height.
 ...
 Posture can be classified as appropriate or inappropriate.

 When sensory information captured by body are symmetrical and well organized, tonic-postural system reaction generates minimal overload of bone, joint and myofascial structures, producing a lower energy expenditure for maintenance of these structures, favoring relative alignment to gravity and individual has an appropriated posture.

 If sensory information, captured by body are unbalanced, inconsistent and disorganized, tonic-postural system requires more of muscles, joints, fascia and bone structures, to keep body segments reacting to gravity force.

 It creates a disharmonious relationship of various parts of body, producing a greater burden in supporting structures and a less efficient body balance on their stand weight basis, creating greater energy expenditure, misalignment and deformities like flat feet, knees valgus, scoliosis, among others and then person has poor posture.

 During motion, there is a predicted movement and movement that is actually done.

 Between these two points there is cerebellum, which is the structure that compares predicted and performed movements by promoting postural adjustments, carried out so that movement is close to what was expected.

 Cerebellum organizes, provides, adjusts and modifies movement.

 Adaptation system function to get body back into balance in cases of imbalance, which can be both internal and external.

 Terminal system adaptation is foot and therefore there is no reprogramming in TPS without focusing foot, with use of postural reprogramming insole (PRI).

 PRI artifact is formed by two crossed polarizing devices, which creates a electrogalvanic field that loads and unloads, causing vibration that integrates with energy field of individual.
 ...
 Mini-Questionnaire Quality of Life in Hypertension - MINICHAL-Brazil suffered cultural adaptation and validation into Portuguese, which was tested for content, construct and internal consistency of instrument, comparing outcomes in hypertensive patients and patients with normal BP.

 Subsequently, other studies have been published testing concurrent validity by comparing Minichal with two other questionnaires used in many researches in Brazil: Short Form 36 (SF-36) and the WHOQOL questionnaire (WHOQOL-Bref), showing significant correlation to both questionnaires, making a specific tool for assessing health-related quality of life in hypertensive population.
...
.
 ...
 Reprogramming Insoles In Regulating Blood Pressure In Hypertensive Subjects@highlight

ASH has a high prevalence rates and considered one of the major modifiable risk factors for cardiac vascular diseases (CVD) and brain vascular diseases (BVD) and one of the most important public health problems.

 Researches estimated 62% of BVD can be attributed to ASH.

 In Brazil, prevalence of hypertension ranged from 21.

6% in 2006 to 42.

4% in 2011.

 CVD are responsible for high frequency of hospitalization, and in 2009, 91,970 hospitalizations due to CVD cost public treasury more than 165 million reais.

 ASH neurological pathophysiology studies has shown that excessive activation of sympathetic autonomic nervous system (SANS) seems to have an important role in genesis and maintenance of ASH, with current studies aimed to understand this relationship.

 Pathways used by SANS for immediate control of BP (wich are reticulate formation, bulb and cortex) appear to be similar to pathways used for postural control reflex (reticulate formation, bulb, cortex, among others), which are also used by Postural Reprogramming Insoles (PRI) for posture adequacy.

 Due to this similarity in reflex activation areas, it is believed that PRI may have some effect on BP regulation.

 There are many ways to treat postural changes and one of them is posturology, which is based on therapeutic use of postural reprogramming insoles (PRI).

 PRI activates tonic-postural system, rebalancing muscles, joints and bony structures of body segments, and returning individual to an appropriate posture.
