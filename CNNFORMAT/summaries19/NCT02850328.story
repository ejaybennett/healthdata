(fifthQuint)Muscular Force Generation in Microgravity.

 The findings from water immersion indicated that some motor tasks, such as plantarflexion (25), but not others, such as the leg-press (7), appear to be affected.

 Thus, it would be relevant to test a number of motor tasks and body regions.

 On the other hand, parabolic flight requires that methodologies can be performed in a quick efficient fashion.

 Hence, we propose examining ankle plantarflexion, leg-press and grip-force.

 The primary hypothesis is that plantarflexion MVC will be reduced in the microgravity phase of parabolic flight.

 As secondary parameters will be assessed parameters of muscle function that can be easily implemented in parabolic flight, such as electromyography and ultrasound measurements of the musculotendinous unit.

 To assess the muscular system more deeply, for plantarflexion superimposed twitches will be performed (16) during MVC and at rest.

 An additional experimental condition placing foam (unstable surface; standard size) under the foot during plantarflexion will be included.

 This approach increases the challenge for the neuromuscular control system and, under such conditions, MVC is reduced (29).
...
.
 ...
 Muscular Force Generation in Microgravity@highlight
