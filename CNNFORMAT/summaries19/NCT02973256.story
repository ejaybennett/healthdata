(fifthQuint)Oncological Care for Patients With Meningioma.

 Meningiomas with malignant components include grade II meningiomas (GIIM, the most common ones) and grade III meningiomas (GIIIM).

 They represent 5-35% of all meningiomas.

 Histological diagnosis of GIIM criteria were changed in 2007 and might be viewed by some as being quite subjective.

 "Standards of care" and consensus do not exist for GIIM, particularly in regards to performing, or not, radiotherapy after surgery.

 One other limitation in the literature is lack of data on health-related quality of life (HRQoL).

 Clinical trials for GIIM are very difficult to conduct.

 No results have been made available.
 ...
 Secondary objectives (for GIIM and GIIIM): - Evaluate the recurrence/progression free survival (PFS), volumetric velocity of the tumor growth (VVTG) after surgery and other treatment.
 ...
 The methodology used is based on a multidisciplinary national network already established by the French Brain Tumor DataBase (FBTDB), with the active participation of societies involved in the French neuro-oncology and the "Inter Groupe Cooperateur en Neuro-Oncologie", labeled by the French National Cancer Institute.
 ...
 The statistical analysis (to answer to the main question) will concern all GIIM only.

 Hypothesis: Experimental group: Group of GIIM with postoperative radiotherapy (n=314).

 Control group: Group of GIIM with postoperative follow-up only (n=732).

 With a bilateral type I error of 5% (two-sided) and a statistical power of 80% we will be able to demonstrate that postoperative radiotherapy will be associated with a Hazard ratio (mortality risk) of 0.

80.

 Secondary endpoints (for GIIM and GIIIM): - PFS, VVTG after surgery and other treatment.
 ...
 It is expected to: - Define subgroups of patients, according to prognostic factors, which would benefit from postoperative radiotherapy in GIIM.
...
.
 ...
 Oncological Care for Patients With Meningioma@highlight
...
Meningiomas with malignant components include grade II meningiomas (GIIM, the most common ones) and grade III meningiomas (GIIIM).
 ...
 Here, we propose to study clinical, pathological, radiological and therapeutic factors of an exhaustive population of GIIM and GIIIM patients, at national level.

 The main objective (for GIIM) is to assess the impact of postoperative radiotherapy, or the absence of postoperative radiotherapy, on overall survival and on quality of life