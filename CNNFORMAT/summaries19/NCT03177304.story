(fifthQuint)Web Based Therapist Training in Interpersonal Psychotherapy for Depression.

 Experts from scientific, ethical, and economic perspectives have stressed the need for evidence-based mental health treatments, i.

e.

, 'treatment based on the best available science or research evidence.
...
' While several evidence-based treatments have been developed, there is a critical shortage of clinicians trained in these approaches.
 ...
 In contrast to other evidence based therapies (e.

g.

, cognitive behavior therapy), for which new training technologies have now been extensively studied, limited efforts to disseminate IPT to date have relied on traditional approaches (e.

g.

, workshops), which are not cost-effective or easily accessible.
...
.
 ...
 Web Based Therapist Training in Interpersonal Psychotherapy for Depression@highlight

The National Institutes of Mental Health has identified the use of empirically based mental health treatments (i.

e.

, treatments with research supporting efficacy) as a priority, yet there is a shortage of clinicians trained in these approaches.
