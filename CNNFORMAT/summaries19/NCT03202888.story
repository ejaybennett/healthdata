(fifthQuint)Family Input for Quality and Safety.
 ...
 The investigators plan to test the central hypothesis and thereby accomplish the objective of this application by focusing on the following areas of research for Health IT: Use, Implementation, and Impact on Outcomes, under the study type "Pilot and feasibility", pursuing three specific aims: Aim 1.

 Determine feasibility and acceptability of the patient data collection and provider dashboard tool (Use and Implementation).
 ...
 Assess whether reporting patient- and caregiver- observed processes of care to providers leads to changes over time (Implementation).
 ...
 Estimate tool implementation effect sizes, using a pre-post design, on medical errors (Impact on outcomes).
...
.
 ...
 Family Input for Quality and Safety@highlight
...
This project aims to create and evaluate a tool that gathers patient and family member feedback and makes it rapidly available to providers, enabling nimble and responsive safety and quality improvement efforts.
 ...
 Determine feasibility and acceptability of the patient data collection and provider dashboard tool.
 ...
 Estimate tool implementation effect sizes, using a pre-post design, on medical errors.
