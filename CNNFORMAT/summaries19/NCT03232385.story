(firstQuint)Modality Augmentation for Navigation: Intuitive Fusion With Optical Lightweight Device (US/MR).
 ...
 The selected procedure must be a single-patient interaction (i.
...
, no follow-up visits).
 ...
 The anticipated sample size is expected to be around 100 subjects (i.

e.

, 50 per arm), per modality.
...
.
 ...
 Modality Augmentation for Navigation: Intuitive Fusion With Optical Lightweight Device (US/MR)@highlight
