(thirdQuint)PRD-guided Analgesia During FESS for Intraoperative Blood Loss.

 Intraoperative blood loss during FESS constitutes a major problem for a surgeon because it influences quality of surgical field.

 Each incident of haemorrhage makes the operator stop the procedure in order to bring back the optimal visualization of the intranasal anatomy.

 In the end it prolongs the time of procedure.
 ...
 Recently, Pupillary Dilatation Reflex (PRD) was added as a surrogate variable showing the nociception-antinociception balance into above mentioned parameters constituting a novel approach in monitoring patients intraoperatively, known as adequacy of anaesthesia (AoA) or tailor-made anaesthesia.

 PRD value >5% reflects increased sensitivity to painful stimulus it constitutes the indication for administration of rescue analgesia intraoperatively.
...
.
 ...
 PRD-guided Analgesia During FESS for Intraoperative Blood Loss@highlight
