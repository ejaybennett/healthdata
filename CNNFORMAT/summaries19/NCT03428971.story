(thirdQuint)P-wave Terminal Force in Patients With Atrial Fibrillation.
...
.
 ...
 We aim to follow PT, PAM and Ptf changes during 5-year follow-up (5FU) and examine the relation of these changes to the number of AF episodes requiring hospitalisation (HOSP) for restoration of sinus rhythm (RSR).

 We hypothesise that, in patients with atrial fibrillation (AF): 1.

 the index parameters (PT, PAM, Ptf), characterising left atrial repolarization, correlates the number of future hospitalisations (HOSP) aimed for restoration of sinus rhythm (RSR) in 5-year follow-up (5FU) 2.
