(firstQuint)Comparison of High-flow Oxygen vs.

 BiPAP in Type II (Hypercapnic) Respiratory Failure.
 ...
 All patients treated with HFNC were treated with an Optiflow device (Fisher&Paykel).

 Various Bilevel positive airway pressure (BiPAP) devices were used during the study period.

 All ventilatory parameters were set according to the treating physicians' preferences.

.

 Comparison of High-flow Oxygen vs.

 BiPAP in Type II (Hypercapnic) Respiratory Failure@highlight
