(thirdQuint)Magnetic Resonance Imaging in Women Receiving Chemotherapy for Stage III Breast Cancer.

 OBJECTIVES: - Identify surrogate markers of response to neoadjuvant chemotherapy by contrast-enhanced magnetic resonance imaging (MRI) that are predictive of pathologic remissions and survival in women with stage III breast cancer.
 ...
 Patients also undergo mammograms and possibly ultrasounds that coincide with the first and last MRI.

 Core or needle biopsy is performed after the first MRI but before the first course of Type 1 chemotherapy and between Type 1 chemotherapy and Type 2 chemotherapy (if the patient continues to Type 2 chemotherapy).

 Patients are followed every 6 months for 7-10 years.

.

 Magnetic Resonance Imaging in Women Receiving Chemotherapy for Stage III Breast Cancer@highlight
