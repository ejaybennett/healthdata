(thirdQuint)Venlafaxine for Hot Flashes After Breast Cancer.
 ...
 This randomized, double-blind, placebo-controlled crossover trial examines the effectiveness and toxicity of sustained release venlafaxine hydrochloride (37.

5 mg po qd) on hot flashes in women following treatment for breast cancer.
...
, mean, slope, maximum response, range, proportion, achievable difference) will be used to effectively reduce the design to a 2 X 2 crossover and data will be analyzed accordingly (i.

e.

, t-tests, linear regression, GEE, mixed model).
...
.
 ...
 Venlafaxine for Hot Flashes After Breast Cancer@highlight
