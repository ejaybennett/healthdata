(firstQuint)A Comparative Study of JNS013 in Participants With Post-Tooth-Extraction Pain.

 This is a multi-center (conducted in more than one center), double-blind (neither Physician nor participant knows the name of the assigned drug), randomized (study drug assigned by chance), parallel-group (each group of participant will be treated at the same time) and comparative study in participants having pain intensity of at least 50.

0 millimeter (mm) (on visual analog scale, score ranging from 0 mm [no pain] to 100 mm [worst possible pain]), following extraction of an impacted mandibular wisdom tooth.
...
.
 ...
 A Comparative Study of JNS013 in Participants With Post-Tooth-Extraction Pain@highlight
