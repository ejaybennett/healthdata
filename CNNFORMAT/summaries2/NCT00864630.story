(fifthQuint)Neuroimaging for Depression.
 ...
 Extrapolating from existing reports of depressive episodes during short-duration spaceflight, depression is thus a probable condition in one or more members of a five to seven person crew during a long duration spaceflight (e.

g.

, a 30 month mission to Mars).
 ...
 Aim 3 will focus on the ability of brain imaging to help predict the efficacy of Dr.

 Cartriene's computer based problem solving therapy.

.

 Neuroimaging for Depression@highlight
...
The investigators seek to determine whether brain imaging techniques can be used to help detect depression, assess its severity, and/or monitor or predict responses to treatment.
 ...
 Subjects with minor or major depression will be randomly assigned to a wait-list control group or to treatment with a new computer-based cognitive behavior therapy developed by Dr.
