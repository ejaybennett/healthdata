(fifthQuint)An Exploratory, Open Label, Multi-Center, Non-Randomized Study of [F-18]VM4-037.
 ...
 CA-IX is a very active enzyme which may acidify the extracellular microenvironment of tumor cells in response to hypoxia.

 Its expression usually promotes tumor growth and invasion, and thus impairs prognosis.
 ...
 This initial trial will be an Exploratory, Phase 0 study designed to evaluate biodistribution, collect baseline and tumor/background imaging data, and gather preliminary safety data for this investigational product.

 The study results will be analyzed and considered in the design of future clinical trials.

 The primary objectives of this exploratory study are: - To gain information on the bio-distribution of [F-18]VM4-037, to evaluate the PET images of [F-18]VM4-037 for resolution and signal to background ratio for tumors, and to determine CA-IX expression in tumor tissues by CA-IX antibody with immunohistochemistry - To collect safety data, and to use this eIND in order to obtain the necessary information to file an IND (Investigational New Drug) application with the FDA (Food and Drug Administration) The secondary objectives for this exploratory study are: - To begin collection of baseline imaging and metabolism data - To gain information to improve study design for the conduct of future trials The trial is expected to begin subject enrolment in approximately April, 2009 and end subject participation in approximately September, 2009, depending on the rate of enrollment.

 The subject is expected to attend three visits, adding up to several hours.

 The Investigational Product (IP) being tested in this study is [F-18]VM4-037.

 The [F-18]VM4-037 will be administered to each qualified subject via a bolus intravenous (IV) injection.

 For normal volunteers, the dose will not exceed 20 mCi, as the imaging time for dosimetry is a minimum of four hours.

 For cancer subjects, the dose will be closer to 10 mCi (total imaging time for cancer subjects is about 2 hours).
 ...
 An Exploratory, Open Label, Multi-Center, Non-Randomized Study of [F-18]VM4-037@highlight
