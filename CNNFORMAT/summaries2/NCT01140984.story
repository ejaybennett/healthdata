(secondQuint)Intra Arterial (IA) Steroids Infusion for Hepatic Acute Hepatic Graft Versus Host Disease (aGVHD).
 ...
 Standard treatment for SR AGVHD includes: IV cyclosporine or tacrolimus with adjusted doses depending on serum levels and methylprednisolone or prednisone 2 mg/kg/d.

 This treatment may be continued during the study period although steroid taper down should be attempted if clinically possible.

 GVHD diagnosis will be based upon clinical criteria and biopsy (if needed) from an involved organ.

 GVHD will be graded according to the International Bone Marrow Transplantation Registry (IBMTR) severity index.
 ...
 Definitions Hepatic response: - Initial response - the day in which bilirubin level began to decrease.
...
.
 ...
 Intra Arterial (IA) Steroids Infusion for Hepatic Acute Hepatic Graft Versus Host Disease (aGVHD)@highlight
