(fifthQuint)Enhancing the Effectiveness of Physical Therapy for People With Knee Osteoarthritis.
 ...
 'Booster' intervention sessions (periodic face-to-face follow-up appointments following discharge from supervised therapy designed to review and progress the patient's home program, troubleshoot problems with the program, etc.

) have been recommended to make beneficial effects endure however this recommendation has not been adequately tested.
 ...
 Therefore, the overall aim of the project is to examine the clinical and cost-effectiveness of utilizing booster sessions in the delivery of ET, and supplementing ET with MT techniques.

The study will be a multi-center,randomized clinical trial, using a 2 x 2 factorial design (factor 1 = booster vs no booster, factor 2 = ET alone vs ET + MT).
 ...
 The primary endpoint for clinical outcome will be the WOMAC at 1 year.
...
.
 ...
 Enhancing the Effectiveness of Physical Therapy for People With Knee Osteoarthritis@highlight
