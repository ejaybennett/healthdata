(secondQuint)Intima-Medial Thickness Guidance of Primary Prevention in Relatives of Patients With Early onSet Atherosclerosis.

 Individuals at intermediate risk account for a large proportion of patients presenting with atherosclerotic events.

 The barriers to reducing this problem relate to the expense of an unselective primary prevention strategy among a group where the majority will not have events, as well as the difficulty of getting apparently well subjects to adhere to lifestyle and pharmacologic management.

 An outcome-based study would require large numbers and would be unlikely to be funded without proof of concept.
 ...
 The Intima-Media thickness guidance of Primary prevention in Relatives of individuals with Early onSet atherosclerosiS (IMPRESS) Study will test the following null hypothesis: In intermediate risk, first-degree relatives (i.
...
e.
 ...
 Study Centres As a multicentre study, participants will be recruited from three centres: - Princess Alexandra Hospital (Brisbane, Australia): responsible site investigator Associate Professor Karam Kostner - Baker IDI Heart and Diabetes Institute/ The Alfred Hospital (Melbourne, Australia): responsible site investigator Dr Melinda Carrington - National University Health System and Novena Heart Centre (Singapore): responsible site investigator Professor Desley Hegney Participants This study will be conducted in a group of 40-65 year old adults.

 IMPRESS Study will test the following null hypothesis: In intermediate risk, first-degree relatives (i.
...
e.
 ...
 Secondary End-Points The secondary endpoints are change from baseline to three years in the following variables: i) Plaque length (carotid artery) ii) Internal CIMT iii) General health and well being (as measured by the SF-12 18 and EQ-5D 19) iv) Mental health (as determined by the Arrol 20 +/- CESD 21) v) Health care costs vi) Modifiable risk factors for atherosclerotic disease other than diabetes ( i.

e.

 smoking, dyslipidaemia, obesity and hypertension) vii) Absolute cardiovascular risk profile 22 and risk of diabetes (as determined by the Type 2 Diabetes Risk Assessment Tool [AUSDRISK]) Score 23) viii) Diabetic status (as determined by fasting glucose) ix) All-cause mortality/ cardiovascular hospitalisation.

 Intima-Medial Thickness Guidance of Primary Prevention in Relatives of Patients With Early onSet Atherosclerosis@highlight
