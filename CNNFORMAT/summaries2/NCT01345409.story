(fifthQuint)Acupuncture and Chiropractic Care for Chronic Pain in an Integrated Health Plan.

 Substantial recent research examines the efficacy and biological basis of many types of complementary and alternative (CAM) therapies.

 However, "real-world" use of CAM has been largely overlooked, despite calls for CAM therapies to be studied in the manner in which they are practiced and urging high prioritization for research that includes clinical outcomes, cost-effectiveness, and the decision-making process for patients and providers.

 There is, therefore, heightened need for enriched understanding-particularly given CAM's growing popularity, which fortunately offers stores of new data for research.

 Recent studies suggests that Americans seek CAM treatments far more often for chronic musculoskeletal pain (CMP) than for any other condition.

 Among CAM treatments for CMP, acupuncture and chiropractic (A/C) care are among those with the highest acceptance by physician groups and the best evidence to support their use.
...
" Because this project consists of four discrete sets of project activities (that largely follow one another chronologically), the investigators plan to submit separate IRQs to cover each set of project activities as follows: (Phase1) Retrospective study using information from the EMR to identify unique clusters of patients with CMP, their trajectories of care within the health plan, and to examine how those in unique clusters may have differing propensities for the use of A/C services and/or differential outcomes associated with such care.
...
.
 ...
 Acupuncture and Chiropractic Care for Chronic Pain in an Integrated Health Plan@highlight

Recent research examines many types of complementary and alternative (CAM) therapies.
 ...
 A secondary purpose is to have KP members with CMP review planned assessment instruments to improve understandability of the instruments.

 They will provide feedback on: relevancy, any notable omissions of domains important in patients' decision to use CAM services for pain treatment.

 They will also provide insight to broader health and quality of life outcomes associated with such CAM treatments.
