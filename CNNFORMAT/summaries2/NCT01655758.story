(fifthQuint)24-hour Control of Intraocular Pressure (IOP) in Ocular Hypertension.
 ...
 (d) study flow-chart: upon enrollment, patients will be initiated to the following schedule: 60 days timolol 0.

5% bid, 60 days washout, 60 days timolol 0.

5%-dorzolamide 2% fixed combination bid, 60 days washout, 60 days PGA1, 60 days washout, 60 days PGA2, 60 days washout, 60 days PGA3.

 Patients were assigned to the PGAs according to a sequence (L-T-B) randomly generated.

 Data will be collected at baseline and at the and of each study phase (i.
...
m.
 ...
 by means of Goldmann applanation tonometry at the slit lamp.
...
m.
 ...
 the Tonopen in supine position will be used.

 (f) statistics: the analysis of co-variance (ANCOVA) for paired samples with Bonferroni correction will be adopted.

 A minimum sample size of 51 patients is needed for a minimal expected difference in mean IOP between inflow and outflow drugs = 2.

5 mmHg, with an estimated pooled variance = 4 , a power = 90% and an alpha probability = 5%.

.

 24-hour Control of Intraocular Pressure (IOP) in Ocular Hypertension@highlight
