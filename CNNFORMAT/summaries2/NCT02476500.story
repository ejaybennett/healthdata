(fifthQuint)Construct Validity of a Large Loop Excision of the Transformation Zone (LLETZ) Training Model.

 In a prospective case-control study, 140 medical students (,novices') and 10 Senior gynecologists (,experts') will be included.

 All participants undergo a video training with demonstration of the LLETZ procedure on a training model using a sausage as previously described (Hefler et al.
...
.
 ...
 Construct Validity of a Large Loop Excision of the Transformation Zone (LLETZ) Training Model@highlight
