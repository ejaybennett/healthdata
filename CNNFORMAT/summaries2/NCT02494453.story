(fifthQuint)Pilot Study of Biomarkers and Cardiac MRI as Early Indicators of Cardiac Exposure Following Breast Radiotherapy.
...
.
 ...
 Pilot Study of Biomarkers and Cardiac MRI as Early Indicators of Cardiac Exposure Following Breast Radiotherapy@highlight

Patients with breast cancer receive low doses to smaller volumes of the heart, but they also have an excellent long-term survival, so it is crucial to study the effects of low dose radiotherapy.

 Indeed, a recent study suggests that these effects can be seen within the first 5 years after treatment, and that there is no dose threshold.

 The investigators wish to develop imaging and blood biomarkers of cardiac exposure, as a first step to identifying patients at increased risk for cardiac effects.

 These patients can then be targeted for close monitoring and early intervention, potentially with statins or ACE inhibitors.

 Additionally, by characterizing a time-course and radiation dose-volume relationship, potentially real-time modifications can be made to radiotherapy (RT) field design for patients sensitive to RT effects.
