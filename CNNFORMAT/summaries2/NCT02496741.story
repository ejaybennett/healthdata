(secondQuint)Metformin And Chloroquine in IDH1/2-mutated Solid Tumors.

 Glioma, intrahepatic cholangiocarcinoma (IHCC) and chondrosarcoma (CS) are aggressive, malignant cancers with a dismal outcome, the two latter types especially in the locally-advanced or metastasized setting.

 This is due to a lack of effective treatment strategies and highlights the dire need for novel therapies.

 A subset of these cancer types are characterized by the presence of mutations in the genes encoding for isocitrate dehydrogenase 1 (IDH1) and isocitrate dehydrogenase 2 (IDH2).

 These mutations occur in 80% of world health organization (WHO) grade II and III glioma and secondary glioblastoma, 20% of IHCC and 60% of CS and, besides their oncogenic function, induce metabolic vulnerabilities to IDH1/2MT cancer cells that can be exploited in vitro by the oral antidiabetic metformin and the oral antimalarial drug chloroquine.
 ...
 The study protocol uses a 3+3 dose-escalation scheme.

 The primary objective is to determine the maximum tolerated dose in order to establish a recommended dose for a phase II trial.
 ...
 This study may open a novel treatment avenue for IDH1/2MT glioma, IHCC and CS by investigating two relatively safe drugs for these highly malignant tumors.

 In addition, this study may present novel therapies for other cancers that are regularly affected by IDH1/2MT, such as acute myeloid leukemia, acute lymphocytic leukemia and T-cell lymphoma.

.

 Metformin And Chloroquine in IDH1/2-mutated Solid Tumors@highlight
