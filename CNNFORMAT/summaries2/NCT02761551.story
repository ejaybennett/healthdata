(fifthQuint)Centralized IIS-based Reminder/Recall to Increase Childhood Influenza Vaccination Rates.
...
S.
 ...
 The investigators have united two leading immunization research groups (Denver, CO and Rochester, NY) to assess the impact of centralized IIS-based influenza vaccine R/R, and to evaluate the effect of intensity of recall (1 v.
 ...
 Aim 2 is to conduct a pragmatic trial, with randomization at the level of the patient within practices randomly selected to be proportionate to each state, to compare: 1) effectiveness and cost-effectiveness of centralized R/R of different intensity (1 vs.

 2 vs.

 3 messages) and usual care (0 messages) and 2) effectiveness and cost-effectiveness of R/R in specified subgroups (family medicine vs pediatric provider, rural vs urban, age of child) on receipt of influenza vaccination.

 Aim 3 will measure the effect of adding mailed or text message R/R for autodialer failures vs.

 autodialer-alone R/R on influenza vaccination rates using a 2-arm Randomized Controlled Trial (RCT).
...
.
 ...
 Centralized IIS-based Reminder/Recall to Increase Childhood Influenza Vaccination Rates@highlight
