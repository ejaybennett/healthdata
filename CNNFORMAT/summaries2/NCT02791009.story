(thirdQuint)Asian neTwork for Translational Research and Cardiovascular Trials ("ATTRaCT").

 Heart failure (HF) is the final common pathway of cardiovascular (CV) diseases and leading cause of CV hospitalizations in Singapore and worldwide, with a mortality rate that rivals most cancers (>50% mortality at 5 years).

 Also similar to cancer, HF is a staged disease where early detection and treatment are vital for prevention of disease progression from Stage A (risk factors) to Stage B (subclinical structural heart disease) and Stage C (symptomatic HF).

 Cardiac imaging is critical for the detection of early subclinical disease.
...
.
 ...
 Asian neTwork for Translational Research and Cardiovascular Trials ("ATTRaCT")@highlight
