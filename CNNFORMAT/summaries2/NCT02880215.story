(fifthQuint)Development of Attention Bias Modification for Depression.
 ...
 Findings indicate that compared to placebo ABM, active ABM reduced negative attention bias and increased resting state connectivity within a neural circuit (i.

e.

, middle frontal gyrus and dorsal anterior cingulate cortex) that supports control over emotional information.
 ...
 Although these preliminary findings are encouraging and demonstrate that ABM successfully alters the treatment target (i.

e.

, negative attention bias), the investigators' prior work is among the first to document efficacy of ABM among adults with clinically significant depression.
...
.
 ...
 Development of Attention Bias Modification for Depression@highlight
