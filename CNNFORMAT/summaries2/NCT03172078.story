(secondQuint)Sedation of Advanced Endoscopic Procedure.
 ...
 The first stage is to compare the differences between manually-controlled infusion of propofol (MCI) and target-controlled infusion of propofol (TCI) in patients undergoing advanced endoscopic procedure.

 The secondary stage is to evaluate the benefit of bispectral index (BIS) monitoring between MCI and TCI.

 The primary outcome is the total amount of propofol.

 The secondary outcomes are patients' and endoscopists' satisfaction, sedative-related adverse events, recovery time, and procedure time.

.

 Sedation of Advanced Endoscopic Procedure@highlight

To compare the total amount of propofol used by the manually-control infusion (MCI) and Target-control infusion (TCI) using standard monitoring without BIS or standard monitoring with BIS during advanced endoscopic procedure.
