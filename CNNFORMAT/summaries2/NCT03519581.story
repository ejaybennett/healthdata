(thirdQuint)Micropulse for Suppression of Diabetic Macular Edema.
 ...
 Subjects will be randomized to receive either subthreshold micropulse laser treatment or no treatment (sham).

 Randomization will occur as a ratio of 2:1 and will take place during the clinic visit.

 Subjects selected for the study will undergo a complete ophthalmic examination, including measurements of best corrected visual acuity, low luminance visual acuity, contrast sensitivity (using ETDRS testing with a masked coordinator), intraocular pressure, slit lamp exam including documentation of lens status, and dilated funduscopic exam with standard dilating agents used at the UC Davis Eye Center.

 Subjects will then undergo baseline imaging including Spectral Domain Ocular Coherence Tomography (SD-OCT), fundus autofluorescence (FAF) and microperimetry testing.

 Both the use of OCT, FAF, and microperimetry testing are within the standard of care for the management of DME.
 ...
 Patients in the treatment arm are eligible for repeat SML laser at any subsequent visit if there is any decline in vision (1 or more ETDRS lines) or worsening in edema (>10% increase), at the discretion of the treating physician.

 If vision declines to 20/40 or worse at any study visit, patients in the treatment arm will undergo repeat treatment with SML laser, while those in the sham arm will undergo repeat sham laser.

.

 Micropulse for Suppression of Diabetic Macular Edema@highlight
