(fifthQuint)3D X-ray Motion Analysis of Ankle-foot Motion After Total Ankle Arthroplasty.
 ...
 Each participant will participate in one day of data collection with an X-Ray Motion Analysis (XMA) system.

 High-speed biplanar XMA system will capture video images of the skeletal motions within the foot-ankle complex during normal movement.

 Subjects will walk and perform controlled movements in the capture volume within the XMA system.

 Following data collection, the 3D bone surface models will be mapped to the sagittal (side view), coronal (front view), and axial (top view) plane skeletal motions demonstrated in the collected x-ray videos.

 Motion tracking data will then be used to accurately animate the 3D bone models to demonstrate the active range of ankle-foot joint motions during voluntary movement and gait.
...
.
 ...
 3D X-ray Motion Analysis of Ankle-foot Motion After Total Ankle Arthroplasty@highlight
