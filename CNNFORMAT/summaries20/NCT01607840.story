(fifthQuint)Effects of Transcranial Direct Current Stimulation in Individuals With Schizophrenia.
...
, saying words out loud, naming objects, drawing designs, remembering lists of words, searching for images or letters, and/or completing puzzles) based upon a number of cognitive functions such as language, memory, vision, processing, and perception.
 ...
 These electrodes will administer very weak electrical current (tDCS) from a 9 volt battery for 20 to 60 minutes.
...
.
 ...
 Effects of Transcranial Direct Current Stimulation in Individuals With Schizophrenia@highlight

This research is being done to determine whether transcranial direct current stimulation (tDCS) can improve certain mental abilities and alter functional connectivity in individuals with Schizophrenia.

 In this research, a 9 volt battery is used to deliver very weak electrical current to the surface of the scalp while participants complete cognitive tasks.

 Participants also receive a brain scan before and after stimulation.

 Our aim is to determine if tDCS can improve mental abilities in individuals with schizophrenia.
