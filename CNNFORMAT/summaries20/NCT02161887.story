(fifthQuint)The Healing Context in Complementary and Alternative Medicine (CAM): Initial Validation Study.
 ...
 cent Hypothesis 3a: Scores on the HEAL measures will display moderate to large correlations (r's > .

50) with similar self-report measures, supporting convergent validity.

 cent Hypothesis 3b: Scores on the HEAL measures will correlate modestly (r's = .
...
35) with self-report measures of general psychosocial functioning, supporting discriminant validity.
 ...
 In addition, the investigators predict that HEAL scores will demonstrate incremental validity, i.

e.

, the scores will account for significant incremental variance in outcome beyond that accounted for by existing measures of treatment expectancy and related constructs.

.

 The Healing Context in Complementary and Alternative Medicine (CAM): Initial Validation Study@highlight
...
gov pertains only to the final, Validation Phase of the study.
