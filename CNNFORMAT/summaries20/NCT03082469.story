(fifthQuint)Pancreatitis CytoSorbents (CytoSorb) Inflammatory Cytokine Removal.

 Severe acute pancreatitis (SAP) has a mortality of up to 42%.

 The outcome of SAP is related to the development of SIRS and consecutive organ failures.

 Due to the lack of a causative therapy except the removal of bile duct stones, therapy is predominantly symptomatic.
 ...
 This prospective case control study investigates the impact of early extracorporeal cytokine adsorption with the CytoSorb(R) device on haemodynamics (primary endpoint) and several secondary outcomes.

 Patients with high probability of SAP (APACHE-II-score 10) are eligible for 7 days after the onset of pain.

 The patients will be treated for 48h with two consecutive 24h sessions of cytokine absorption with the CytoSorb(R)-device.
...
.
 ...
 Pancreatitis CytoSorbents (CytoSorb) Inflammatory Cytokine Removal@highlight
