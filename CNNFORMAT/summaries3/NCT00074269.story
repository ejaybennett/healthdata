(fifthQuint)Allogeneic Stem Cell Transplant After ATG, High-Dose Melphalan, and Fludarabine for Patients With Metastatic Breast Cancer.
 ...
 - Graft-versus-host disease (GVHD) prophylaxis: Patients receive cyclosporine IV (and then orally when tolerated) every 12 hours beginning on day -4 and tapered after day 42 (if no GVHD occurs) or after day 90 (if grade I acute GVHD occurs).
 ...
 Patients also receive filgrastim (G-CSF) IV or subcutaneously beginning on day 0 and continuing until blood counts recover.

 - Donor lymphocyte infusion (DLI): Patients who show disease progression or fail to achieve full donor type T-cell chimerism (at least 90% donor derived T-cells) by the 90-day assessment posttransplantation, and have no evidence of active GVHD may receive DLI.

 Patients who have unresponsive disease with no active GVHD receive subsequent DLIs every 6-8 weeks.
...
.
 ...
 Allogeneic Stem Cell Transplant After ATG, High-Dose Melphalan, and Fludarabine for Patients With Metastatic Breast Cancer@highlight

RATIONALE: Giving chemotherapy, such as fludarabine and melphalan, before a donor peripheral blood stem cell transplant helps stop the growth of tumor cells.

 It also stops the patient's immune system from rejecting the donor's stem cells.

 The donated stem cells may replace the patient's immune system and help destroy any remaining tumor cells (graft-versus-tumor effect).
