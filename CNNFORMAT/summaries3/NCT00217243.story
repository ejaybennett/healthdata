(firstQuint)Evoked Fields After Median and Ulnar Stimulation.
 ...
 Finally the study not only intends to support clinical diagnosis but also to provide tools to monitor treatment and support the choice (algorithm) between SCS and SAN.

 An algorithm, facilitating decision making between these two treatments, will be promoted.

 It should also provide a clinical decision tool for the use of SAN.

 Evoked Fields After Median and Ulnar Stimulation@highlight
