(secondQuint)Lenalidomide, Fludarabine & Cyclophosphamide in Advanced Chronic Lymphocytic Leukemia Not Responding to Therapy.

 OBJECTIVES: Primary - To define the maximum tolerated dose (MTD) of Lenalidomide given in combination with FC.

(Phase I) - To evaluate the complete remission (CR) rate of FC given in combination with the MTD of Lenalidomide (FCL).

 (Phase II) Secondary - To define the toxicity and the infection rate of patients treated with FCL and the median number of delivered courses of FCL, overall response rate and the progression-free survival and the relationship between the response and the baseline biologic factors (IgVH, FISH, ZAP-70, CD38).
...
.
 ...
 Lenalidomide, Fludarabine & Cyclophosphamide in Advanced Chronic Lymphocytic Leukemia Not Responding to Therapy@highlight
