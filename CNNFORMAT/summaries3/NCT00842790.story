(fifthQuint)Impact of Predicting Anti-angiogenic Response in mRCC Using Functional Imaging.
 ...
 Patient and methods - Patients 200 patients with metastatic RCC will be enrolled in the study.

 Patients will be recruited by an oncologist and the images will be acquired by a radiologist.
 ...
 - Imaging data acquisition Morphological and functional imaging will be obtained before the beginning of the anti-angiogenic treatment, at 72 days and every 6 weeks until tumor progression.
 ...
 - Imaging data analysis The examinations will be anonymized and transferred to a workstation for processing.

 Images will be processed by two independent readers.

 Diffusion coefficient maps will be obtained using linear regression.

 The microvascular parametric maps yielding as tissue blood flow, tissue blood volume, mean transit time, permeability surface area product and tissue interstitial volume will be calculated for both the CT and MRI dynamic series using a proprietary software by means of compartmental modeling with an arterial input function (AIF).
 ...
 -Statistical analysis The functional parameters will be analyzed for inter-observer reproducibility.

 The correlation between parameters obtained using functional CT and functional MRI will tested.
 ...
 The correlation between each parameter's changes under treatment as compared to the baseline value will be tested to evaluate the efficacy of each parameter to detect the response to the anti-angiogenic drug.

 The precocity of the detection of the response using the parameter variations will be also tested.
...
.
 ...
 Impact of Predicting Anti-angiogenic Response in mRCC Using Functional Imaging@highlight
...
The goal is to study the impact of functional MRI and CT evaluation of changes in tumor vessels induced by anti-angiogenic treatment in patients with metastatic RCC.
 ...
 Functional CT and MRI will be performed in 200 patients before the beginning of antiangiogenic treatment, 7 days after and every 6 week until tumor progression (as defined by the RECIST criteria).

 Perfusion and diffusion parameters will be measured using a dedicated software.
