(fifthQuint)Acute MRI in Transient Ischemic Attack.
 ...
 Diffusion weighted Imaging (DWI) is today one of the best ways to detect ischemic lesions after TIA.

 The problem is that this only gives the diagnosis in 30% of the cases.
 ...
 Patients admitted with clinical signs of TIA can be included.

 Patients will be examined with the TIA protocol in reference to the standardized clinical care: 1.
 ...
 (Total scantime 10min) If no signs of ischemic lesions is detected the following additional research scan-protocol will be initiated: 1.
 ...
 (Total additional scantime 10min) All in All 20min in the scanner.

.

 Acute MRI in Transient Ischemic Attack@highlight
