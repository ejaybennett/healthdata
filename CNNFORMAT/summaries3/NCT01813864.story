(fifthQuint)Linking Services to Patient Needs for Improved Patient Outcomes (CASPAR).
 ...
 They are all located within Bucks and Montgomery Counties in Pennsylvania and within a 70 mile radius of Atlantic City, New Jersey.
 ...
 Directors will also be provided with a detailed Director Information Sheet outlining aspects of the Quality Improvement Initiative outlined in the LoA.

 TRI staff will provide counselors and supervisors with the treatment planning training as well as the CASPAR Resource Guide software and training on its use.

 These activities will be initiated as an organization-wide Quality Improvement Initiative, and as such, will be implemented with all counselors at each program.

 No data will be collected from the counselors, nor will we discuss or report on client outcomes grouped by counselor.

 This will be a 2-Phase project.

 TRI staff will recruit up to 6 eligible clients per counselor prior to providing the CASPAR training and up to 6 additional clients after providing training.

 Based on current data from the sites, we expect a minimum of 36 counselors to be involved in the Quality Improvement Initiative.
 ...
 We will continue to evaluate the effectiveness of this enhanced protocol by addressing the same aims and using primarily the same client instruments previously approved by this Institutional Review Board (IRB, some have been modified, see full discussion below).

 We will compare client outcomes before (Phase I) and after the individualized treatment planning and problem-service matching components are introduced (Phase II).

 As before, we expect to see pre-post differences in problem-treatment plan matching, treatment plan-service matching, and in the number and appropriateness of services clients receive; we also expect to see pre-post differences in client outcome such as treatment attendance, treatment retention, breathalyzer, and urinalysis results, the same measures and outcomes in the original design.

.

 Linking Services to Patient Needs for Improved Patient Outcomes (CASPAR)@highlight

The proposed Quality Improvement Initiative study is a health services research project in community-based substance abuse treatment programs.

 The primary goals are to use training and technology transfer to match services to client needs, increase the number of services received by clients, and improve client outcomes.

 This is a two phase study in which we compare clients pre-intervention to clients post-intervention.
