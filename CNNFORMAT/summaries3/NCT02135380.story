(fifthQuint)Evaluate Safety and Efficacy of Intravenous Autologous ADMSc for Treatment of Idiopathic Pulmonary Fibrosis.
...
.
 ...
 Evaluate Safety and Efficacy of Intravenous Autologous ADMSc for Treatment of Idiopathic Pulmonary Fibrosis@highlight

Despite intense research efforts and clinical trials, there is still no effective treatment that can prolong the survival of patients with IPF.

 Conventional therapeutic approach includes combination of corticosteroids, anti-oxidants, immunodepressants and immune modulatory anti-fibrotic agents to be discontinued 20 days before screening.

 The only, so far, therapeutic approach that has been proven effective in terms of prolonging patient's survival is lung transplantation.

 Nonetheless, not all the patients with IPF are eligible for lung transplantation; there is a significant proportion of these patients that finally succumb while waiting in a lung transplantation list.

 Therefore, there is critical need for more effective and reliable therapeutic modalities5.

 Adult Stem Cells (ASCs) seem to represent one of these.

 Therefore, it is conceivable to assume that adult-stem cells can be easily and safely be applied as a novel therapeutic agent in chronic and fatal lung diseases, including chronic obstructive pulmonary disease (COPD) and IPF.

 Therefore, there is an urgent need to provide a safe, effective and affordable treatment option for IPF patients.

 New diagnostic, prognostic and therapeutic strategies need to be developed to reduce the burden of IPF.

 Given the present lack of appropriate treatment adjunctive in the therapy of IPF, adipose derived stromal vascular fraction provides new opportunities for development of the same.

 MSCs are having anti-fibrotic activity and hence may be excellent source to tackle pulmonary fibrosis and hence could be explored for their therapeutic potential for treating Idiopathic pulmonary fibrosis.

 MSC's also display membrane-bound and insoluble secreted molecules involved with cell attachment to neighbouring cells and to the extra cellular matrix.

18 This cell surface configuration may enable mesenchymal stem cells to home from bloodstream to mesenchymal tissue.

14 As limited clinical information is available about use of SVF and MSC in the IPF patients hence this Open Label, Prospective, Randomized multi center comparative study has been undertaken to explore the tolerability & effectiveness of SVF in one treatment arm and MSC in second treatment arm in IPF patients.
