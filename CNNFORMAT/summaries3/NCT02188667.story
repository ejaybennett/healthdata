(secondQuint)Integrating Patient Reported Outcomes (I-PRO) Study for Multidisciplinary Pain Care.

 The initiative has three components to aid clinicians' care of patients with chronic noncancer pain: (1) education, (2) standardized patient reported outcomes data collection, and (3) evidence-based brief treatment reminders.

 Practices will be randomized to either receive the three novel components (treatment group) or continue with usual care (control group).
 ...
 Primary study outcomes include comparison of treatment and control group provider and patient satisfaction surveys.

 Secondary outcome measures include provider referral rates, patient outcomes, patient treatments recommended/ordered, and patient service utilization/costs.

.

 Integrating Patient Reported Outcomes (I-PRO) Study for Multidisciplinary Pain Care@highlight
