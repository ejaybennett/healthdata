(fifthQuint)Intralymphatic Immunotherapy for House Dust Mite, Dog, and Cat Allergy Using Tyrosine S in Allergic Rhinitis.

 After informed consent, subjects will be randomly assigned to ILIT group or placebo group in double-blind manner.

 In both group, causal allergen or placebo will be injected into inguinal lymph node through guidance by ultrasonography three times with 4-week interval.

 In ILIT group, initial dose of allergen will be 1,000-fold diluted solution from maximal concentration of allergen extract for subcutaneous immunotherapy (Tyrosine S, Allergy Therapeutic, West Sussex, UK) in volume of 0.

1ml.

 If skin is highly reactive in skin prick test, the initial dose will be 10-fold dilution from maximal concentration where diameter of wheal is less than that of histamine.
 ...
 The investigators will evaluate allergic rhinitis symptom score before and 4, 12 months after the initial treatment.

 Rhinoconjunctivitis Quality of Life Questionnaire (RQLQ) and Sino-Nasal Outcome Test (SNOT-20) will be used.
 ...
 Skin prick test (SPT), intradermal test (IDT), blood sampling for serum total immunoglobulin E (IgE), allergen-specific IgE, and allergen-specific immunoglobulin G4 (IgG4), nasal lavage for Th1, Th2, and Treg cytokines, and nasal provocation test (NPT) with Df and/or Dp allergen (in subjects whose AR symptoms are provoked by Df and/or Dp) will be also performed before and 4, 12 months after the initial treatment.

 In addition, the investigators evaluated the change of subjects' recognition of causal allergens, their avoidance, and AIT during this study.
...
.
 ...
 Intralymphatic Immunotherapy for House Dust Mite, Dog, and Cat Allergy Using Tyrosine S in Allergic Rhinitis@highlight
