(firstQuint)BIP CVC Clinical Safety and Performance Study.

 The primary objective of this study is to determine the safety for the medical device of 'BIP central venous catheter".

 Safety is assessed by evaluation of adverse events (according to ISO 14155:2011).

 Examples of CVC related common events are phlebitis, infection at the infection site, catheter related bacteremia/fungemia, septicemia, sepsis, thrombosis, lung emboli and pneumothorax.
 ...
 All statistical analyses is performed using the SAS(R) System, version 9.

3 or higher (SAS Institute Inc.

, Cary, NC, USA).

 Data is to be summarized using descriptive statistics.

.

 BIP CVC Clinical Safety and Performance Study@highlight
