(fifthQuint)CT-Perfusion for Neurological Diagnostic Evaluation.
 ...
 Comatose patients at high risk of neurological death exempt of confounding factors (e.

g.

 hypothermic patients, use of long-acting sedatives, etc.
 ...
 Safety endpoints will be CT-perfusion -related adverse events (i.
...
.
 ...
 CT-Perfusion for Neurological Diagnostic Evaluation@highlight

For the purpose of organ donation after neurological determination of death (NDD), death must be declared using a set of standardized clinical criteria.

 When a full clinical evaluation cannot be completed, additional neuroimaging ancillary testing is required.

 The ideal ancillary test for NDD would demonstrate no cerebral blood flow, be free of false-positive and false negative results, rapid, safe, readily available, non-invasive, and inexpensive.

 No current ancillary test for NDD meets these criteria.

 Computed tomography (CT) perfusion has the characteristics of an ideal test for NDD, but has not been evaluated for routine clinical use for NDD.

 The overarching goal of this project is to improve the NDD process by establishing CT-perfusion as the ideal ancillary test.

 A large prospective Canadian multi-centre diagnostic cohort study will be conducted to validate CT-perfusion for the neurological determination of death.

 Specific objectives are: Primary objective: To determine diagnostic accuracy of CT-perfusion compared to complete clinical evaluation for NDD.
