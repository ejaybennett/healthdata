(secondQuint)Predictors of Persistence in Patients With Schizophrenia Treated With Once-monthly Aripiprazole in Spain.
 ...
 Data from each patient will be collected after informed consent is obtained (if possible), and will include retrospective information mainly from the index date (start of AOM treatment, baseline timepoint) until the last information available in the patient file at the time of data collection (minimum of 6 months after the index date).

 Data will be retrospectively collected from all visits occurring as per clinical practice (usually once-monthly).

.

 Predictors of Persistence in Patients With Schizophrenia Treated With Once-monthly Aripiprazole in Spain@highlight
