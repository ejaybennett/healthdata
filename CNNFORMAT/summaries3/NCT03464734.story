(secondQuint)Pembrolizumab and Nab Paclitaxel in Patients With Metastatic Urothelial Carcinoma.

 Pembrolizumab is a new standard of care in chemotherapy (CT) pre-treated urothelial cancer (UC) patients and nab-paclitaxel has shown one of the highest activities among chemotherapy options in UC.

 Their combination may overcome resistance to immunotherapy (IT) and result in longer delay in the time to disease progression (PD).

 We will explore dynamic biomarkers of response to CT+IT.
 ...
 Response is evaluated by RECIST criteria v.
...
1 every 2 cycles.
 ...
 The target is to detect an improvement in the median PFS from 3.
...
0 months (H1).
 ...
 The trial is registered with EudraCT, number 2017-000579-10.

.

 Pembrolizumab and Nab Paclitaxel in Patients With Metastatic Urothelial Carcinoma@highlight
