(firstQuint)Healthy Together Program Evaluation (Phase 3).

 The purpose of the Phase 3 scale up project is to expand the reach and impact of Healthy Together (HT), by supporting the integration of the HT program into core services of organizations serving children (up to 18 years) and families, particularly those from under-served populations across diverse communities and settings in Canada.

 The HT program offers a flexible, effective, integrated approach, relevant to multiple contexts, creating potential to become a sustainable approach to promoting healthier weights in Canadian children.

 The objectives of the evaluation for Phase 3 are to: 1.
...
.
 ...
 Healthy Together Program Evaluation (Phase 3)@highlight
