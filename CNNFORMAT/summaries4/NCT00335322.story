(thirdQuint)ALTAIR - Alternative Antiretroviral Strategies : a Comparison of Three Initial Regimens.
 ...
 (Primary comparisons are regimen I versus II and I versus III as described below).

 I.

 tenofovir (TDF) + emtricitabine (FTC) + efavirenz (EFV) II.

 tenofovir (TDF) + emtricitabine (FTC) + ritonavir/atazanavir (r/ATV) III.

 tenofovir (TDF) + emtricitabine (FTC) + zidovudine (ZDV) + abacavir (ABC) Secondary objectives of this study will be to undertake a range of analyses including but not limited to the following, 1.

 Percentage of patients 50 copies/mL (and 400 copies/mL) after confirmed < 50 copies/mL (where time = 0 if patient never achieves plasma virus load < 50 or <400 copies/mL).
