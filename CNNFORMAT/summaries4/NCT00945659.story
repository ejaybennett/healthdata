(fifthQuint)Use of Continuous Glucose Sensors by Adolescents With Inadequate Diabetic Control.
 ...
 We hypothesize that a targeted, family-focused behavioral intervention could optimize benefit from adding CGS to T1DM therapy for youths with glycosylated hemoglobin (HbA1c) > 7.

5%.

 A multi-site sample of 150 adolescents with T1DM and HbA1C of 7.

5% to 10.

0% will be randomized to either Standard Care for T1DM (SC), or to augmentation of SC with 9 months' use of a CGS device (CGS) or use of a CGS device supplemented with a targeted behavior therapy intervention (CGS+BT).
 ...
 Three specific aims will be addressed: 1.

 Evaluate whether CGS+BT yields more improvement in glycemic outcomes than CGS or SC; 2.

 Evaluate whether CGS+BT yields more improvement in behavioral outcomes than CGS or SC; and 3.

 Identify behavioral variables that mediate and moderate glycemic benefit from use of the CGS device.
...
.
 ...
 Use of Continuous Glucose Sensors by Adolescents With Inadequate Diabetic Control@highlight
