(thirdQuint)Behaviorally Enhanced Counseling on Nicotine Dependence (BEACON) Trial.
...
.
 ...
 Aim 2: Conduct a mixed-methods feasibility trial randomizing treatment-seeking smokers to pharmacogenetic (PGx) treatment combined with genetic feedback (GF) vs.

 PGx treatment without GF for smoking cessation to examine the feasibility of the newly developed protocol in a primary care setting and characterize its psychological and behavioral impact: Smokers (N = 100) will be randomized to GF vs.

 no GF and all will receive motivational interviewing (standard care/SC) and PGx treatment.

 We will assess the impact of GF on time to relapse, medication adherence, and a comprehensive assessment battery of process and cognitive, psychological, and behavioral outcomes.

 Finally, we will synthesize quantitative and qualitative data to revise protocols, generate hypothesizes, and estimate effect sizes for a follow-up R01 submission.
