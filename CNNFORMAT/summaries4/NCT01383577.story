(fifthQuint)Comparison Between Single and Triple Rubber Band Ligation for the Treatment of Hemorrhoids.
 ...
 Patients enrolled in the study, after applying inclusion and exclusion criteria, signed the consent form, and responded to a questionaire about epidemiological data and hemorrhoidal symptoms, are (and will be) randomly allocated to one of the two arms of the study: G1: a single major hemorrhoidal group is ligated in each of three sessions of hemorrhoidal ligation, while the two other hemorrhoidal groups are submitted to sham ligation (a McGown aspirating type of hemorrhoidal ligator is employed); G2: all three major hemorrhoidal groups are ligated in the first session of treatment and in the next two sessions only sham ligations are performed.

 Three sessions of hemorrhoidal and/or sham ligation are performed in all patients, each spaced by one month from the other.

 A final consultation is held 1 month after the third ligation session in order to gather all the results of the treatment.

 After each session of hemorrhoidal ligation patients receive a chart containing a modified level of pain scale (Wong & Baker) and are asked to indicate pain level (from 0 to 5: 0 = no pain, 5 = unbearable pain) at fixed intervals (immediate post-ligation, 12 h post-ligation, 24 h post-ligation and each other day until 7 days post-ligation).

 Investigators gather this information about pain, and patient well-being post-ligations, from 8 programmed telephone calls to the patients after each session of hemorrhoidal (or sham) ligation.
...
.
 ...
 Comparison Between Single and Triple Rubber Band Ligation for the Treatment of Hemorrhoids@highlight

Rubber band ligation is a widely adopted treatment of internal hemorrhoids in busy coloproctology institutions.

 All three major hemorrhoidal clusters (left lateral, right anterior and right posterior) use to be ligated in order to obtain therapeutic success.

 It is commonly performed either through the ligation of a single hemorrhoid per session spaced by some few weeks to the second and third sessions, or of all three major hemorrhoids in one single session.

 Advocates of either method of hemorrhoidal ligation have arguments to defend their choice in terms of advantages, supported mainly on personal preferences.
