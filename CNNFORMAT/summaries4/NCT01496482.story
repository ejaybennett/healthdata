(fifthQuint)Comparison of Evaporimetry With the Established Methods of Tear Film Measurement.
 ...
 Methods: Subjects were divided in two groups: 45 in group without dry eye related symptoms, and 45 in group with symptoms.

 Examination was performed in the following sequence: 1.

 structured case history (questionnaire), 2.

 evaporimetry 3.

 slit lamp examination with fluorescein staining, 4.
 ...
 First measurement was performed by measuring for 5 minutes with eyes closed.

 Second measurement also lasted 5 minutes, with eyes kept open, normal blinking, and with subject fixating at one point in distance, with no eye movements.

 Measured parameters included: basal (%): relative environment humidity before measurement basal T: environment temperature before measurement closed eye (%): relative humidity in front of closed eye open eye (%): relative humidity in front of open eye C/O: ratio of (%) closed/open eye.

 Comparison of Evaporimetry With the Established Methods of Tear Film Measurement@highlight
...
Purpose: To establish whether there is a correlation between dry eye symptoms, age and gender, a difference in symptom intensity in different times of the day, which test (Schirmer or TBUT) better correlates with dry eye symptoms, whether it is possible to reliably use cheap, easy to use hygrometer in everyday clinical setting, and finally whether there is statistically significant correlation between applied tests (TBUT, Schirmer and evaporimetry).
 ...
 Methods: Subjects: 45 in group without dry eye related symptoms, and 45 in group with symptoms.
