(fifthQuint)Corticosteroids + Bevacizumab vs.

 Corticosteroids + Placebo (BEST) for Radionecrosis After Radiosurgery for Brain Metastases.

 This is a randomized double-blinded phase II study of corticosteroids with bevacizumab vs.

 corticosteroids with placebo for brain radionecrosis following radiosurgery for brain metastases.

 This is a two-arm clinical trial with parallel group design for longitudinal quality of life endpoint.

 Patients will be stratified according to age ( 65 years vs.

 > 65 years), pathological confirmation of necrosis (yes vs.

 no), MDASI-BT mean global score (symptom + interference scores) ( 4.

0) and prior whole brain radiotherapy (yes vs.
 ...
 Patient event monitoring will occur every 2 months after treatment up to 6 months.

 Then event monitoring will occur up to one year.

.

 Corticosteroids + Bevacizumab vs.

 Corticosteroids + Placebo (BEST) for Radionecrosis After Radiosurgery for Brain Metastases@highlight
