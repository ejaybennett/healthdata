(fifthQuint)WittyFit - Live Your Work Differently.

 1.

 Whereas other interventional software focus on a specific aim (relaxation, musculo-skeletal disorder, etc), Wittyfit has the ambition to promote health with a global understanding of workers, based on continuous and updated scientific knowledge (evidence based medicine).

 A feedback is given on targets screened from questionnaires through e-learning and personalized motivating messages.

 2.

 The second novelty of WittyFit is that managers will also have an anonymous feedback on the general state of health and problems encountered by its employees, in general or by department if the sample size is sufficiently high.

 Managers will indeed be able to target specific actions such as promoting physical activity at work or helping its employees to quit smoking.
 ...
 Moreover, WittyFit is in fact based on two databases: "WittyFit" which deals with behavioral data, and "WittyFit Research" which deals with medical data.

 To guarantee the highest level of security, the two databases are separate and do not communicate together; physicians from the CHU of Clermont-Ferrand will be the only individuals with an access to medical data.
 ...
 Therefore, WittyFit will have the ability to have mortality as a primary outcome.
...
.
 ...
 WittyFit - Live Your Work Differently@highlight
