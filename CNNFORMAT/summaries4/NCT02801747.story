(fifthQuint)Using MOST to Optimize an HIV Care Continuum Intervention for Vulnerable Populations.

 More than half of persons living with HIV/AIDS (PLHA) in the U.

S.

 are insufficiently engaged in HIV primary care and not taking antiretroviral therapy (ART), mainly African Americans and Latinos.
 ...
 A similar set of multi-level factors impede both HIV care and ART initiation for African American and Latino PLHA, primary among them individual (e.

g.

, substance use, distrust, fear), social (e.

g.

, stigma), and structural-level barriers (e.

g.

, difficulties accessing ancillary services).

 Guided by a multi-level social cognitive theory, the study will evaluate 5 distinct intervention components (i.

e.

, Motivational Interviewing sessions, pre-adherence preparation, support groups, peer mentorship, and patient navigation), each designed to address a specific barrier to HIV care and ART initiation.
...
.
 ...
 Using MOST to Optimize an HIV Care Continuum Intervention for Vulnerable Populations@highlight

The present study targets the large population of persons living with HIV/AIDS (PLHA) in the U.

S.

 who are both insufficiently engaged in HIV primary care and not taking antiretroviral therapy (ART), who are mainly African American/Black and Latino.
