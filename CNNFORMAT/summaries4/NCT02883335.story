(secondQuint)Lorraine Registry of Multiple Sclerosis.

 As every patient registry in France, the RelSEP is periodically (every four years) evaluated by an independent committee.

 The RelSEP interrogate multiple sources to insure its exhaustiveness : - every neurologists of Lorraine - MS patient network in Lorraine - health insurance data - PMSI (administrative French national database for hospitals) - biological and imagery services in Lorraine Procedures (automatic and manual) are used to eliminate duplicates Once a patient has been identified its medical file are checked by investigators in order to retrieve the relevant information.

 New MS cases are confirmed by neurologists.

 Automatics (implemented in EDMUS software)and manual checks are implemented in the registry database, looking for inconsistencies.
...
.
 ...
 Lorraine Registry of Multiple Sclerosis@highlight
