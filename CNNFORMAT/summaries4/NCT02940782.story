(firstQuint)Comparison Between Reciproc and Oneshape Systems.
 ...
 Sequence of Procedural Steps: 1.
 ...
 Determination of the working length using an electronic apex locator, and confirmed by a radiograph using K-file.

 Then, the working length will be established at 0.

5 mm up to the radiographic apex.
 ...
 Mechanical preparation for both groups will be as follows: - Experimental group: - Canals will be instrumented using Reciproc reciprocating system set on an electric motor, with adjusted torque and speed according to the manufacturer's instructions.
 ...
 - Reciproc file selection: R40 (40/0.

06) - Control group: - Coronal preflaring will be performed using Gates Glidden drill.

 - Canals will be instrumented using One Shape single-file (25/0.

06) set on an electric motor with adjusted torque and speed according to the manufacturer's instructions.

 - For wide canals, One Shape Apical (30/0.
...
06) will be used.
 ...
 Canals will be irrigated with 2.

6% sodium hypochlorite solution between every subsequent instrument.

 It is prepared by adding 10 ml of sterile distilled water to 10 ml of 5.

25% sodium hypochlorite solution using a 27 gauge needle fit to 5ml disposable plastic syringe placed in the canal space without binding.

 10.

 Canals will be dried with sterile paper points and obturated using lateral condensation technique.

 A spreader will be used to allow space for auxiliary cones, with resin-based root canal sealer.
...
.
 ...
 Comparison Between Reciproc and Oneshape Systems@highlight
