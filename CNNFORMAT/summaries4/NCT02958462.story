(firstQuint)Pre-myeloid Cancer and Bone Marrow Failure Clinic Study.

 The pre-myeloid cancer and bone marrow failure clinic is an individualized medicine clinic conceptualized for the early detection of myeloid malignancies such as, myelodysplastic syndromes (MDS), myeloproliferative neoplasms (MPN), MDS/MPN overlap syndromes and acute myeloid leukemia (AML).

 Using next-generation sequencing technologies, clonal hematopoietic stem cell changes can be detected early on in myeloid malignancies.

 These changes are currently classified as follows: 1.
...
.
 ...
 Pre-myeloid Cancer and Bone Marrow Failure Clinic Study@highlight
