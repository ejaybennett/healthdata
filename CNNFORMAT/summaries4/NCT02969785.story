(fifthQuint)Postural Control and Trunk Neuromuscular Activation in Athletes With Chronic Low Back Pain.
 ...
 For the analysis two-way ANOVA with repeated measures will be performed to compare the effects of the intervention (two groups) and times (baseline vs.

 end 8-weeks measurement) and the effects of interaction (Groups x Times).

 The size effect also will be computed to determine the rate of the changes observed.

.

 Postural Control and Trunk Neuromuscular Activation in Athletes With Chronic Low Back Pain@highlight

The relevance of this study is given by the feasibility to assess the effect of an intervention program based on the postural control and trunk neuromuscular activity, comparing two methods: stabilization exercises vs.

 back strengthening exercises, in athletes with low back pain.
