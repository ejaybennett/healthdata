(firstQuint)Traditional Bed Baths Versus Disposable Wet Wipes.

 The study is a crossover clinical trial where the effect of two interventions is compared on the same subject.

 The two interventions are: - Intimate hygiene with water and soap - Intimate hygiene with prepackaged disposable wet wipes Null hypothesis: Same effectiveness to reduce microbiological counts on skin Alternative hypothesis: Significant different effectiveness to reduce microbiological counts on skin Each individual receives the two interventions in random order.

 The effect of the interventions on microbiological counts on the patients skin is evaluated on the same patient.

 A crossover trial requires half the number of participants and reduces confounding factors.

 All participants receive a sequence of the two different interventions.

 But there is a sufficient gab between the two interventions to ensure a washout period and avoid a crossover effect.

 In this study this is 12-24 hours.
 ...
 Analyses: Data are structured in CASTOR and will be stored in a secure Team Collaboration Software Tool (SharePoint).
 ...
 Test of differences will be performed by simple t- test or Wilcoxon sign rank test, depending on the distribution of the data.

 A multiple regression analysis including possible confounders will be considered.

 Inclusion of 68 patients.

 Traditional Bed Baths Versus Disposable Wet Wipes@highlight
