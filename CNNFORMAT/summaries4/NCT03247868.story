(thirdQuint)A Multimodal Approach to Cervical Dystonia Treatment With Association of Botulinum Toxin and Motor Learning Techniques.
 ...
 The SPRInt approach aims are to improve body perception, posture and movement quality and to restore body axis by using specific sensory feedbacks, both intrinsic (IFB) and extrinsic (EFB), and motor exercises (ME) with specific rhythmic temporal structure.

The ME can be focused on different body parts (eyes, head, neck, trunk, arm) and involve different spatial planes (frontal, sagittal, horizontal, multiplanar).

 The exercises can be performed with eyes closed and with an external passive motor leading in order to improve proprioception and facilitate sensory integration by excluding visual or verbal information that can be misleading for the patient.

 The ability to perceive and integrate intrinsic feedback is the fundamental element to create mental image that define body scheme and motor behaviour.
 ...
 At each time point these test are performed: - CLINICAL SCALES i.
