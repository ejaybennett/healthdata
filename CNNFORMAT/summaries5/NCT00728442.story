(secondQuint)Impact of OncoDoc2 on Guideline Compliance in the Management of Breast Cancer.
 ...
 OncoDoc2 is a CDSS providing patient-specific recommendations based on CPGs for non-metastatic female breast cancer management elaborated by the CancerEst INTERMEDICAL collaboration.

The main goal of the study is to evaluate the effect of the routine use of OncoDoc2 during MSMs on compliance of MSM decisions with local CPGs.
 ...
 Under the assumption of a baseline compliance rate of 70% without intervention, an expected compliance rate of 90% in the intervention group ( = 5%, = 20%), an inter-cluster variability of 5%, and 59 decisions per center, the required number of centers is 3 in each group, or 177 decisions in each arm.

 The study will be conducted in cancer care centers (public and private) from Paris area, France.

This prospective trial will be conducted in two steps.
...
.
 ...
 Impact of OncoDoc2 on Guideline Compliance in the Management of Breast Cancer@highlight
