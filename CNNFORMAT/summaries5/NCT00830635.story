(thirdQuint)Multimedia Educational Program for Patients With Early-Stage Prostate Cancer or Breast Cancer.
 ...
 - Examine potential moderator variables to assess potential differences in intervention efficacy by selected subgroups (e.

g.

, age, education) within each component project.
...
, perceived need for and benefit from the CISRC interventions and intervention efficacy across three high priority cancer patient populations) that will be made possible by the use of a common theoretical framework, the same or similar intervention and research design across projects, and a common set of endpoints.
 ...
 Patients are randomized to 1 of 3 intervention groups: - Group 1: Patients receive a mailing containing standard CIS print materials.

 In project 1, patients receive " Treatment Choices for Men with Early-Stage Prostate Cancer" and "What You Need to Know About Prostate Cancer".

 In project 2, patients receive "What You Need to Know About Breast Cancer" and "Surgery Choices for Women with Early-Stage Breast Cancer".

 In project 3, patients receive "Facing Forward: Life After Cancer Treatment" and "What You Need to Know About Breast Cancer".

 - Group 2: Patients receive mailings appropriate to their project as in group 1.

 Patients also receive the multimedia program via the Internet or CD-ROM.

 - Group 3: In project 3 only, patients receive mailings appropriate to their project as in group 1 and the multimedia program as in group 2.

 Patients also receive a CIS callback intervention at 10-14 days from trained Information Specialists from the CIS.

 After completion of study therapy, patients are followed at 2 and 9 months.

.

 Multimedia Educational Program for Patients With Early-Stage Prostate Cancer or Breast Cancer@highlight
