(secondQuint)Effectiveness Repetitive Transcranial Magnetic Stimulation (rTMS) in Patients With Chronic Tinnitus.
 ...
 Pilot data indicate that the beneficial effect of low-frequency rTMS can be enhanced by high frequency rTMS of the left dorsolateral prefrontal cortex (DLPFC).

 In the proposed study we investigate whether high frequency rTMS of the DLPFC improves therapeutic efficacy of low-frequency rTMS on tinnitus in a controlled trial.

.

 Effectiveness Repetitive Transcranial Magnetic Stimulation (rTMS) in Patients With Chronic Tinnitus@highlight
