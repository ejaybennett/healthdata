(secondQuint)Efficacy/Safety Study of Bevacizumab,Capecitabine,Oxaliplatin to Metastatic Colorectal Adenocarcinoma Elderly Patients.

.

 The efficacy will be determined by objective response rate following RECIST criteria.

 In several clinical trials with Bevacizumab, there has been demonstrated that elderly patients benefits as well as the younger of a combination therapy with chemotherapy plus Bevacizumab, but these results have come from subgroup analyses of trials not specifically design to test the effect of these combinations on the elderly.

 This clinical trial is specific only for elderly patients and we expect to confirm the benefits demonstrated in other clinical trials where the elderly patients were a number reduced.

 This clinical trial includes 3 substudies: - Assessment of tumor response of CRC liver metastases to treatment with Avastin in combination with Capecitabine and Oxaliplatin as first line treatment by dynamic ultrasound contrast.
