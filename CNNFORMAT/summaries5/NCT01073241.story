(thirdQuint)Transurethral Ventral Wall of Urethra-preserving Enucleation of Prostate.
 ...
 In this study, we design a randomized and double-blind prospective trial to evaluate the efficiency and safety of our new approach-transurethral ventral wall of urethra-preserving enucleation of prostate in comparison with TURP for the hyperplasia weighing more than 45 g.

Urodynamic examination [maximum flow rate (QMax), detrusor pressure, and so on], transrectal color Doppler ultrasonography for the prostate, blood routine, blood electrolyte, prostate specific antigen (PSA), International Prostate Symptom Score (IPSS), the quality of life (Qol), blood loss during operation, and the weight of resected prostate were studied before and after the operation.

.

 Transurethral Ventral Wall of Urethra-preserving Enucleation of Prostate@highlight
