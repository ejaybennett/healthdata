(secondQuint)Prenatal Cytogenetic Diagnosis by Array-Based Copy Number Analysis.

 Specifically, the aims are as follows: 1.

 Demonstrate the performance of microarray analysis as a clinical method for prenatal cytogenetic diagnosis with regard to: 1.

 Accuracy in the detection of the common autosomal and sex chromosomal aneuploid (trisomies, 13,18,21, 45,X, 47,XXY, etc.

) 2.

 Ability of microarray to diagnose less common, but clinically significant, cytogenetic aneusomies (e.

g.

 DiGeorge, Williams, Smith- Magenis, Prader-Willi syndrome, etc.

) currently not detected by conventional karyotype.
 ...
 Develop a prenatal diagnostic tissue repository (TDR) to facilitate the further development of microarray technology.

 This will be used to investigate the molecular etiologies of specific fetal anomalies and to test newer technologies, such as higher resolution microarrays.

.

 Prenatal Cytogenetic Diagnosis by Array-Based Copy Number Analysis@highlight
