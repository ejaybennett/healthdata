(thirdQuint)Intensified, Inpatient Adaptation of Dialectical Behavior Therapy (DBT).
 ...
 Intervention: All patients receive DBT according to the basic DBT treatment protocol.

 Treatment integrity is established by supervision in both groups.

 Outcome measures Main study parameter is the number of suicide attempts/self-harming acts (the Life Time Parasuicide Count and the Parasuicide Scale of the Borderline Personality Severity Index).

 Second study parameter is the severity of borderline symptomatology (BPDSI).

 Quality of life as measured on the SF-36, and the EQ-5D and psychopathological symptoms (BSI) will also be taken into account.

 The cost-effectiveness of the inpatient program compared to the outpatient program will be examined (TiC-P).

 Sample size.

 The researchers expect that after 12 weeks of treatment, 20% of the patients of the intervention group still show suicidal and/or self-harming behavior compared to 60% of the patients in the control condition, and that this difference sustains after 24 weeks and will be gradually reduced between 24 and 52 weeks by the additional reduction in suicidal and/or self-harming behavior in the control group.

 To be able to detect a difference of 40% after 12 weeks, with a power of 0.

80 and = 0.

05, 36 patients per experimental condition are required.

 The researchers expect to recruit about 150 patients, which guarantees enough power, even with a 20% drop out rate.

.

 Intensified, Inpatient Adaptation of Dialectical Behavior Therapy (DBT)@highlight
