(secondQuint)Prevention of Pressure Ulcers in Patients Under Non-Invasive Mechanical Ventilation.

 Non-Invasive Mechanical Ventilation (NIVM) has turned into a standard in the care of patients with acute respiratory failure.

 Defined as a support modality to the patient`s spontaneous ventilation, it does not use invasive techniques to ventilate, working as an external device named interface or mask, avoiding so the complications associated to the invasive ventilation.
 ...
 Often, the preferred interface is the oronasal, worst tolerated but associated to best treatment of the acute pathology.

 In most cases to avoid air leaks, its proper placement generates high pressure on the skin, being able to harm patient`s tissues, so that this therapy as intervention for the acute patient has pressure ulcers -PU- as main iatrogenic effect - although 95% of the PU are considered as preventable-.
 ...
 The aim of this study is to test direct application of the mask or interface, as the most efficient intervention, compared with other three usual preventive measures which consist in the use of three different medical devices: autoadhesive polyurethane dressing (Allevyn Thin(R)), semi-permeable hydrogel-foams adhesive dressing (Askina Transorbent Border(R)) or hyperoxygenated fatty acids (Linovera(R)).

 Prevention of Pressure Ulcers in Patients Under Non-Invasive Mechanical Ventilation@highlight
