(fifthQuint)Omega-3 Supplementation in HIV Patients With Therapeutic Lifestyle Change Diet.
...
.
 ...
 The state of Jalisco, Mexico, occupies the fourth place in terms of positive cases of HIV-AIDS, in this same plane, the municipalities of Guadalajara, Zapopan, Tlaquepaque and Puerto Vallarta in Jalisco, represent the main populations with the highest number of positive cases by HIV-AIDS.

 The HIV positive individuals with Highly Active Antiretroviral Therapy (HAART) or without treatment are facing numerous challenges in terms of management of their health; some of the most disturbing changes are visible in the shape and appearance of the body.

 In most cases this anatomical changes come accompanied by alterations in biochemical indicators: lipid levels (cholesterol and triglycerides) and insulin resistance4.

These adverse effects may have important clinical implications, such as severe lactic acidosis, coronary artery disease and acute pancreatitis5.

 In patients with HIV and HAART has published an incidence of hypercholesterolemia and hypertriglyceridemia between 5 and 90% depending on the series, although the true incidence is yet to be determined6.

 Pharmacological interventions with statins or fibrates in patients infected with HIV are limited partially due to the drug interactions and increase in the frequency of adverse effects7.
 ...
 All the patients were active in the SMART database from HIV/AIDS department of the Civil Hospital in Guadalajara "Fray Antonio Alcalde".

 Patients were excluded for intolerance or allergy to fish, patients that use or have used in the last 6 weeks supplements or drugs that modify lipids.
 ...
 Our subjects were assigned to 5 intervention groups: Groups one= 20 subjects received Therapeutic Lifestyle Changes diet more 1.

05 grams of Fatty Acid omega 3.

 Groups two= 20 subjects received conventional diet more 1.

05 grams of Fatty Acid omega three.

 Groups 3=20 subjects received Therapeutic Lifestyle Changes diet more 2.

10 grams of Fatty Acid omega 3.

 Groups four=20 subjects received conventional diet more 2.
...
10 grams of Fatty Acid omega 3.
 ...
 Statistical analysis The main objective of this study was to compare the changes in fasting levels of triglycerides (TG), total cholesterol (TC), high density cholesterol (HD-C), low density cholesterol (LD-C), very low density cholesterol (VLD-C), the body weight and body mass index (BMI) against the week 4 and 12.
 ...
 Inferential analysis to the intra-group used the Wilcoxon test and Friedman.

 For the inferential analysis between groups was implemented in the variables of non-normal distribution, the Kruskal-Wallis test; and for variables with normal distribution was used the one-way ANOVA test.

 Differences were considered statistically significant when the p value was <0.

05 .

 The data were processed using the statistical package No.

18.

0 and are presented in tables and graphics.
