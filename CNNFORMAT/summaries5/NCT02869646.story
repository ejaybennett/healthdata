(fifthQuint)Acupuncture for PTSD.
 ...
 The primary hypothesis is that efficacy of ACU for PTSD symptom severity will be large (pre- to post-treatment Cohen's d > 0.

8), and significantly better than MIN (between group Cohen's d > 0.

30, with 80% probability of detecting a true group difference at p<0.
...
05 (2-sided).
 ...
 General linear mixed models will be used to evaluate hypothesized effects over time (mid treatment, end of treatment, 1-month follow-up), controlling for baseline severity of symptoms and demographic characteristics (e.

g.

, age, gender) using intent-to-treat modeling.
...
.
 ...
 Acupuncture for PTSD@highlight
