(fifthQuint)Working Memory Training in Huntington's Disease.
 ...
 Compared to baseline scores, patients showed significant improvement on the neuropsychological measures of verbal WM, including Digit Span (p = .

047) and Auditory WM (p = .

041).

 This pilot study provides support for feasibility of computerized WM training in early-stage patients with HD.

 Results suggest that HD patients can improve WM with intensive training, though a full-scale intervention project is needed to understand the reliability of changes over time.

.

 Working Memory Training in Huntington's Disease@highlight
