(secondQuint)Diagnostic Accuracy of ERCP-guided Versus Cholangioscopy-guided Tissue Acquisition in Patients With Indeterminate Biliary Strictures Suspected to be Intrinsic .

.

 Study Design : Prospective,multi-center, randomized controlled, Post market Study (PMS) Two groups: - Control arm - ERCP arm: ERCP impression and ERCP-guided brushing and biopsy - Study arm - Cholangioscopy arm: SpyDS impression and SpyDS-guided SpyBite biopsy Randomization 1:1 ratio.

 Primary Endpoint: Diagnostic accuracy of cholangioscopy or cholangiography assessed at 6 months after initial ERCP procedure - Malignancy will be determined by cytology or histology on tissue sampling during the index procedure, or from other tissue acquisition or surgical specimen histopathology up to 6 months after the index procedure.
 ...
 Procedural measures: Type and number of devices used, 8.
