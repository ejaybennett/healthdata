(fifthQuint)Early Detection of Cardiovascular Changes After Radiotherapy for Breast Cancer.

 EARLY-HEART is a multicentre prospective cohort study that will include 250 female primary breast cancer cases aged 40-75 years treated with postoperative radiotherapy (RT) alone after breast-conserving surgery using modern planning-CT based RT technologies and followed for 2 years after RT in one of the 5 participating hospitals.

 In addition to the standard follow-up, patients will need to give repeated blood samples and will undergo repeated cardiac imaging: - Functional and anatomical cardiac imaging biomarkers will be based on automated 2D-speckle-tracking echocardiography (ECHO-ST); Computed Tomography Coronary Angiography (CT) and cardiac magnetic resonance imaging (MRI).
 ...
 All relevant DICOM-data (including planning-CT scans and the ECHO, MRI and CT) will be centralized to the MEDIRAD-ENACT database managed by University of Groningen for automated segmentation of all cardiac substructures (including coronary arteries) to ensure uniformity of the segmentation procedure between centres.

 The RT planning CTs will be used to generate dose volume histograms and 3D dose maps of the heart and cardiac substructures in order to correlate the localization of any cardiovascular change with the anatomical dose distribution.
...
.
 ...
 Early Detection of Cardiovascular Changes After Radiotherapy for Breast Cancer@highlight

Breast cancer (BC) radiotherapy leads to coincidental radiation of the heart, resulting in increased risk of a variety of heart diseases.

 Identifying BC patients with the highest risk of radiation-induced cardiac complications is crucial for developing strategies for primary and secondary prevention.
