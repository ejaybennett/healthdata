(secondQuint)Efficacy and Safety of CB-01-11 200mg Tablets in Infectious Diarrhoea.
 ...
 Primary end points to determine: cent The safety and preliminary efficacy data of the three doses of the new rifamycin SV formulation tested based upon the time elapsed from the ingestion of the 1st dose of study medication to the passage of the last unformed stool (TLUS), in compliance with the relevant guidelines Secondary end-points to determine: - The number of patients showing improvement in diarrhoea during a 24-h interval, i.

e.

 >50 % reduction of bowel movements.

 - The number of unformed stools passed per 24-h interval, after dosing.

 - The number of patients who are declared to be "well".

 Wellness is defined as the patient having 48 hours with no unformed stools, a maximum of two soft stools and no clinical symptoms of infectious diarrhoea.
 ...
 - The number and percentage of patients recovered from diarrhoea.
...
.
 ...
 Efficacy and Safety of CB-01-11 200mg Tablets in Infectious Diarrhoea@highlight
