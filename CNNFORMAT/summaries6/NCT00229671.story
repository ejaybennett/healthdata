(secondQuint)Medication Errors and Adverse Drug Events (ADEs) in Ambulatory Pediatrics.

 This study has the following 2 goals: Aim 1: To determine the rates, types, and predictors of medication errors and ADEs.
...
.
 ...
 Medication Errors and Adverse Drug Events (ADEs) in Ambulatory Pediatrics@highlight

The purpose of this study is to determine the rates of medication errors in pediatric outpatients in 6 office practices.

 Further, we wish to determine the effectiveness of a computerized physician order entry (CPOE) system in reducing errors.
