(thirdQuint)Trial to Evaluate Genomic Expression Profiles to Direct Preoperative Chemotherapy in Early Stage Breast Cancer.

 Primary Objective 1 was to test for an arm difference in pathological complete response rates.

 Secondary Objective 2 was to estimate and test the difference in pathologic complete response rates between drug-sensitive patients who received their preferred drug and drug-resistant patients randomized to AC or TC.
...
, genomic predictive probabilities) with clinical response, disease-free survival, sites of recurrence, and overall survival; Secondary Objective 9:to compare the mean cost of guided versus non-guided treatment; and Secondary Objective 10 to assess patient perceptions of participating in a clinical trial that evaluated cancer genomics for preoperative systemic therapy of early-stage breast cancer.

 Objective 10 details: Due to space limitations in the Outcome Measure Description field, details are supplied here: To assess patient motivation and participation for study participation in a clinical trial evaluating cancer genomics for treatment patients provided responses for the following questions at both baseline (the day of chemotherapy start) and following post-surgical medical oncology evaluation: One of the goals of this study is to tailor your cancer treatments for you based upon a genomic analysis of your tumor.

 How much did the knowledge that the treatment is potentially tailored specifically for your tumor influence your decision to participate in this study? (Select One) Response 1: I did not know that the treatment was tailored.
...
.
 ...
 Trial to Evaluate Genomic Expression Profiles to Direct Preoperative Chemotherapy in Early Stage Breast Cancer@highlight

This multi-center randomized Phase II study assigned HER2-negative early-stage breast cancer patients to receive preoperative systemic chemotherapy in either a "genomic-guided" arm or a "non-guided arm.

" The "genomic-guided" method (Arm 1) used genomic expression profiling to assign the preoperative therapy (Doxorubicin/Cyclophosphamide (AC) versus Docetaxel/Cyclophosphamide (TC), while Arm 2 used random assignment to these two therapies.
