(fifthQuint)Treatment of Predominant Central Sleep Apnoea by Adaptive Servo Ventilation in Patients With Heart Failure.
 ...
 Study Design: Randomized, multicentre, international trial with parallel group design, with patients randomized to either control (optimal medical management) or active treatment (optimal medical treatment plus use of adaptive servoventilation) in a 1:1 ratio.

 There will be no sham-positive airway pressure treatment in the control arm.

 Assumptions: the intervention reduces the hazard rate by 20%.

 The event rate in the control group is 35% in the first year.

 It is assumed that the hazard rate is constant over time.

 The trial is an event driven design: the final analysis is to be performed latest when 651 events have been observed.

 The primary analysis is in the intention-to-treat population that consists of all patients randomized.

 Number of Patients: 1116 patients will be randomly assigned to one of the two treatment groups.

 A 20% drop out rate is estimated.
 ...
 Primary Endpoints: Time to first event of: 1.

 all cause mortality or unplanned hospitalisation/prolongation of hospitalisation for worsening heart failure 2.

 cardiovascular mortality or unplanned hospitalisation/prolongation of hospitalisation for worsening heart failure.

 3.

 all cause mortality or all cause unplanned hospitalisation/prolongation of hospitalisation Heart transplantation, appropriate shock from ICD, long term assist device (LTAD) insertion and survived resuscitation of sudden cardiac arrest are counted as cardiovascular death, survived resuscitation for other reasons is counted as all cause death.
...
.
 ...
 Treatment of Predominant Central Sleep Apnoea by Adaptive Servo Ventilation in Patients With Heart Failure@highlight
