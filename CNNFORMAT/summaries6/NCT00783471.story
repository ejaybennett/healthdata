(firstQuint)Docetaxel Intermittent-Erlotinib (Tarceva) In Metastatic Non Small Cell Lung Cancer (NSCLC).
 ...
 This is a multicenter randomized Phase II trial aiming to determine the more active dosing sequence between intermittent erlotinib and docetaxel for treating patients with advanced Non-Small-Lung-Cancer.

Patients will be randomly assigned to one of two treatment arms: they will receive a 12-days course of erlotinib either before docetaxel [arm A] or after docetaxel administration [arm B].

Treatment will be repeated every 21 days.

Patients will be evaluated every 2 cycles (~6 weeks) for response using RECIST criteria.
...
.
 ...
 Docetaxel Intermittent-Erlotinib (Tarceva) In Metastatic Non Small Cell Lung Cancer (NSCLC)@highlight
