(thirdQuint)A Post-market Registry of the MARIS-stent (Invatec) Implanted in the Superficial Femoral Artery.
 ...
 The registry includes 998 patients from 13 German investigational sites.

 Clinical data are captured on electronic case report forms The primary endpoint is the target lesion revascularization after 12 month Secondary endpoints are : - Restenosis rate > 50% according to ultrasound criteria - Restenosis rate > 70% according to ultrasound criteria - Location of restenosis (proximal, middle, distal AFS) - Number of stent fractures (grading according to FESTO criteria) - Procedure related complication rate - Vascular complication rate within 12 month - Amputations within 12 month - Deaths within 12 month In order to measure the restenosis the peak systolic velocity (PSV) is to be measured in two sections during the duplex ultrasound examinations at 6 and 12 month.

 First measurement is performed 2cm proximal to the first stent, second measurement at the location where the maximum peak velocity over all lesions/all implanted stents is measured.

 The clinical status includes the patients Fontaine classification.

.

 A Post-market Registry of the MARIS-stent (Invatec) Implanted in the Superficial Femoral Artery@highlight
