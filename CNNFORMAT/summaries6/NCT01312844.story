(fifthQuint)A Study of the Use of IV Scopolamine to Augment the Efficacy of Electroconvulsive Therapy (ECT).

 Electroconvulsive therapy (ECT) is a highly effective treatment for severe major depression.

 It has been estimated that approximately 10 percent of all patients admitted to the hospital for treatment of major depressive disorder receive ECT.

 However, not all patients who receive ECT respond, and of those who do, not all achieve remission.

 Furthermore, while there is a wide range in the number of ECT treatments done among all people with depression, the average is approximately eight treatments.

 Because treatments are usually done three times per week (Monday, Wednesday, and Friday), the minimal length of stay for the average person receiving inpatient ECT is typically greater than two weeks.

 Finally, ECT is not without risk, and every round of ECT incurs additional risk of not just the treatment itself, but also the risks of general anesthesia.

 Thus, although ECT is a robust mode of treatment for Major Depressive Disorder (MDD), there remains a need for improved treatment efficacy and speed of onset.

 Improving the efficacy of ECT would not only benefit individuals with MDD, but also have far-reaching effects for the health care system as it could impact the cost and resources utilized.

 Ideally, an agent could be added to augment the effect of ECT, both in terms of efficacy as well as speed of onset.

 In 2006, Furrey et al, reported the rapid antidepressant effect of the antimuscarinic drug, scopolamine, delivered parenterally.

 Significant antidepressant effect was found after the first scopolamine administration.

 The improvement was reported immediately following the first IV administration, increased across all treatments, and was sustained into the placebo crossover period.

 Scopolamine is an anticholinergic muscarinic agent, with activity in the CNS and pilot data to suggest a significant impact on rapidly improving depressive symptoms in patient with MDD, when administered IV.

 Thus, it serves as a reasonable choice to augment the effects of ECT in the treatment of patients with MDD.
...
.
 ...
 A Study of the Use of IV Scopolamine to Augment the Efficacy of Electroconvulsive Therapy (ECT)@highlight
