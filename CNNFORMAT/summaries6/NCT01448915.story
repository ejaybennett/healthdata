(thirdQuint)Management of Hepatitis C in HIV Infected Injection Drug Users (IDUs).
 ...
 The investigators will apply the innovative technology, elastography (FibroScan(R)) to ask whether the marked differences in the final disease outcome, end-stage liver disease (ESLD), can be explained by a measure of liver stiffness as assessed by elastography (FibroScan(R)).
 ...
 Hepatitis C Treatment Eligibility: To determine the population prevalence of significant liver disease in coinfected IDUs using an innovative, non-invasive methodology (transient elastography, FibroScan(R)) to measure liver stiffness.
...
.
 ...
 Management of Hepatitis C in HIV Infected Injection Drug Users (IDUs)@highlight
