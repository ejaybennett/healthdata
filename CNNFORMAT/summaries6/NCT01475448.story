(thirdQuint)Long Distance Running Training by Older Adults.

 In a study the investigators conducted about elderly runners, the main observed difference by the first time was that elderly individuals present greater foot abduction (toe-out) during running than young adults.

 This alteration has been observed in elderly individuals in general during walking, and identified as a protective mechanism to not overload the medial compartment of the knee joint.

 It is also known that elderly individuals present a different joint torque distribution in the lower limbs during walking in comparison with young adults.

 However, it's not known the relation between the movement patterns, particularly the foot abduction pattern, and the mechanical load on the knee joint during running by elderly individuals and neither the longitudinal effect of running practice on this relation and on the mechanical joint load distribution.

 Another unknown aspect is the actual effect of the running practice on the posture control of elderly individuals.
...
.
 ...
 Long Distance Running Training by Older Adults@highlight
