(fifthQuint)An Exercise App to Reduce Young Adults' MJ Use.

 Currently, marijuana (MJ) is the most popular illicit drug, with prevalence studies indicating increasing use among young adults (Johnston et al.
...
, 2011).
 ...
 The intervention includes elements from the Marijuana Check-Up (MCU; Stephens et al.

, 2007), a MI-based brief intervention that has shown promise for reducing MJ use.
 ...
 The investigators research also has shown that short (i.

e.

, 10 minute) bouts of moderate or intense exercise reduce craving/urges to use MJ.

 Exercise interventions have successfully reduced use of licit substances, such as tobacco (e.
...
, 2009), but have not been adequately tested for MJ use.

 The two aims of this R34 application are: 1) To develop an intervention that consists of four, 60-minute, in-person sessions composed of MCU content (e.

g.

, personalized feedback, MI) as well as a smart phone application (app) that promotes exercise/physical activity (EA) as an alternative to MJ use.
 ...
 2) To conduct a pilot/efficacy study of the 4-week MCU+EA intervention vs.

 a MCU-only control condition.
 ...
 It includes cutting-edge technology (e.

g.

, accelerometers, smart phone app) for real-time assessments.
...
.
 ...
 An Exercise App to Reduce Young Adults' MJ Use@highlight
