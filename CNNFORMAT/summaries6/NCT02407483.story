(firstQuint)Laparoscopic Training With Laser Guidance Trial.
 ...
 Methods: Randomised Clinical Trial- Laser visual guidance vs.

 normal 2 D vision.

 Outcomes: Primary outcome: Motor skills performance parameters-movement-time: Cumulative instrument movement-time for both the right and left instrument for the test session, Secondary outcome: 2) The overall composite score.

 Exploratory outcomes: 3) The NASA Task Load index (NASA-TLX).

.

 Laparoscopic Training With Laser Guidance Trial@highlight
