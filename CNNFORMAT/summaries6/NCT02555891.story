(fifthQuint)The PIP-STOPP Study.
 ...
 Background: Adverse drug events are common in the elderly, and contribute significantly to emergency room (ER) visits and unplanned hospitalizations.

 Patients aged sixty-five and over currently represent over 14% of the Canadian population, yet spending on prescription medications by seniors accounts for over 40% of all retail prescription drug sales.

 This is equivalent to a per capita spending on prescription drugs by seniors that is three times the Canadian average.

 A recent Irish study showed that, of 600 elderly patients admitted to hospital for an acute illness, 25% of them had one or more adverse drug events, of which two thirds had contributed to the hospitalizations.

 Of these adverse events contributing to hospitalizations, 69% were deemed avoidable.

 A number of tools and strategies have been developed to identify potentially inappropriate prescribing (PIP), however, until recently, none of the commonly used tools had been shown to reliably predict adverse events.

 The STOPP/START criteria (Screening Tool of Older Persons' potentially inappropriate Prescriptions / Screening Tool to Alert doctors to Right Treatment) was recently compared to the long-standing Beers criteria, and found to detect adverse drug effects that are causal or contribute to hospitalization in elderly patients with acute illness 2.

8 times more often than the Beers criteria.

 The application of these criteria is usually done in a clinical context, which involves time-intensive and expensive chart reviews.

 There are relatively few studies looking at appropriateness of prescribing at the population level, using health administrative data.

 Applying tools to assess appropriateness of prescribing, such as a subset of the STOPP criteria, to health administrative data can provide a unique opportunity to assess both the frequency of potentially inappropriate prescribing and its associated costs, in terms of both medication and health services use at the population level.
...
The overall objective of the present study will be to describe the occurrence of Potentially Inappropriate Prescribing (PIP) in Ontario's elderly (>65 yrs) population, assess the health and economic burden associated with it, and evaluate interventions aimed at mitigating its effects.
 ...
 To attain this objective, the investigators will test three specific hypotheses: Hypothesis 1: Instances of Potentially Inappropriate Prescribing are frequent and costly.
 ...
 The investigators will test these hypotheses in the framework of a retrospective cohort study which the investigators will conduct using Ontario's large health administrative and population databases.

 These are housed at the Institute for Clinical Evaluative Sciences (ICES) and contain information on both hospital and outpatient use of health services, as well as demographic and socioeconomic data.

 Patients included in the study will be all OHIP (Ontario Health Insurance Plan) eligible patients aged 66 yrs of age and older who have been issued at least one prescription between April 1st 2003 and March 31st 2013.
