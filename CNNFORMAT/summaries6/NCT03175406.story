(firstQuint)Predicting the Outcomes of Labor Induction.

 preinduction cervical assessment using The Burnett modification of Bishop score with 1.
 ...
 Position of the cervix will be given a score of zero if posterior, a score of 1 if mid position and a score of 2 if anterior.

 So, a total score (sum of all scores) of zero at a minimum to 10 at a maximum can be estimated.

 and also preinduction cervical assessment using transvaginal ultrasound and Manipal system where: 1.
 ...
 Length of the funnel will be given a score of zero if absent, a score of 1 if 0.

5 cm, a score of 2 if more than 0.

5 cm.

 3.

 width of the funnel will be given a score of zero if absent, a score of 1 if 0.
...
5 cm.
 ...
 cervical position and shape will be given a score of zero if curved, a score of 2 if straight 5.
 ...
 Predicting the Outcomes of Labor Induction@highlight
