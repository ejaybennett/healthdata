(thirdQuint)Central Obesity and Disease Risk in Japanese Americans.
 ...
 This cluster of abnormalities has been called 'Syndrome X'.

 It is postulated that 'Syndrome X' develops in Japanese Americans in response to environmental (behavioral) factors, many of which reflect 'westernization' in this ethnic group.
 ...
 DESIGN NARRATIVE: The cohort was re-examined for diabetes, hypertension, coronary heart, disease, peripheral vascular disease, and a number of potential coronary heart disease risk factors including medical history, health practice, social history, diet, glycosylated hemoglobin, insulin, proinsulin, c-peptide, glucose, anthrometric measurements, lipids, and computed tomography on the thorax, abdomen, and thigh.

.

 Central Obesity and Disease Risk in Japanese Americans@highlight
