(thirdQuint)White Button Mushroom Extract in Preventing the Recurrence of Breast Cancer in Postmenopausal Breast Cancer Survivors.
 ...
 Patients undergo blood and urine sample collection at baseline and periodically during treatment for pharmacokinetic, pharmacodynamic, and immunologic correlative studies.

 Blood and urine samples are analyzed for concentrations of C-18 unsaturated fatty acids (CUFA) by high-performance liquid chromatography tandem-mass spectrometry.

 Blood samples are also analyzed for anti-aromatase activity by ex vivo plasma aromatase inhibition assays; circulating sex steroid hormones by radioimmunoassay; serum immune cytokine levels by multiplex cytokine analyses; immunophenotyping, NK-cell activation status, and NK-cell function by multiparameter flow cytometry; lipid levels by lipid assays; and biochemical markers of bone metabolism by bone metabolism marker assays.

 DNA, RNA, and plasma samples are stored for post-trial pharmacogenomic studies.

.

 White Button Mushroom Extract in Preventing the Recurrence of Breast Cancer in Postmenopausal Breast Cancer Survivors@highlight
