(fifthQuint)Intracoronary Infusion of Bone Marrow Mononuclear Cells in Patients With Previous Myocardial Infarction.

.

 This is an uncontrolled study in which the efficacy of the cell therapy drug is measured by comparing the variables of ventricular function after treatment to the basal condition prior to its application The total number of patients to be studied 20.

 The study population will correspond to male and female patients with chronic anterior myocardial infarction (more than 6 months after the acute episode) and ventricular dysfunction.

 It is expected 36 months of inclusion and one year follow up Patients will receive in a concomitant way the drug treatment established by the good practice, so it would certainly be possible that some improvement occurs due to drug treatment.
...
Phase II clinical trial which will include all patients diagnosed with chronic anterior myocardial infarction (more than 6 months from the acute phase and the complete revascularization in which it is assessed the evolution of left ventricular function in patients to the monitoring against their own basal condition.
 ...
 Included patients will be studied in the following conditions: - Basal condition: defined as the immediately preceding to the administration of cell therapy treatment.
 ...
 - Monitoring Condition 2: six months after administration of treatment.

 Includes the same methods of exploration of ventricular function practised in the basal condition, including cardiac catheterism as well as non invasive methods.
