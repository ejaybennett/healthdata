(secondQuint)Neuropsychological Profile of a Patient's Group With Multiple Sclerosis and Effect of a Cognitive Rehabilitation Program.

 Objectives Primary: 1.

 To determine the effect of an intensive cognitive rehabilitation program in neuropsychological performance of a population of patients with multiple sclerosis or clinical isolated syndrome.
 ...
 Population and Sample Patients will be selected from an electronic database that exists in Centro Hospitalar Entre Douro e Vouga.

 They will be consecutively convoked and it will be proposed neuropsychological evaluation and participation in the study.

 Every patient will have a baseline neuropsychological evaluation (table 1).

 After that, they will be randomized for training (Cogweb(R) program or Cogweb Monthly Notebooks(R)) or placebo in a 2(training):1(placebo) fashion (online program of randomization).

 After a 3-month period of tasks (training versus placebo), they will have another neuropsychological evaluation with the same battery used for baseline.

 Patients included in intervention arm that have computer with internet access at home will perform a minimum of 3 sessions per week of Cogweb(R) during 3 months.

 Patients included in intervention arm that don't have computer with internet access at home will perform a minimum of 3 sessions per week of Cogweb Monthly Notebooks(R) during 3 months.
 ...
 Clinical Practice Concomitant medication allowed Any except corticotherapy.
 ...
 Parameters to evaluate de study objectives 1.
 ...
 Efficacy Endpoints Primary: To determine if an intensive cognitive rehabilitation program changes, in a statistically significant way, the performance on a neuropsychological evaluation after 3 months of training, comparing to the control group (number of tests scored more than one standard deviation from the normal value).

 There will be analyzed the total and partial scores for each test.

 The individuals with cognitive deficits at baseline will be analyzes as rehabilitation group.
...
.
 ...
 Neuropsychological Profile of a Patient's Group With Multiple Sclerosis and Effect of a Cognitive Rehabilitation Program@highlight
