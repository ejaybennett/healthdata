(thirdQuint)Verapamil vs Heparin in Transradial Procedures.
 ...
 However, radial artery occlusion (RAO) after the procedure (the incidence of which varies from 1% to 10%) remains one of the major limitations of TRA.
 ...
 METHODS Patients referred to the cath-lab of the Cardiovascular Institute of the University Hospital of Ferrara, Italy, for coronary angiography were randomized in 2 groups with a computer-generated random sequence.

 The study is double-blind.

 In the first group, patients received intravenous heparin (5000 UI) immediately after a 6 F sheath insertion.

 In the second group, patients received Verapamil (5 mg) immediately after a 6 F sheath insertion.

 If after the start of the procedure a radial artery spasm (RAS) occurs, the operators can choose to use bail-out a local vasodilator therapy.

 After sheath removal, hemostasis was obtained using a TR band (Terumo corporation, Tokyo, Japan) with a plethysmography-guided patent hemostasis technique.

 Radial artery patency was evaluated at 24 hours (early RAO) and 30 days after the procedure (late RAO) by ultrasound.
 ...
 Verapamil vs Heparin in Transradial Procedures@highlight

Transradial approach (TRA) for cardiac catheterization and percutaneous coronary interventions (PCI) is increasingly being used worldwide.

 At the present is unknown the cocktail of agents necessary to minimize local access site complications.

 The investigators planned a prospective randomized clinical trial to test the superiority of verapamil vs.
