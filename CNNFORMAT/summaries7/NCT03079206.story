(firstQuint)Basophile Activation Testing (BAT) in Hazelnut Allergy (Hazelnut BAT Study).

 Accurate diagnosis of food allergy depends on food challenge outcome.

 The proposed study intends to compare the outcome of food challenge in hazelnut allergic patients with the outcome of basophile activation tests using hazelnut extract and components to evaluate the diagnostic utility of basophile activation testing.
...
.
 ...
 Basophile Activation Testing (BAT) in Hazelnut Allergy (Hazelnut BAT Study)@highlight
