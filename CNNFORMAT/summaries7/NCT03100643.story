(fifthQuint)Development of a Couple-Based Mobile Health Intervention for Enhancing HIV Care Engagement Outcomes (N'Gage).
 ...
 Mobile technology-based strategies (mHealth) offer tremendous potential as an acceptable, feasible, and effective intervention approach for enhancing HIV care engagement among partnered HIV+ Black MSM for several important reasons: (1) Black MSM are likely to report having a primary partner and to participate in couple-based HIV interventions; (2) couple-based behavior (e.

g.

, daily routines of the couple), within-partnership dynamics (e.

g.

, trust, intimacy), and couple serostatus (i.

e.

, serodiscordant and concordant-positive relationships) are understudied factors in optimal HIV care engagement among MSM; and (3) mHealth has shown feasibility and acceptability in targeting couple-based behavior (e.

g.

, money management, family planning) in the general population.
...
.
 ...
 Development of a Couple-Based Mobile Health Intervention for Enhancing HIV Care Engagement Outcomes (N'Gage)@highlight
