(thirdQuint)Combining Motor Imagery With Action Observation Does Not Lead to a Greater Autonomic Response Than Motor Imagery Alone During Simple and Functional Movements: a Randomized Controlled Trial.
...
.
 ...
 Both observation and imagination share a great number of common mental processes based primarily on sensory perception, and the information stored by memory systems.

 The activation of the motor command during a mental practice does not induce an active movement probably due to an inhibitory mechanism in the primary motor cortex on the descending corticospinal tract pathways.

 However, this inhibition is not complete, for it is well known that the training of mental practice involves a component of the autonomic nervous system (ANS).

 It has been shown that both MI and AO lead to changes in the ANS that cause excitatory sympathetic responses, although the neurophysiological bases remain uncertain and are still based on hypotheses.

 The functional relations between both neurocognitive processes and the sympathetic-excitatory nervous system (SNS) could be based on a preparation phase in which, the activation of the SNS, happens to a near effort and, therefore, to a close energy expenditure in physiological processes (i.

e.

, cardiorespiratory adaptationse) which will take place in order to face said metabolic changes produced by the voluntary movement itself.
...
.
 ...
 The secondary objective of the present study was to explore whether there is any relationship between the sympathetic-excitatory response and the ability to generate motor imagery, the mental chronometry, and the level of physical activity.
