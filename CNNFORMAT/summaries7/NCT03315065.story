(firstQuint)19F Thoracic Radiotherapy for Lung Cancer.

 Primary Objective: Determine feasibility by evaluating if: PO1: Patients diagnosed with lung cancer are able to successfully complete pre- and post-radiotherapy 19F MR imaging scans as scheduled.

 Secondary Objective: Determine efficiency by evaluating if: SO1: Determine efficiency by evaluating if 19F MRI data can be successfully analyzed and incorporated into the radiation planning system.
...
.
 ...
 19F Thoracic Radiotherapy for Lung Cancer@highlight
