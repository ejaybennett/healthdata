(firstQuint)ILF With/Without Cisplatin for Advanced Gastric Cancer.

 Irinotecan, in combination with 5-FU or cisplatin, clearly demonstrated efficacy against gastric cancer.

 A previous randomized study of ILF regimen versus IP in patients with AGC showed that the ILF produced an overall response rate of 42% and a median survival of 10.

7 months, which were significantly better than the results with IP regimen [Pozzo C, et al.
...
.
 ...
 ILF With/Without Cisplatin for Advanced Gastric Cancer@highlight
