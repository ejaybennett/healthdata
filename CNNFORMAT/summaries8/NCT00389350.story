(firstQuint)Effect of an Extract of Green Tea on Adults With Type 2 Diabetes.

 Background: Recent evidence suggests that tea from Camellia Senensis (e.

g.

, green, oolong and black tea) may have a hypoglycemic effect.
 ...
 Measurements: HbA1c at three months was the primary endpoint.

 Results: After three months the mean changes in HbA1c were +0.

4, +0.

3 and +0.

5, in the placebo, 375mg and 750mg arms, respectively.

 The changes were not significantly different between study arms.

 Limitations: Evaluation of a particular extract that contained components of black teas as well as green tea.

 Power insufficient to detect changes in HbA1c < 0.
...
.
 ...
 Effect of an Extract of Green Tea on Adults With Type 2 Diabetes@highlight
