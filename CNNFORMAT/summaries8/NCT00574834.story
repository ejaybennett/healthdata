(thirdQuint)Mechanisms of Ramipril Reduction in the Onset of Type 2 Diabetes.

 Several studies have demonstrated that therapeutic agents used to reduce glucose levels and/or weight can delay the onset of type 2 diabetes.

 Intriguingly, angiotensin converting enzyme (ACE) inhibitors or angiotensin receptor blockers (ARB) also result in reduction in the onset of type 2 DM.

 The most striking effect was found with Ramipril in the HOPE study.

 The onset of new type 2 DM was reduced by 34% (p<0.

001) as compared to placebo.

 Furthermore, the results of the DREAM trial demonstrate that Ramipril at a dose of 15 mg can significantly reverse impaired glucose tolerance.

 However, the mechanisms underlying Ramipril effects to delay type 2 diabetes are not known.
...
.
 ...
 Mechanisms of Ramipril Reduction in the Onset of Type 2 Diabetes@highlight
