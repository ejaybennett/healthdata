(thirdQuint)Adapting DBT for Children With DMDD: Pilot RCT.
 ...
 Hypothesis 1: Attendance rate in DBT-C, as compared to TAU, will be at least 10% higher and drop-out rate will be at least 10% lower (primary feasibility endpoint).

 Further, DBT-C, as compared with TAU will have significantly higher treatment satisfaction rating by subjects (on the child and caregiver Therapy Satisfaction Questionnaires), and by therapists (on Therapist Satisfaction Scale), and higher patient compliance (on Psychosocial Treatment Compliance Scale).

 Therapist treatment adherence and competence as measured by DBT-C Treatment Integrity Scale, will not fall below 80%.

 Specific Aim 2: Examine preliminary efficacy of DBT-C in reducing symptoms of Disruptive Mood Dysregulation Disorder.

 Hypothesis 2: Children in DBT-C condition as compared to TAU will have significantly greater reduction in irritability, anger, aggression, temper outbursts, and mood instability (on Clinical Global Impression - Improvement scale [primary categorical outcome] and Mood Symptoms Questionnaire [primary continuous outcome]).

 Exploratory Aim 3: Examine efficacy of DBT-C in improving adaptive coping skills, emotional and behavioral regulation, social skills, and reducing aggressive behaviors, affective reactivity, non-suicidal self-harm behaviors, suicidal ideations, suicidal attempts, and non-suicidal self-harm urges.
...
.
 ...
 Adapting DBT for Children With DMDD: Pilot RCT@highlight

This study examines feasibility and preliminary efficacy of Dialectical Behavior Therapy adapted to children (DBT-C).

 DBT-C as compared to treatment-as-usual (TAU) is hypothesized to have lower drop-out rate, and higher treatment attendance and satisfaction.

 Further, DBT-C as compared to TAU will have significantly greater reduction in symptoms of Disruptive Mood Dysregulation disorder, including verbal and behavioral outbursts and angry/irritable mood.
