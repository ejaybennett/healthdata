(fifthQuint)Genetic Risk and Health Coaching for Type 2 Diabetes and Coronary Heart Disease.

 This study will examine the impact of providing genetic CHD and T2D risk information, with or without a supportive behavioral intervention, on promoting risk-reducing behaviors and improving clinical outcomes.

 In short, using a 4-group (2X2) randomized controlled trial (RCT) design, this study will determine whether incorporating multiple-marker genetic testing into risk counseling for CHD and T2D, coupled with a health coaching intervention will lead to greater changes in physical fitness, health behaviors, risk status and clinical outcomes in active-duty Air Force (ADAF), beneficiaries or dependents and AF retiree patients (N=400).

 The study will address the following task objectives: 1.
 ...
 Given the lack of RCTs on the effects of differing genetic test results, such as false reassurance and genetic determinism, we will also pursue a third, exploratory task objective: 3.
 ...
 Health coaching intervention: Participants in the two groups that include health coaching will be assigned to a trained health coach for a period of 6 months (n=200).

 IHC (Integrative Health Coaching) sessions will be provided by telephone using a structure that has evolved in multiple trials and clinical programs at Duke Integrative Medicine.
...
.
 ...
 Genetic Risk and Health Coaching for Type 2 Diabetes and Coronary Heart Disease@highlight
...
The purpose of this study is to examine whether the use of genetic test information and/or health coaching in patient risk counseling for heart disease and diabetes affect health behaviors and health outcomes in active-duty Air Force (ADAF), beneficiaries or dependents and Air Force retiree patients.
 ...
 Total of 400 subjects will be enrolled.

 They will be randomly(like flipping a coin)assigned to 4 groups: 1)Standard risk assessment (SRA)only; 2)SRA plus genetic risk information (SRA+G); 3)SRA plus health coaching (SRA+HC); or 4)SRA, genetic risk information, and health coaching (SRA+G+HC).

 Subjects randomized to the two genetic arms will have blood collected for testing of investigational coronary heart disease (CHD) and type 2 diabetes (T2D) risk markers.

 Participants in the two groups that include health coaching will be assigned to a trained certified health coach for a period of 6 months.

 The duration of the study is 12 months with 3 in person visits (baseline, 6 months and 12 months) and completion of surveys at 6 weeks and 3 month time points.
