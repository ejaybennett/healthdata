(fifthQuint)Automated Control of End-tidal Volatile Anesthetic Concentration.
 ...
 After tracheal intubation MIRUS automatically adjusted the end-tidal VA concentration to 1.
...
0 MAC the ventilator mode was switched from SIMV V+ (totally controlled ventilation, "passive patient", with a tidal volume of 8 ml/IBW) to proportional assist ventilation (PAV) with 50% support ("active patient").

 At the end of surgery the MIRUS system was stopped (MAC set to 0.

0) and recovery times were measured.

.

 Automated Control of End-tidal Volatile Anesthetic Concentration@highlight
