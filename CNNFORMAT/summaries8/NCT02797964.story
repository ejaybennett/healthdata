(fifthQuint)A Phase 1/2 Trial of SRA737 in Subjects With Advanced Cancer.

 SRA737 is a potent, highly selective, orally bioavailable small molecule inhibitor of Chk1, a key regulator of cell cycle progression and the DNA Damage Response (DDR) replication stress response.

 In cancer cells, intrinsic replication stress (RS) is induced by factors such as oncogenes (e.

g.

, CCNE1 or MYC), genetic mutations in DNA repair machinery (e.

g.

 BRCA1 or FANCA), genetic mutations leading to a dysregulated cell cycle (e.

g.

, TP53 or RAD50) or other genomic alterations.

 This replication stress results in persistent DNA damage and genomic instability, leading to an increased dependency on Chk1 for survival.

 Targeted inhibition of Chk1 by SRA737 may therefore be synthetically lethal to cancer cells with elevated intrinsic RS.
 ...
 - Key tumor suppressor genes regulating G1 cell cycle progression/arrest such as TP53, RAD50, etc.

 For patients with HNSCC or SCCA, positive human papilloma virus (HPV) status is also considered for eligibility.
...
.
 ...
 A Phase 1/2 Trial of SRA737 in Subjects With Advanced Cancer@highlight
