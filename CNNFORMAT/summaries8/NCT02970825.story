(firstQuint)Move and Feel Good : Effects of Intensive Physical Training on Brain Plasticity, Cognition and Psychological Well-being.

.

 The investigators wish to document the benefit of an intensive exercise program in youth with the aim to identify the most effective programs that can improve psychological well-being, especially reducing depressive and anxiety symptoms and improving self-esteem.
 ...
 The investigators propose to perform a prospective, randomized, clinical study involving participants with mood disorders (International Classification of Diseases, 10th Revision, Clinical Modification (ICD-10-CM) for medical coding: ICD-10-CM F32.

9), anxiety (ICD-10-CM F41.

9), specific learning disabilities (ADHD hyperactivity (ICD-10-CM F90.

2), dyslexia-dyscalculia-dyspraxia (ICD-10-CM F81.

0, F81.

2, F81.

81)) and healthy subjects equally distributed for confounding variables (age, gender, subclinical depressive symptoms).

 The participants will be enrolled either in an experimental, intensive aerobic exercise regime or in a active control activity of stretching and relaxation conducted in parallel.
