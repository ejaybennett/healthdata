(thirdQuint)Immediate and Delayed Dentin Sealing Effect on Partial Crowns.

 Micromechanical and chemical retention of ceramic fixed prosthesis to tooth structure introduced minimal invasive preparation to dentistry.

 As a result, biomechanically or aesthetically compromised teeth can be restored at a lower biological price, saving sound tooth tissues.
 ...
 Improvements in this field over the years have brought about better cements and more effective methods to condition both substrates and teeth.
...
(Pashley et al, 1992; Paul en Scharer, 1997; Magne et al, 2005; Magne et al, 2007; Breschi et al, 2008; Lee en Park, 2009).
 ...
 At first glance this may appear a minor difference, but it is presumed to be of major clinical importance.

 The effectiveness of IDS is studied as an adjunct to conventional adhesive cementation of ceramic indirect restorations.

 A split mouth clinical trial comparing ceramic restorations cemented with either IDS or DDS after one year of clinical service is executed.

 For each patient two all ceramic indirect restorations are made.

 One is cemented by means of DDS (control group) and the other one is cemented by means of IDS (experimental group).

 Clinical evaluation is performed shortly after cementation and after 1 and 3 year(s) of clinical function.

.

 Immediate and Delayed Dentin Sealing Effect on Partial Crowns@highlight
