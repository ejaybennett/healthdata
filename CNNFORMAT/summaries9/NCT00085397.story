(fifthQuint)Vaccine Therapy in Treating Patients With Stage III or Stage IV Melanoma.
 ...
 Secondary - Compare the safety and toxicity of these regimens in these patients.
 ...
 All patients undergo leukapheresis.

 Peripheral blood mononuclear cells are cultured to generate dendritic cells (DC).

 - Arm I: Patients undergo surgical harvesting of tumor cells for subsequent fusion.

 Patients receive vaccination comprising DC fused with autologous tumor cells subcutaneously on day 1.

 Treatment repeats every 21 days for 3 courses.

 Patients who achieve a partial (PR) or complete response (CR) may receive an additional 3 courses.

 - Arm II: Patients receive vaccination comprising DC pulsed with gp100 antigen IV on day 1.

 Treatment repeats every 21 days for 6 courses.

 Patients who achieve a PR or CR may receive an additional 6 courses.
...
RATIONALE: Vaccines made from a patient's dendritic cells may make the body build an immune response to kill tumor cells.

 It is not yet known whether combining vaccine therapy with either gp100 antigen or the patient's tumor cells will cause a stronger immune response and kill more tumor cells.
