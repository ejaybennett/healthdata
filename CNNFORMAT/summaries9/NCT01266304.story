(fifthQuint)The Healing Context in Complementary and Alternative Medicine (CAM): Instrument Development and Initial Validation.

 This project will develop and test a patient self-report measurement tool to assess the perceived contextual factors, such as patient attitudes and expectations, patient provider relationship factors, and environmental factors that contribute to healing.
 ...
 We will use item response theory (IRT) and classical test theory (CTT) to calibrate the items from Aim 1 on three samples: 1) an internet-based sample (n= 1000), 2) 100 outpatients participating in CAM interventions at our Center for Integrative Medicine (CIM), and 3) 100 outpatients at a General Internal Medicine clinic.

 During year 2-3 we administer the items in the item bank to the 1200 persons, conduct IRT and CTT analyses and refine the item bank to only those items that best assess the constructs.
 ...
 A static short form of the HEAL will be derived from the HEAL CAT in Aim 2.

 Specific Aim 3: Conduct initial validation studies.
 ...
 - Hypothesis 3a: Scores on the HEAL measure will display moderate to large correlations (r's > .

50) with similar self-report measures, supporting convergent validity.

 - Hypothesis 3b: Scores on the HEAL measure will correlate modestly (r's = .

20-.

35) with self-report measures of general psychosocial functioning, supporting discriminant validity.

 - Hypothesis 3c: HEAL scores will account for a significant proportion of variance in treatment outcome in both samples.

 In addition, we predict that HEAL scores will demonstrate incremental validity, i.

e.

, they will account for significant incremental variance in outcome beyond that accounted for by existing measures of treatment expectancy and related constructs.

.

 The Healing Context in Complementary and Alternative Medicine (CAM): Instrument Development and Initial Validation@highlight
...
The overall objective of this study is to develop and test an efficient self-report instrument to measure Complementary and Alternative Medicine(CAM)-relevant contextual factors important in healing.
 ...
 The current protocol in ClinicalTrials.

gov pertains only to the initial phase of the study involving focus groups and cognitive interviews.

 The next step of instrument development is called Calibration, and will involve administering the revised item bank to an internet sample and to persons who receive services in a CAM clinic and a conventional primary care setting.
 ...
 The final phase of the project will involve conducting initial validation studies of the instrument.

 The instrument will be called the Healing Encounters and Attitudes List (HEAL).

 The investigators will evaluate the convergent, discriminant, and predictive validity of the HEAL in a sample of 200 persons with chronic low back pain who are receiving physical therapy, chiropractic care, or mindfulness-based stress reduction.
 ...
 Finally, HEAL score should account for a significant proportion of the variance in treatment outcome, supporting predictive validity.
