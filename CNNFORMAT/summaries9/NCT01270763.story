(fifthQuint)Gene x Behavior Interaction in the Look AHEAD Study.
 ...
 At year 1, participants assigned to Intensive Lifestyle Intervention (ILI), focusing on changes in diet and physical activity, lost an average of 8.

6% of their weight (N = 2,496; 97.

1% follow-up) relative to losses of 0.

7% among individuals assigned to the Diabetes Support and Education (DSE) group (N= 2,463, 95.

7% follow-up), who received diabetes support and education groups alone.
...
.
 ...
 Gene x Behavior Interaction in the Look AHEAD Study@highlight
