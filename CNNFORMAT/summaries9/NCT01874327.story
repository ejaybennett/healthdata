(secondQuint)Biomarkers of Developmental Trajectories and Treatment in Autism Spectrum Disorder (ASD).

 The proposed intervention adapts a parent-mediated intervention that successfully improved outcomes in toddlers with autism.

 The intervention model (a) targets the foundations of social-communication (joint attention, imitation, play), (b) uses naturalistic strategies to increase the rate and complexity of social-communication and (c) includes parents as implementers of the intervention to promote generalization across settings and activities and to ensure maintenance over time.

 In addition to testing the primary effects of this early intervention on the developmental outcomes of children with signs of autism, we will examine whether this method is superior to an early intervention focused on global infant development.
 ...
 Study Aims: AIM 1: To examine the effects of the experimental intervention (Baby JASPER) on primary (joint attention) and secondary outcomes (receptive language, play, symbol-infused joint engagement and parent use of social communication support strategies).
...
.
 ...
 Biomarkers of Developmental Trajectories and Treatment in Autism Spectrum Disorder (ASD)@highlight
