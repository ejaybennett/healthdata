(secondQuint)Validation of Objective Measures of Place-Based Physical Activity.

 The Personal Activity Location Measurement System (PALMS) researchers at UCSD have created a web-based processing system for location (GPS) and physical activity (accelerometer) data.
 ...
 We will be assessing the usability of PALMS in a research staff with no previous experience of using the PALMS system.

 We will be assessing the added value of using PALMS to examine a place-based intervention in an existing cohort study.

.

 Validation of Objective Measures of Place-Based Physical Activity@highlight
