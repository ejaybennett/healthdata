(secondQuint)SPREAD-NET: PRactices Enabling Adapting and Disseminating in the Safety NET.

 The investigators propose to compare the effectiveness of 3 support strategies for optimizing the sustainable implementation of the evidence-based ALL intervention.

 To do so, the investigators will randomize 30 community health centers (CHCs) to receive 1 of 3 implementation support strategies: Low support (toolkit only), Medium (toolkit, staff training), High (toolkit, training, on-site facilitation).

 The study aims are as follows: Aim 1: Compare the effectiveness of the 3 strategies (low, medium, high intensity) at supporting CHCs' implementation of the ALL intervention, through a cluster-randomized trial.
 ...
 Aim 3: Identify clinic characteristics associated with the support strategies' effectiveness (e.

g.

 decision-making structures, leadership support, team processes / characteristics, readiness and capacity for change).
 ...
 SPREAD-NET: PRactices Enabling Adapting and Disseminating in the Safety NET@highlight
