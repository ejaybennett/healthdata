(secondQuint)Use of a Supplemental Radiofrequency Detection System Subsequent to Manual Counting of Vaginal Textiles Following Vaginal Birth.
 ...
 This static scan will serve to detect any retained cotton texiles within the vaginal cavity after birth.
 ...
 Once the provider is assured there is no retained item, the same device may be used to scan trash receptacles to locate a missing textile if the pre- and post-delivery sponge/guauze count remains incongruent.

 This alleviates the need for the assistant personnel to manually "dig" through soiled materials for sponge localization.

.

 Use of a Supplemental Radiofrequency Detection System Subsequent to Manual Counting of Vaginal Textiles Following Vaginal Birth@highlight
