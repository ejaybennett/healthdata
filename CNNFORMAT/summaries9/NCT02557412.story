(fifthQuint)Effect of Nasal CPAP on Lipid Profile in Patients With Dyslipidaemia and Sleep Apnea.
 ...
 Secondary objectives: - Determine the additional effect of CPAP on insulin resistance and dyslipidemia in patients with mild-moderate OSA.
 ...
 38 patients who completed the test in each treatment arm.

 TREATMENT Patients will be randomized to one of the following treatment arms form: 1.
 ...
 - Systemic Biomarkers: inflammatory (IL-6, IL-8 and TNF-), oxidative stress (8-isoprostane), endothelial damage (endothelin, VCAM-1 and ICAM-1), sympathetic activity (neuropeptide Y) and appetite-regulating hormones (leptin, orexin A / hypocretin-1 and ghrelin).
 ...
 STATISTICAL PROCEDURES Data will be expressed as mean standard deviation, median (interquartile range) or percent, depending on type and distribution.

 For comparison between groups, or t-Student test, or the Mann-Whitney U-test or chi-square test will be used, as appropriate.

 The relationships between variables will be analyzed by Pearson correlation and multiple linear regression.

 The treatment effect will be evaluated by analysis of variance for repeated measures with post-hoc multiple comparisons, using the Bonferroni test.

 A model of multiple logistic regression will be applied to determine the variables associated with treatment response.

 P values will be considered statistically significant <0.

05.

.

 Effect of Nasal CPAP on Lipid Profile in Patients With Dyslipidaemia and Sleep Apnea@highlight
