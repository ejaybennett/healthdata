(fifthQuint)Identification of Risk Factors Causing Difficulty in Laryngeal Mask Insertion.
 ...
 Aim of the study Some studies have concerned the causes that determine the difficulty in the insertion of an LM.

 They are retrospective studies and/or focused on the analysis of a single type of device.
 ...
 Statistic Descriptive: for each quantitative variable will be reported mean, standard deviation, first and third quartiles, median, minimum and maximum.

 For each qualitative variable will be reported frequency and percentage of each category.
 ...
 Sample size: For a hypothesis test on the relative risk so specified H0: RR 1 H1: RR> 1 and considering an expected relative risk of 2, a proportion of 2.

9% of the failures in the group of experts and a first type error equal to 5%, 832 patients per group are needed to ensure a power equal to 90%.
...
.
 ...
 Identification of Risk Factors Causing Difficulty in Laryngeal Mask Insertion@highlight
