(fifthQuint)Internet-based Depression Treatment: Differential Efficacy of Different Therapeutic Components.
 ...
 A minimum of 102 participants diagnosed with mild to moderate depression symptoms will be randomly assigned to one of the three experimental conditions: an Internet-based global protocol composed of several therapeutic components (n=34); a Internet-based protocol based on BA (n=34), and an Internet-based program based on PP (n=34).
...
.
 ...
 Internet-based Depression Treatment: Differential Efficacy of Different Therapeutic Components@highlight
